...
- Commit: `c3a1d4ab8cbc`
- Recorded at: 2026-08-27T11:23:44.954Z
- Total smoke time: 22069 ms (+2253 ms vs previous)
- Login: 3823 ms
- App ready: 1086 ms
- Native long tasks: 0, max 0 ms
- Scheduled task samples: 64, max end-to-end 184.5 ms, max derived network wait 5 ms
- Budget failures: 0
- Errors: 0
...
| --- | --- | --- | --- |
| `grade-scheduler` | 33.89999999999418 ms | 687 ms | 720.8999999999942 ms |
| `freshman-simulator` | 76.90000000002328 ms | 449 ms | 525.9000000000233 ms |
| `student-overview` | 33.30000000001746 ms | 481 ms | 514.3000000000175 ms |
| `subject-balance` | 33.70000000001164 ms | 432 ms | 465.70000000001164 ms |
| `report-generator` | 19.39999999999418 ms | 379 ms | 398.3999999999942 ms |
| `exam-arranger` | 13.60000000000582 ms | 353 ms | 366.6000000000058 ms |
| `cohort-growth` | 16 ms | 335 ms | 351 ms |
| `correlation-analysis` | 18.5 ms | 189 ms | 207.5 ms |
