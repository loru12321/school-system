...
- Commit: `c8ff54e2cdfa`
- Recorded at: 2026-07-28T01:38:34.291Z
- Total smoke time: 31622 ms (-362 ms vs previous)
- Login: 6229 ms
- App ready: 108 ms
...
| --- | --- | --- | --- |
| `indicator` | 32.79999999998836 ms | 1994 ms | 2026.7999999999884 ms |
| `teacher-analysis` | 54.5 ms | 1775 ms | 1829.5 ms |
| `teacher-township-ranking` | 5 ms | 864 ms | 869 ms |
| `student-overview` | 34.20000000001164 ms | 788 ms | 822.2000000000116 ms |
| `analysis` | 58.800000000046566 ms | 661 ms | 719.8000000000466 ms |
| `progress-analysis` | 43 ms | 622 ms | 665 ms |
| `report-generator` | 15 ms | 576 ms | 591 ms |
| `subject-balance` | 30 ms | 508 ms | 538 ms |
