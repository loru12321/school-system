...
assert.ok(readme.includes('/downloads/school-system-windows-beta-20260621-9a362b3.exe'), 'README should document the current hosted Windows download');
assert.ok(readme.includes('/downloads/school-system-android-beta-20260621-9a362b3.apk'), 'README should document the current hosted APK download');
