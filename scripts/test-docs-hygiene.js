...
assert.ok(readme.includes('/downloads/school-system-windows-beta-20260624-7e19d7d.exe'), 'README should document the current hosted Windows download');
assert.ok(readme.includes('/downloads/school-system-android-beta-20260624-7e19d7d.apk'), 'README should document the current hosted APK download');
