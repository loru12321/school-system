...
assertIncludes(serviceWorkerRuntime, "const SERVICE_WORKER_VERSION = '20260606-summary-entry-v1';", 'service worker runtime should version registration updates');
...
assertIncludes(srcIndex, 'service-worker-runtime.js?v=20260606-summary-entry-v1', 'HTML should cache-bust the service worker runtime loader');
assertIncludes(srcIndex, "var refreshVersion = '20260606-summary-entry-v1';", 'early runtime refresh should use the same service worker runtime version');
