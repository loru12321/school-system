...
const tablerBuildScript = packageJson.scripts['build:pre'] || packageJson.scripts.build || '';
assert.ok(tablerBuildScript.includes('node scripts/build/subset-tabler-icons.mjs'), 'production build should regenerate the Tabler icon subset');
