...
assert.ok(teachingManagementOverviewRuntime.includes("const supportedModules = ['teacher-analysis', 'class-comparison', 'class-diagnosis'];"), 'teaching management state bars should only cover retained modules');
