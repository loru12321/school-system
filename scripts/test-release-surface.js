...
assert.strictEqual(publicManifest.name, '知衡云台', 'web manifest name should stay readable');
assert.strictEqual(publicManifest.short_name, '知衡云台', 'web manifest short name should stay readable');
