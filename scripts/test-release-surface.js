...
assert.strictEqual(publicManifest.name, '菁莪云枢', 'web manifest name should stay readable');
assert.strictEqual(publicManifest.short_name, '菁莪云枢', 'web manifest short name should stay readable');
