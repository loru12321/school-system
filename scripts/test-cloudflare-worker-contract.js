...
assert.ok(workerContractSource.includes("pathname.startsWith('/assets/js/')") && workerContractSource.includes("/^runtime-[A-Za-z0-9_-]{6,}$/"), 'query-versioned runtime JS should use immutable browser caching');
