...
assert.ok(appSource.includes('Windows 本地安装包'), 'public channel config should label Windows as a local installer package');
assert.ok(appSource.includes('双击打开安装向导'), 'public channel config should explain the Windows installer wizard');
assert.ok(appSource.includes("url: './downloads/school-system-android-beta-20260621-9a362b3.apk'"), 'public channel config should point Android to the current hosted package');
assert.ok(appSource.includes("url: './downloads/school-system-windows-beta-20260621-9a362b3.exe'"), 'public channel config should point Windows to the current hosted package');
...
assert.ok(!appSource.includes("url: './downloads/school-system-android-v1.0.apk'"), 'public channel config should not point Android to the old package');
assert.ok(!appSource.includes("url: './downloads/school-system-windows-latest.exe'"), 'public channel config should not point Windows to the old alias');
assert.ok(!source.includes("version: '1.0.1'"), 'download runtime fallback versions should match the current package generation');
assert.ok(!appSource.includes("version: '1.0.1'"), 'public app fallback versions should match the current package generation');
