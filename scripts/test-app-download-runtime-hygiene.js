...
assert.ok(source.includes('./downloads/school-system-android-beta-20260624-161180a.apk'), 'download center should expose the current hosted APK');
assert.ok(source.includes('./downloads/school-system-windows-beta-20260624-161180a.exe'), 'download center should expose the current hosted Windows client installer');
...
assert.ok(loginDownloadSource.includes("url: './downloads/school-system-android-beta-20260624-161180a.apk'"), 'public channel config should point Android to the current hosted package');
assert.ok(loginDownloadSource.includes("url: './downloads/school-system-windows-beta-20260624-161180a.exe'"), 'public channel config should point Windows to the current hosted package');
