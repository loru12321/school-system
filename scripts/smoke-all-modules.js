...
// Keep readiness just below the 6000ms switch budget while avoiding false
// negatives when a production/CI runner briefly approaches the budget.
const MODULE_SWITCH_READY_TIMEOUT_MS = 5950;
