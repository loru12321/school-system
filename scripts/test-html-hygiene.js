...
assert.ok(html.includes('./assets/css/product-redesign.css?v=20260606-product-redesign-v3'), 'index.html should load the product redesign layer after legacy styles');
...
assert.ok(html.includes("var refreshVersion = '20260606-product-redesign-v3';"), 'early runtime refresh version should match the service worker runtime');
