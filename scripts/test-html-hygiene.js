...
assert.ok(html.includes('./assets/css/product-redesign.css?v=20260617-win11-fluent-v1'), 'index.html should load the product redesign layer after legacy styles');
