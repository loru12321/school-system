...
assert.ok(html.includes('./assets/css/product-redesign.css?v=20260617-curated-media-v2'), 'index.html should load the product redesign layer after legacy styles');
