(()=>{if(typeof window=="undefined"||window.__COUNTY_ANALYSIS_RUNTIME_PATCHED__)return;const tt="COUNTY_ANALYSIS_SCOPE_V1",V="COUNTY_ANALYSIS_HISTORY_V1",w={promptArmed:!1,lastSignature:"",teacherContextPromise:null,lastTeacherContextSignature:"",lastTeacherContextAt:0,subjectRowCacheSignature:"",subjectRowCache:new Map,preUploadTownshipSchools:[],isRendering:!1,lastRankSignature:""},et={"county-teacher-portrait":{title:"县域教师画像",badge:"教师县域排名",description:"对照“教师教学质量画像”，把本校教师放到县域所有学校同学科样本中排名，查看学科教师县域站位。"},"county-school-horizontal":{title:"县域学校横向分析",badge:"全县横向对比",description:"对照“两率一分(横向)”，生成五科总综合分析表和各学科明细表，按县域所有学校统一排名。"}},me=["语文","数学","英语","物理","化学","政治"],nt=["语文","数学","英语","物理","化学","历史","地理","生物","政治"];function S(t){return String(t!=null?t:"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function y(t,e=0){const n=Number(t);return Number.isFinite(n)?n:e}function v(t,e,n){if(window.RankingDataService&&typeof window.RankingDataService.assignCompetitionRanks=="function")return window.RankingDataService.assignCompetitionRanks(t,e,n);const o=Array.isArray(t)?t.slice():[];o.sort((a,c)=>Number(e(c)||0)-Number(e(a)||0));let s=null,r=0;return o.forEach((a,c)=>{const d=Number(e(a)),i=s!==null&&Math.abs(d-s)<1e-4?r:c+1;n(a,i),s=d,r=i}),o}function m(t,e=2){const n=Number(t);return Number.isFinite(n)?n.toFixed(e):"-"}function b(t){const e=Number(t);return Number.isFinite(e)?`${(e*100).toFixed(1)}%`:"-"}function N(t,e,n=!1){const o=Number(t),s=Number.isFinite(o)?n?`${(o*100).toFixed(2)}%`:o.toFixed(2):"-",r=e?` <span style="font-size:0.9em; color:#94a3b8">(${e})</span>`:"";return`${s}${r}`}function J(t){const e=String(t||"").trim();return typeof window.normalizeSubject=="function"?window.normalizeSubject(e):e.replace(/\s+/g,"")}function we(){var o,s,r;const t=typeof window.getExamMetaFromUI=="function"?window.getExamMetaFromUI():{},e=a=>{try{return localStorage.getItem(a)||""}catch(c){return""}},n=[t==null?void 0:t.grade,(o=window.CURRENT_COHORT_META)==null?void 0:o.grade,(s=window.CONFIG)==null?void 0:s.grade,(r=window.CONFIG)==null?void 0:r.name,e("CURRENT_TEACHER_TERM_ID"),e("CURRENT_TERM_ID")];for(const a of n){const c=String(a||"").match(/([6-9])\s*年?级?/);if(c)return Number(c[1])}return 0}function at(){const t=we();return t===9?me:([6,7,8].includes(t),nt)}function F(t){const e=at().map(J);return Array.from(new Set((t||[]).map(o=>String(o||"").trim()).filter(Boolean))).sort((o,s)=>{const r=D(o),a=D(s);return r!==a?r-a:String(o).localeCompare(String(s),"zh-CN",{numeric:!0})})}function D(t){const n=at().map(J).indexOf(J(t));return n>=0?n:999}function ot(){var e;return String(((e=window.CONFIG)==null?void 0:e.name)||"").trim().includes("9")?{avg:50,excellent:80,pass:50}:{avg:60,excellent:70,pass:70}}function rt(t,e=5e3,n=!1){return Promise.race([Promise.resolve(t).catch(()=>n),new Promise(o=>setTimeout(()=>o(n),e))])}function K(t,e){try{const n=localStorage.getItem(t);return n?JSON.parse(n):e}catch(n){return e}}function st(t,e){try{localStorage.setItem(t,JSON.stringify(e))}catch(n){console.warn("[county-analysis] failed to persist state:",n)}}function T(){var t;return String(window.CURRENT_EXAM_ID||(typeof window.readWorkspaceExamId=="function"?window.readWorkspaceExamId():"")||((t=window.COHORT_DB)==null?void 0:t.currentExamId)||"current").trim()||"current"}function k(){return Object.keys(window.SCHOOLS||{}).filter(Boolean).sort((t,e)=>t.localeCompare(e,"zh-CN"))}function ct(t){const e=String(t||"").trim();return/^(?:\u6574\u4f53|\u5168\u90e8|\u6c47\u603b|\u603b\u8868|\u5408\u8ba1|\u5168\u53bf|\u53bf\u57df|Sheet\d*|\u5de5\u4f5c\u8868\d*)$/i.test(e)}function it(t){return typeof window.normalizeSchoolName=="function"&&window.normalizeSchoolName(t)||String(t||"").trim()}function lt(t){const e=Array.isArray(t)?t.filter(Boolean):k();if(!e.length)return[];if(typeof window.getTownshipManagedSchoolNames=="function"){const a=window.getTownshipManagedSchoolNames(e);if(Array.isArray(a)&&a.length)return a}const n=window.TARGETS&&typeof window.TARGETS=="object"?window.TARGETS:{},o=Object.keys(n);if(!o.length)return[];const s=new Map;e.forEach(a=>{s.set(it(a),a)});const r=o.map(a=>{if(typeof window.resolveSchoolNameFromCollection=="function"){const c=window.resolveSchoolNameFromCollection(e,a);if(c)return c}if(typeof window.getCanonicalSchoolName=="function"){const c=window.getCanonicalSchoolName(a,e);if(c&&e.includes(c))return c}return s.get(it(a))||""}).filter(a=>a&&!ct(a));return Array.from(new Set(r)).sort((a,c)=>a.localeCompare(c,"zh-CN"))}function _(){const t=Object.keys(window.TARGETS&&typeof window.TARGETS=="object"?window.TARGETS:{}).sort((n,o)=>String(n).localeCompare(String(o),"zh-CN")),e=Number(window.__RAW_DATA_VERSION||0);return[T(),Array.isArray(window.RAW_DATA)?window.RAW_DATA.length:0,e,k().join("|"),t.join("|")].join("::")}function dt(){const t=K(tt,{});return t&&typeof t=="object"?t:{}}function x(){return dt()[T()]||null}function Se(t){const e=dt();e[T()]=t,st(tt,e)}function He(t){return String(t||"").split(/[,\n，、]+/).map(e=>e.trim()).filter(Boolean)}function be(t,e=null){const n=Array.isArray(t)?t.filter(Boolean):k();return lt(n)}function M(t){const e=k(),n=lt(e),o=new Set(n),s=d=>o.has(d)?!0:typeof window.isTownshipManagedSchool=="function"?window.isTownshipManagedSchool(d,e):n.some(i=>typeof window.areSchoolNamesMatched=="function"?window.areSchoolNamesMatched(i,d,!0):i===d),r=e.filter(d=>s(d)),a=e.filter(d=>!s(d)),c=!!(t!=null&&t.includesCounty)&&(r.length>0||a.length>0);return{examKey:T(),includesCounty:c,explicitCountyUpload:c&&(t==null?void 0:t.explicitCountyUpload)===!0,townshipSchools:r,countySchools:a,signature:(t==null?void 0:t.signature)||_(),updatedAt:(t==null?void 0:t.updatedAt)||new Date().toISOString()}}function ut(){return Object.values(window.SCHOOLS||{}).slice().sort((t,e)=>(t.countyRank2Rate||9999)-(e.countyRank2Rate||9999))}function W(){const t=Object.values(window.SCHOOLS||{}).filter(e=>{var n;return(n=e==null?void 0:e.metrics)==null?void 0:n.total}).map(e=>{var o,s,r,a,c;const n=e.metrics.total||{};return{school:e,schoolName:e.name||"",count:y(n.count),avg:y(n.avg),excellentRate:y(n.excRate),passRate:y(n.passRate),ratedAvg:y((o=n.countyRatedAvg)!=null?o:e.countyRatedAvg),ratedExc:y((s=n.countyRatedExc)!=null?s:e.countyRatedExc),ratedPass:y((r=n.countyRatedPass)!=null?r:e.countyRatedPass),score:y((c=(a=n.countyScore2Rate)!=null?a:e.countyScore2Rate)!=null?c:e.score2Rate)}});return v(t,e=>e.avg,(e,n)=>{e.rankAvg=n}),v(t,e=>e.excellentRate,(e,n)=>{e.rankExcellent=n}),v(t,e=>e.passRate,(e,n)=>{e.rankPass=n}),v(t,e=>e.score,(e,n)=>{e.rankScore=n}),t.sort((e,n)=>(e.rankScore||9999)-(n.rankScore||9999))}function pt(){const t=k();if(!t.length)return"";const e=[typeof window.readCurrentSchool=="function"?window.readCurrentSchool():"",window.MY_SCHOOL,(()=>{try{return localStorage.getItem("MY_SCHOOL")||""}catch(n){return""}})()].map(n=>String(n||"").trim()).filter(Boolean);for(const n of e){if(t.includes(n))return n;if(typeof window.resolveSchoolNameFromCollection=="function"){const o=window.resolveSchoolNameFromCollection(t,n);if(o)return o}if(typeof window.getCanonicalSchoolName=="function"){const o=window.getCanonicalSchoolName(n,t);if(o&&t.includes(o))return o}}return""}function ht(t,e){const n=ot();return{ratedAvg:e.avg?y(t==null?void 0:t.avg)/e.avg*n.avg:0,ratedExc:e.excellent?y(t==null?void 0:t.excRate)/e.excellent*n.excellent:0,ratedPass:e.pass?y(t==null?void 0:t.passRate)/e.pass*n.pass:0}}function yt(t,e,n,o){const s=M(o||x()||{}),r=new Set(s.townshipSchools||[]),a=Object.values(window.SCHOOLS||{}).filter(l=>{var f;return(f=l==null?void 0:l.metrics)==null?void 0:f[t]}).filter(l=>n!=="township"||r.has(l.name));if(!a.length)return null;const c=a.reduce((l,f)=>{var g;const h=((g=f==null?void 0:f.metrics)==null?void 0:g[t])||{};return l.avg=Math.max(l.avg,y(h.avg)),l.excellent=Math.max(l.excellent,y(h.excRate)),l.pass=Math.max(l.pass,y(h.passRate)),l},{avg:0,excellent:0,pass:0}),d=a.map(l=>{var g;const f=((g=l==null?void 0:l.metrics)==null?void 0:g[t])||{},h=ht(f,c);return{name:l.name,metric:f,score:h.ratedAvg+h.ratedExc+h.ratedPass}}).sort((l,f)=>f.score-l.score);let i=d.find(l=>l.name===e);return!i&&typeof window.areSchoolNamesMatched=="function"&&(i=d.find(l=>window.areSchoolNamesMatched(l.name,e,!0))),i?{rank:d.findIndex(l=>l===i)+1,total:d.length,score:i.score,metric:i.metric}:null}function Ue(t){var a,c;const e=pt(),n=e?(window.SCHOOLS||{})[e]:null;if(!n)return'<div class="county-empty">未锁定本校。请先在数据管理里设置本校，县域分析会自动补充本校学科对比。</div>';const o=((a=n.metrics)==null?void 0:a.total)||{},s=n.countyScope!=="county",r=(window.SUBJECTS||[]).map(d=>{var f,h,g;const i=yt(d,e,"county",t),u=s?yt(d,e,"township",t):null;if(!i&&!u)return"";const l=i||u;return`
                    <tr>
                        <td>${S(d)}</td>
        ...
        `:'<div class="county-empty">暂无学校成绩数据，请先导入本次成绩。</div>'}function Ce(t){var c,d,i;const e=Array.isArray(t)?t.slice():bt();if(!e.length)return"";const n=e.slice().sort((u,l)=>(u.countyRankAvg||9999)-(l.countyRankAvg||9999))[0],o=e.slice().sort((u,l)=>(u.countyRankExc||9999)-(l.countyRankExc||9999))[0],s=e.slice().sort((u,l)=>(u.countyRankPass||9999)-(l.countyRankPass||9999))[0],r=new Set(e.map(u=>u.subject).filter(Boolean)),a=e.slice().sort((u,l)=>(u.countyRankAvg||9999)-(l.countyRankAvg||9999)).slice(0,8);return`
        ...
        `).join("");return`
                ...
                ${t.map((o,s)=>{var r,a,c;return`
                    <article class="county-portrait-card ${o.riskLevel==="risk"?"is-risk":""}">
                        ...
                        <div class="county-portrait-rankline">
                            ...
                            <span>及排 #${(c=o.countyRankPass)!=null?c:"-"}</span>
                        </div>
                    </article>
                `}).join("")}
            </div>
            ...
            ${n?`
                ...
                ${n}
            `:""}
        `}function Fe(){const t=ft().slice(0,40);if(!t.length)return'<div class="county-empty">暂无学生成绩数据。</div>';const e=window.SUBJECTS||[];return`
            <div class="table-wrap analysis-table-shell">
                <table class="analysis-generated-table county-analysis-table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ${t.map(n=>`
                            <tr>
                                ...
                                <td>${S(n.class||"")}</td>
                                <td>${m(n.total,1)}</td>
                                ${e.map(o=>{var s,r,a,c;return`
                                    <td>${((r=(s=n==null?void 0:n.ranks)==null?void 0:s[o])==null?void 0:r.township)||"-"}</td>
                                    <td>${((c=(a=n==null?void 0:n.ranks)==null?void 0:a[o])==null?void 0:c.county)||"-"}</td>
                                `}).join("")}
                            </tr>
                        `).join("")}
                    </tbody>
        ...
        `}function Z(t,e){const n=window[t];if(typeof n!="function"||n[`__countyPatched_${t}`])return!1;const o=function(...r){const a=n.apply(this,r),c=d=>(e(...r),d);return a&&typeof a.then=="function"?a.then(c):(c(a),a)};return o[`__countyPatched_${t}`]=!0,window[t]=o,!0}function Ie(t){const e=window[t];return typeof e=="function"&&!!e[`__countyPatched_${t}`]}function Mt(){return Z("processData",()=>{E(),B(),$t()}),Z("renderTables",()=>{E()}),Z("switchTab",t=>{(t==="county-analysis"||t==="county-teacher-portrait"||t==="county-school-horizontal")&&setTimeout(()=>I(t),0)}),["processData","renderTables","switchTab"].every(Ie)}function Me(){document.addEventListener("change",t=>{const e=t.target;!e||e.id!=="fileInput"||e.files&&e.files.length&&(w.preUploadTownshipSchools=k().filter(n=>!ct(n)),w.promptArmed=!0)},!0)}function Pe(){if(document.getElementById("county-analysis-runtime-style"))return;const t=document.createElement("style");t.id="county-analysis-runtime-style",t.textContent=`
