(function(m){if(m.ZhongkaoCountdownModule)return;const S="SYSTEM_ZHONGKAO_COUNTDOWN_CONFIG_V1",J=1,N=1440*60*1e3,t={config:null,root:null,el:{},autoSaveTimer:null,clockTimer:null,noticeTimer:null,mounted:!1};function v(){return{version:J,examDate:E(),excludeWeekends:!0,holidays:[],officialHolidays:{},lastSyncedAt:""}}function C(e="",a="",n=""){return{id:typeof crypto!="undefined"&&crypto.randomUUID?crypto.randomUUID():`zkc-${Date.now()}-${Math.random().toString(16).slice(2)}`,name:e,start:a,end:n}}function l(e){return typeof e=="string"&&/^\d{4}-\d{2}-\d{2}$/.test(e.trim())?e.trim():""}function f(e){const a=l(e);if(!a)return null;const[n,o,i]=a.split("-").map(Number),r=new Date(n,o-1,i);return r.setHours(0,0,0,0),r.getFullYear()!==n||r.getMonth()!==o-1||r.getDate()!==i?null:r}function E(e=new Date){const a=new Date(e);a.setHours(0,0,0,0);const n=a.getFullYear(),o=new Date(n,5,16);return o.setHours(0,0,0,0),`${a>=o?n+1:n}-06-13`}function U(e){return/^\d{4}-06-13$/.test(String(e||"").trim())}function I(e,a=new Date){const n=l(e),o=E(a);if(!n)return o;const i=f(n),r=new Date(a);return r.setHours(0,0,0,0),U(n)&&i&&i<r?o:n}function b(e){return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`}function q(e){const a=f(e);return a?a.toLocaleDateString("zh-CN",{year:"numeric",month:"long",day:"numeric"}):e}function T(e,a){const n=new Date(e);return n.setDate(n.getDate()+a),n}function G(e){if(!e||typeof e!="object")return null;const a=C(typeof e.name=="string"?e.name.trim():"",l(e.start),l(e.end));return typeof e.id=="string"&&e.id.trim()&&(a.id=e.id.trim()),a}function K(e){if(!e||typeof e!="object")return{};const a={};return Object.entries(e).forEach(([n,o])=>{const i=l(n);!i||!o||typeof o!="object"||(a[i]={isHoliday:!!o.isHoliday,name:typeof o.name=="string"&&o.name.trim()?o.name.trim():o.isHoliday?"法定节假日":"调休上课"})}),a}function p(e){const a=v();return!e||typeof e!="object"||(a.examDate=I(e.examDate),a.excludeWeekends=e.excludeWeekends!==!1,a.holidays=Array.isArray(e.holidays)?e.holidays.map(G).filter(Boolean):[],a.officialHolidays=K(e.officialHolidays),a.lastSyncedAt=typeof e.lastSyncedAt=="string"?e.lastSyncedAt:""),a}function V(){if(document.getElementById("zkc-runtime-style"))return;const e=document.createElement("style");e.id="zkc-runtime-style",e.textContent=`
        ...
        `}function P(){t.el={noticeBar:t.root.querySelector('[data-zk="noticeBar"]'),totalDays:t.root.querySelector('[data-zk="totalDays"]'),studyDays:t.root.querySelector('[data-zk="studyDays"]'),weekendDays:t.root.querySelector('[data-zk="weekendDays"]'),holidayDays:t.root.querySelector('[data-zk="holidayDays"]'),examDate:t.root.querySelector('[data-zk="examDate"]'),excludeWeekends:t.root.querySelector('[data-zk="excludeWeekends"]'),cacheStatus:t.root.querySelector('[data-zk="cacheStatus"]'),holidayList:t.root.querySelector('[data-zk="holidayList"]'),summaryText:t.root.querySelector('[data-zk="summaryText"]'),summaryMeta:t.root.querySelector('[data-zk="summaryMeta"]'),liveClock:t.root.querySelector('[data-zk="liveClock"]'),fileInput:t.root.querySelector('[data-zk="fileInput"]'),saveBtn:t.root.querySelector('[data-zk-action="save"]'),resetBtn:t.root.querySelector('[data-zk-action="reset"]'),syncBtn:t.root.querySelector('[data-zk-action="sync"]'),exportBtn:t.root.querySelector('[data-zk-action="export"]'),importBtn:t.root.querySelector('[data-zk-action="import"]'),addHolidayBtn:t.root.querySelector('[data-zk-action="addHoliday"]')}}function j(){const e=localStorage.getItem(S);if(!e){t.config=v();return}try{t.config=p(JSON.parse(e))}catch(a){console.error("[zhongkao-countdown] config read failed:",a),t.config=v(),x(),s("本地倒计时配置读取失败，已恢复默认设置。","error",4200)}}function x(){localStorage.setItem(S,JSON.stringify(t.config))}function D(){const e=Array.from(t.el.holidayList.querySelectorAll(".zkc-holiday-row")).map(a=>{var n,o,i;return{id:a.dataset.id||C().id,name:((n=a.querySelector(".zkc-holiday-name"))==null?void 0:n.value.trim())||"",start:l(((o=a.querySelector(".zkc-holiday-start"))==null?void 0:o.value)||""),end:l(((i=a.querySelector(".zkc-holiday-end"))==null?void 0:i.value)||"")}});return{examDate:l(t.el.examDate.value),excludeWeekends:t.el.excludeWeekends.checked,holidays:e}}function A(e){if(t.el.holidayList.replaceChildren(),!e.length){const a=document.createElement("div");a.className="zkc-empty",a.textContent="当前还没有自定义假期，点击“添加假期”即可新增区间。",t.el.holidayList.appendChild(a);return}e.forEach(a=>{const n=document.createElement("div");n.className="zkc-holiday-row",n.dataset.id=a.id;const o=document.createElement("input");o.type="text",o.className="zkc-holiday-name",o.placeholder="假期名称，例如：寒假",o.value=a.name,o.addEventListener("input",z);const i=document.createElement("input");i.type="date",i.className="zkc-holiday-start",i.value=a.start,i.addEventListener("change",z);const r=document.createElement("input");r.type="date",r.className="zkc-holiday-end",r.value=a.end,r.addEventListener("change",z);const c=document.createElement("button");c.type="button",c.className="btn btn-gray",c.textContent="删除",c.addEventListener("click",()=>{n.remove(),h(!1)}),n.append(o,i,r,c),t.el.holidayList.appendChild(n)})}function w(){t.el.examDate.value=t.config.examDate||"",t.el.excludeWeekends.checked=t.config.excludeWeekends,A(t.config.holidays),B()}function B(){const e=Object.keys(t.config.officialHolidays).length;if(!e){t.el.cacheStatus.className="zkc-pill",t.el.cacheStatus.textContent="尚未同步法定节假日";return}const a=t.config.lastSyncedAt?` · ${new Date(t.config.lastSyncedAt).toLocaleString("zh-CN",{hour12:!1})}`:"";t.el.cacheStatus.className="zkc-pill ok",t.el.cacheStatus.textContent=`已缓存 ${e} 天法定数据${a}`}function H(e){if(!e){t.el.totalDays.textContent="--",t.el.studyDays.textContent="--",t.el.weekendDays.textContent="--",t.el.holidayDays.textContent="--";return}t.el.totalDays.textContent=String(e.totalDays),t.el.studyDays.textContent=String(e.studyDays),t.el.weekendDays.textContent=String(e.weekendDays),t.el.holidayDays.textContent=String(e.holidayDays)}function L(e,a){t.el.summaryText.textContent=e,t.el.summaryMeta.replaceChildren(),a.forEach(n=>{const o=document.createElement("span");o.className="zkc-chip",o.textContent=n,t.el.summaryMeta.appendChild(o)})}function s(e,a="info",n=0){window.clearTimeout(t.noticeTimer),t.el.noticeBar.className=`zkc-notice ${a}`,t.el.noticeBar.textContent=e,n>0&&(t.noticeTimer=window.setTimeout(()=>{t.el.noticeBar.textContent===e&&(t.el.noticeBar.className="zkc-notice is-hidden info",t.el.noticeBar.textContent="")},n))}function $(){t.el.liveClock&&(t.el.liveClock.textContent=new Date().toLocaleTimeString("zh-CN",{hour12:!1}))}function Q(){$(),t.clockTimer&&window.clearInterval(t.clockTimer),t.clockTimer=window.setInterval($,1e3)}function X(e){const a=e.map(o=>{const i=f(o.start),r=f(o.end);return!i||!r?null:{start:Math.min(i.getTime(),r.getTime()),end:Math.max(i.getTime(),r.getTime())}}).filter(Boolean).sort((o,i)=>o.start-i.start);if(!a.length)return[];const n=[a[0]];for(let o=1;o<a.length;o+=1){const i=a[o],r=n[n.length-1];i.start<=r.end+N?r.end=Math.max(r.end,i.end):n.push(i)}return n}function ee(e,a){return a.some(n=>e>=n.start&&e<=n.end)}function M(e,a=new Date){var Y;const n=f(e.examDate),o=new Date(a);if(o.setHours(0,0,0,0),!n)return null;if(n<=o)return{expired:!0,totalDays:0,studyDays:0,weekendDays:0,holidayDays:0,adjustedWorkdays:0,classificationStart:"",classificationEnd:""};const i=X(e.holidays||[]),r=Math.round((n.getTime()-o.getTime())/N);let c=0,d=0,y=0,O=0;const g=T(o,1),W=T(n,-1);for(;g<=W;){const de=g.getTime(),F=b(g),R=g.getDay();let k=!1;ee(de,i)&&(y+=1,k=!0);const _=((Y=t.config)==null?void 0:Y.officialHolidays)||{};!k&&_[F]&&(_[F].isHoliday?y+=1:(O+=1,c+=1),k=!0),!k&&e.excludeWeekends&&(R===0||R===6)&&(d+=1,k=!0),k||(c+=1),g.setDate(g.getDate()+1)}return{expired:!1,totalDays:r,studyDays:c,weekendDays:d,holidayDays:y,adjustedWorkdays:O,classificationStart:b(T(o,1)),classificationEnd:b(W)}}function u(){const e=D(),a=M(e);if(!a){H(null),L("请选择中考日期后开始计算。系统会从明天开始统计，一直算到考试当天。",["支持本地保存","支持保存到文件和从文件恢复","支持联网同步法定节假日"]);return}if(a.expired){H(a),L(`考试日期 ${q(e.examDate)} 已到达或已过去，当前倒计时已归零。`,["如需继续使用，请修改为新的考试日期"]);return}H(a),L(`距离 ${q(e.examDate)} 还有 ${a.totalDays} 天，其中预计可用于高强度复习的时间约为 ${a.studyDays} 天。`,[`复习/休息统计区间：${a.classificationStart} 至 ${a.classificationEnd}`,`普通周末休息：${a.weekendDays} 天`,`假期休息：${a.holidayDays} 天`,`调休上课：${a.adjustedWorkdays} 天`])}function h(e){t.config=p({...t.config,...D()}),x(),B(),u(),e&&s("倒计时设置已保存，并重新计算。","success",2800)}function z(){window.clearTimeout(t.autoSaveTimer),t.autoSaveTimer=window.setTimeout(()=>h(!1),160)}function te(){const e=D().holidays;e.push(C("","","")),t.config=p({...t.config,holidays:e}),A(t.config.holidays),h(!1)}function ae(){window.confirm("恢复默认设置会清空当前考试日期、假期设置和法定节假日缓存，是否继续？")&&(t.config=v(),x(),w(),u(),s("已恢复默认倒计时设置。","success",2800))}function ne(){const e=new Set([new Date().getFullYear()]),a=f(t.el.examDate.value);return e.add(a?a.getFullYear():new Date().getFullYear()+1),Array.from(e).sort((n,o)=>n-o)}async function oe(e){const a=new AbortController,n=window.setTimeout(()=>a.abort(),8e3);try{const o=await fetch(`https://timor.tech/api/holiday/year/${e}`,{signal:a.signal});if(!o.ok)throw new Error(`HTTP ${o.status}`);const i=await o.json();if(i.code!==0||!i.holiday||typeof i.holiday!="object")throw new Error("返回数据格式不符合预期。");const r={};return Object.entries(i.holiday).forEach(([c,d])=>{const y=l(d.date||`${e}-${c}`);y&&(r[y]={isHoliday:!!d.holiday,name:typeof d.name=="string"&&d.name.trim()?d.name.trim():d.holiday?"法定节假日":"调休上课"})}),r}finally{window.clearTimeout(n)}}async function ie(){const e=ne(),a=t.el.syncBtn.textContent;t.el.syncBtn.disabled=!0,t.el.syncBtn.textContent="同步中...",s(`正在同步 ${e.join("、")} 年的法定节假日，请稍候。`,"info");try{const n={...t.config.officialHolidays};for(const o of e)Object.assign(n,await oe(o));t.config=p({...t.config,...D(),officialHolidays:n,lastSyncedAt:new Date().toISOString()}),x(),B(),u(),s(`同步完成，当前已缓存 ${Object.keys(t.config.officialHolidays).length} 天法定节假日数据。`,"success",3800)}catch(n){console.error("[zhongkao-countdown] holiday sync failed:",n),s("同步失败：请检查网络连接或稍后重试。原有缓存已保留。","error",4200)}finally{t.el.syncBtn.disabled=!1,t.el.syncBtn.textContent=a}}function re(){h(!1),m.ConfigTransferRuntime.downloadJson({...t.config,exportedAt:new Date().toISOString()},{fileName:`zhongkao-countdown-settings-${b(new Date)}.json`}),s("当前倒计时设置已保存到文件。","success",2400)}async function ce(e){const a=e.target.files&&e.target.files[0];if(a)try{const n=await m.ConfigTransferRuntime.readJson(a);t.config=p({...t.config,...n}),x(),w(),u(),s("已从文件恢复倒计时设置，并重新计算。","success",3200)}catch(n){console.error("[zhongkao-countdown] import failed:",n),s("恢复失败：文件内容不是有效的设置 JSON。","error",4200)}finally{e.target.value=""}}function se(){t.el.examDate.addEventListener("change",z),t.el.excludeWeekends.addEventListener("change",z),t.el.saveBtn.addEventListener("click",()=>h(!0)),t.el.resetBtn.addEventListener("click",ae),t.el.syncBtn.addEventListener("click",ie),t.el.exportBtn.addEventListener("click",re),t.el.importBtn.addEventListener("click",()=>t.el.fileInput.click()),t.el.fileInput.addEventListener("change",ce),t.el.addHolidayBtn.addEventListener("click",te),window.addEventListener("storage",e=>{e.key===S&&(j(),w(),u(),s("检测到其他页面更新了倒计时配置，当前页面已同步。","info",3200))})}function le(){t.root=document.getElementById("zhongkao-countdown"),t.root&&(V(),t.root.innerHTML=Z(),P(),j(),w(),se(),Q(),u(),t.mounted=!0)}m.ZhongkaoCountdownModule={ensureInitialized(){var e;if(!m.ConfigTransferRuntime){console.warn("[zhongkao-countdown] ConfigTransferRuntime is not ready");return}if(!t.mounted||!((e=document.getElementById("zhongkao-countdown"))!=null&&e.querySelector(".zkc-shell"))){le();return}$(),u()},_test:{computeCountdownMetrics:M,getAnnualExamDate:E,resolveAutoExamDate:I,normalizeConfig:p}}})(window);
