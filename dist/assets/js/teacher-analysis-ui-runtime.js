(()=>{if(typeof window=="undefined"||window.__TEACHER_ANALYSIS_UI_RUNTIME_PATCHED__)return;const a=typeof window.teacherToNumber=="function"?window.teacherToNumber:((t,i=0)=>{const r=Number(t);return Number.isFinite(r)?r:i}),b=typeof window.teacherFormatPercent=="function"?window.teacherFormatPercent:((t,i=1)=>`${(a(t,0)*100).toFixed(i)}%`),k=typeof window.teacherFormatSigned=="function"?window.teacherFormatSigned:((t,i=1)=>{const r=a(t,0);return`${r>=0?"+":""}${r.toFixed(i)}`}),o=typeof window.teacherEscapeHtml=="function"?window.teacherEscapeHtml:(t=>String(t!=null?t:"").replace(/[&<>"']/g,i=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[i])),M=typeof window.teacherGetWeightConfig=="function"?window.teacherGetWeightConfig:(()=>({avg:60,exc:70,pass:70,total:200})),_=typeof window.getCurrentUser=="function"?window.getCurrentUser:(()=>{var t;return((t=window.Auth)==null?void 0:t.currentUser)||null}),J=typeof window.normalizeSubject=="function"?window.normalizeSubject:(t=>String(t||"").trim()),j=typeof window.sortSubjects=="function"?window.sortSubjects:((t,i)=>String(t||"").localeCompare(String(i||""),"zh-Hans-CN")),H=typeof window.formatRankDisplay=="function"?window.formatRankDisplay:((t,i,r="school",n=!1)=>`${n?`${(a(t,0)*100).toFixed(2)}%`:a(t,0).toFixed(2)} <span style="font-size:0.9em; color:#94a3b8">(${i})</span>`),T={cardsSignature:"",cardsHtml:"",comparisonSignature:"",comparisonHtml:""};function B(t,i=""){const r=[String(i||"")];return Object.keys(t||{}).sort().forEach(n=>{r.push(`T:${n}`),Object.keys(t[n]||{}).sort(j).forEach(p=>{const l=t[n][p]||{};r.push([p,l.classesText||l.classes||"",l.studentCount,l.avg,l.avgValue,l.fairScore,l.fairRank,l.leagueScoreRaw,l.leagueScore,l.baselineAdjustment,l.baselineCoverageText,l.excellentRate,l.passRate,l.lowRate,l.conversionScore,l.conversionAdjustment,l.focusSummary,l.sampleStabilityText,l.teacherContinuityText].join("|"))})}),r.join("::")}function A(){return typeof window.getVisibleTeacherStats=="function"?window.getVisibleTeacherStats():window.TEACHER_STATS||{}}function Y(t){return typeof window.getVisibleSubjectsForTeacherUser=="function"?window.getVisibleSubjectsForTeacherUser(t):null}function I(t){const i=a(t==null?void 0:t.fairScore,(t==null?void 0:t.finalScore)||0),r=a(t==null?void 0:t.baselineAdjustment,0);return i>=85&&r>=0?{class:"performance-excellent",text:"优秀"}:i>=75?{class:"performance-good",text:"良好"}:i>=65?{class:"performance-average",text:"稳健"}:{class:"performance-poor",text:"待改进"}}function O(t,i,r="",n="guest"){const p=[];Object.keys(t||{}).forEach(c=>{Object.keys(t[c]||{}).forEach(d=>{var g,w;const e=t[c][d],v=I(e),x=((w=(g=i==null?void 0:i[c])==null?void 0:g[d])==null?void 0:w.rank)||"-";p.push({id:`${c}-${d}`,name:c,subject:d,classes:e.classesText||e.classes||"",avg:e.avg,fairScore:a(e.fairScore,0).toFixed(1),leagueScoreRaw:a(e.leagueScoreRaw,0).toFixed(1),leagueScore:a(e.leagueScore,0).toFixed(1),baselineAdjustment:k(e.baselineAdjustment,1),baselineCoverage:e.baselineCoverageText||"0%",sampleSummary:e.sampleSummary||"共同样本待识别",sampleStability:e.sampleStabilityText||"0%",conversionSummary:e.conversionSummary||"暂无转化样本",conversionScore:a(e.conversionScore,50).toFixed(1),excRate:b(e.excellentRate,1),passRate:b(e.passRate,1),lowRate:b(e.lowRate,1),focusSummary:e.focusSummary||"培优0 / 临界0 / 辅差0",count:e.studentCount,rank:x,badgeClass:v.class,badgeText:v.text})})});const l=String(r||"").replace(/\s+/g,"").toLowerCase();return p.sort((c,d)=>{if((n==="teacher"||n==="class_teacher")&&l){const x=String(c.name||"").replace(/\s+/g,"").toLowerCase(),g=String(d.name||"").replace(/\s+/g,"").toLowerCase(),w=x===l||x.startsWith(`${l}(`)||x.startsWith(`${l}（`),s=g===l||g.startsWith(`${l}(`)||g.startsWith(`${l}（`);if(w!==s)return w?-1:1}const e=a(d.fairScore,0)-a(c.fairScore,0);if(e!==0)return e;const v=a(d.leagueScore,0)-a(c.leagueScore,0);return v!==0?v:String(c.name||"").localeCompare(String(d.name||""),"zh-Hans-CN")}),p}function P(){const t=document.getElementById("teacherCardsContainer"),i=_(),r=(i==null?void 0:i.role)||"guest",n=A(),p=window.TEACHER_TOWNSHIP_RANKINGS||{},l=O(n,p,(i==null?void 0:i.name)||"",r);try{if(window.Alpine&&typeof window.Alpine.store=="function"){const e=window.Alpine.store("teacherData");e&&(e.list=l)}}catch(e){console.warn("teacherData store update skipped:",e)}if(!t)return;if(!l.length){t.innerHTML=`
            ...
            `;return}const c=B(n,[r,(i==null?void 0:i.name)||"",Object.keys(p||{}).sort().join("|")].join("|"));if(T.cardsSignature===c&&T.cardsHtml){t.dataset.teacherCardsSignature!==c&&(t.innerHTML=T.cardsHtml,t.dataset.teacherCardsSignature=c);return}const d=l.map(e=>`
        ...
        `).join("");T.cardsSignature=c,T.cardsHtml=d,t.dataset.teacherCardsSignature=c,t.innerHTML=d}function K(){const t=_(),i=(t==null?void 0:t.role)||"guest",r=i==="teacher"||i==="class_teacher"?Y(t):null,n=document.getElementById("teacher-township-ranking-container"),p=document.getElementById("side-nav-teacher-ranks-container");if(p&&(p.innerHTML=""),!n)return;if(typeof window.calculateTeacherTownshipRanking=="function"&&window.calculateTeacherTownshipRanking({teacherMetricScope:"admin"}),!window.TOWNSHIP_RANKING_DATA||!Object.keys(window.TOWNSHIP_RANKING_DATA).length){n.innerHTML='<div class="analysis-empty-state">暂无教师乡镇排名数据</div>';return}const l=window.TEACHER_TOWNSHIP_AVERAGES||{},c=s=>{const h=(s||[]).filter($=>$.type==="school"&&a($.studentCount,0)>0),f=h.length?h:(s||[]).filter($=>a($.studentCount,0)>0);let m=0,y=0,C=0,u=0;return f.forEach($=>{const S=a($.studentCount,0);S<=0||(m+=S,y+=a($.avg,0)*S,C+=a($.excellentRate,0)*S,u+=a($.passRate,0)*S)}),m<=0?null:{avg:y/m,excRate:C/m,passRate:u/m,count:m,source:h.length?"ranking-schools":"ranking-rows"}},d=(s,h)=>{const f=a(s,NaN),m=a(h,NaN);if(!Number.isFinite(f)||!Number.isFinite(m)||Math.abs(m)<1e-9)return{text:"—",value:null};const y=(f-m)/m*100;return{text:`${y>=0?"+":""}${y.toFixed(2)}%`,value:y}},e=s=>!s||s.value===null?"rank-muted":s.value>=0?"positive-percent":"negative-percent",v=[],x=(s,h)=>{const f=(h||[]).filter(m=>m.type==="teacher").slice().sort((m,y)=>a(m.rankAvg,99999)-a(y.rankAvg,99999)).slice(0,8);return f.length?`
            ...
            `:""};let g="";if((window.SUBJECTS||[]).forEach(s=>{var C;if(r&&r.size>0&&!r.has(J(s)))return;const h=(C=window.TOWNSHIP_RANKING_DATA)==null?void 0:C[s];if(!(h!=null&&h.length))return;const f=l[s]||c(h);let m="";h.forEach(u=>{const $=d(u.avg,f==null?void 0:f.avg),S=d(u.excellentRate,f==null?void 0:f.excRate),N=d(u.passRate,f==null?void 0:f.passRate),z=u.type==="teacher"?"text-blue":"",Z=u.type==="teacher"?"analysis-row-emphasis":"",ee=u.type==="teacher"?"analysis-row-badge analysis-row-badge-teacher":"analysis-row-badge analysis-row-badge-school",te=u.type==="teacher"?"教师":"学校";m+=`
                    <tr class="${Z}">
                        <td data-label="教师/学校" class="${z}">${o(u.name)}</td>
                        <td data-label="类型"><span class="${ee}">${te}</span></td>
                        <td data-label="平均分">${H(u.avg,u.rankAvg,"teacher")}</td>
                        <td data-label="与镇均比" class="${e($)}">${o($.text)}</td>
                        <td data-label="镇排">${o(u.rankAvg)}</td>
                        <td data-label="优秀率">${H(u.excellentRate,u.rankExc,"teacher",!0)}</td>
                        <td data-label="与镇均比" class="${e(S)}">${o(S.text)}</td>
                        <td data-label="镇排">${o(u.rankExc)}</td>
                        <td data-label="及格率">${H(u.passRate,u.rankPass,"teacher",!0)}</td>
                        <td data-label="与镇均比" class="${e(N)}">${o(N.text)}</td>
                        <td data-label="镇排">${o(u.rankPass)}</td>
                    </tr>
                `});const y=`rank-anchor-${s}`;if(v.push({subject:s,anchorId:y,count:h.length}),g+=`
            ...
            `,p){const u=document.createElement("a");u.className="side-nav-sub-link",u.innerText=s,u.onclick=()=>{typeof window.scrollToSubAnchor=="function"&&window.scrollToSubAnchor(y,u)},p.appendChild(u)}}),!g){n.innerHTML='<div class="analysis-empty-state">当前角色下暂无可见学科的教师乡镇排名数据</div>';return}const w=v.length?`<div class="teacher-township-jumpbar analysis-generated-panel">
                    <div>
            ...
            <div style="text-align:left;">
                ...
                <div class="table-wrap analysis-table-shell" style="max-height:55vh; overflow:auto;">
                    <table class="analysis-generated-table" style="width:100%; font-size:13px;">
                        ...
                        <tbody>
                            ${c.map(g=>{const w=Number.isFinite(g.gap)?Math.abs(g.gap).toFixed(1):"-",s=g.school||window.MY_SCHOOL||"";return`
                                    <tr>
                                        <td>${o(g.className||"-")}</td>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-sm btn-blue"
                                                onclick="window.jumpToStudent && window.jumpToStudent(${E(g.name)}, ${E(s)}, ${E(g.className)})">
                                                查看成绩单
                                            </button>
                                        </td>
                                    </tr>
...
${c.map(g=>{var w;return`${g.className||"-"} ${g.name||"-"} ${(w=g.score)!=null?w:"-"}`}).join(`
`)||l.empty}`)}function Q(t){t&&U(t.dataset.teacher||"",t.dataset.subject||"",t.dataset.focusType||"passEdges")}function W(){const t=document.getElementById("teacherComparisonTable"),i=A();if(!t)return;if(!Object.keys(i).length){t.innerHTML='<p style="text-align:center; color:#666;">暂无教师统计数据</p>';return}const r=B(i,["comparison",window.innerWidth<=860?"mobile":"desktop"].join("|"));if(T.comparisonSignature===r&&T.comparisonHtml){t.dataset.teacherComparisonSignature!==r&&(t.classList.add("comparison-table"),t.innerHTML=T.comparisonHtml,t.dataset.teacherComparisonSignature=r,typeof window.refreshResponsiveMobileTables=="function"&&window.refreshResponsiveMobileTables(t.closest(".section")||t));return}const n={};Object.keys(i).forEach(c=>{Object.keys(i[c]||{}).forEach(d=>{n[d]||(n[d]=[]),n[d].push({teacher:c,data:i[c][d]})})});let l=`
            <thead>
                <tr>
                    <th rowspan="2">教师</th>
                    <th rowspan="2">班级</th>
        ...
        `;Object.keys(n).sort(j).forEach(c=>{l+=`<tr style="background:#f1f5f9; font-weight:bold; color:#64748b;"><td colspan="14" style="text-align:left; padding-left:15px;">${o(c)}</td></tr>`,n[c].sort((d,e)=>a(e.data.fairScore,0)-a(d.data.fairScore,0)).forEach(d=>{var f;const e=d.data,v=a(e.baselineAdjustment,0)>=0?"text-green":"text-red",x=a(e.lowRate,0)>=.12?"color:#dc2626; font-weight:700;":"color:#334155;",g=e.sampleWarning?"color:#b45309; font-weight:700;":"color:#334155;",w=`基线覆盖 ${e.baselineCoverageText||"0%"}；预计均分 ${a(e.expectedAvg,0).toFixed(2)}；预计优率 ${b(e.expectedExcellentRate,1)}；预计及格率 ${b(e.expectedPassRate,1)}；预计低分率 ${b(e.expectedLowRate,1)}；任课连续性 ${e.teacherContinuityText||"任课连续"}${e.baselineExamId?`；基线 ${e.baselineExamId}`:""}`,s=(e.previousSampleCount||0)>0?`新增 ${e.addedSampleCount||0} / 缺考退出 ${e.exitedSampleCount||0}`:"暂无基线",h=`${a(e.conversionScore,50).toFixed(1)}${a(e.conversionAdjustment,0)?` (${k(e.conversionAdjustment,1)})`:""}`;l+=`
                    ...
                    `})}),l+="</tbody>",T.comparisonSignature=r,T.comparisonHtml=l,t.dataset.teacherComparisonSignature=r,t.classList.add("comparison-table"),t.innerHTML=l,typeof window.refreshResponsiveMobileTables=="function"&&window.refreshResponsiveMobileTables(t.closest(".section")||t)}function D(){return typeof window.ensureLazySectionLoaded=="function"&&window.ensureLazySectionLoaded("teacherModal"),document.getElementById("teacherModal")}function G(){if(window.__TEACHER_ANALYSIS_MODAL_BOUND__)return!0;const t=D(),i=document.getElementById("closeModal");return!t||!i?!1:(i.addEventListener("click",()=>{const r=document.getElementById("teacherModal");r&&(r.style.display="none")}),window.addEventListener("click",r=>{const n=document.getElementById("teacherModal");n&&r.target===n&&(n.style.display="none")}),window.__TEACHER_ANALYSIS_MODAL_BOUND__=!0,!0)}function X(t,i){var $,S,N,z;const r=A(),n=r[t]?r[t][i]:null;if(!n){window.UI&&window.UI.toast("当前筛选范围下暂无该教师该学科数据","warning");return}G();const p=D(),l=document.getElementById("modalSubjectTable"),c=document.getElementById("modalAvgProgress");if(!p||!l||!c)return;const d=document.getElementById("modalTeacherName"),e=document.getElementById("modalAvgScore"),v=document.getElementById("modalExcellentRate"),x=document.getElementById("modalPassRate"),g=document.getElementById("modalAvgComparison");d&&(d.textContent=`${t} - ${i} 教学详情`),e&&(e.textContent=n.avg),v&&(v.textContent=b(n.excellentRate,1)),x&&(x.textContent=b(n.passRate,1));const w=a(n.expectedAvg,NaN),s=a(n.avgValue,NaN),h=Number.isFinite(w)&&w>0&&Number.isFinite(s),f=h?(s-w)/w*100:null;g&&(g.textContent=h?`${f>=0?"+":""}${f.toFixed(1)}%`:"—");const m=h?Math.min(Math.max(50+f,0),100):50;c.style.width=`${m}%`,c.className=h?f>=0?"progress-good":"progress-poor":"progress-neutral",c.style.backgroundColor=h?f>=0?"#22c55e":"#ef4444":"#94a3b8";const y=l.querySelector("thead"),C=l.querySelector("tbody");y&&(y.innerHTML=`
                <tr>
                    <th>学科</th>
                    <th>实际均分</th>
                    <th>预计均分</th>
            ...
            `);let u=document.getElementById("teacherModalExtra");!u&&l.parentNode&&(u=document.createElement("div"),u.id="teacherModalExtra",u.style.marginBottom="16px",l.parentNode.insertBefore(u,l)),u&&(u.innerHTML=`
                ...
                <div style="border:1px solid #e2e8f0; border-radius:12px; padding:14px; background:#f8fafc;">
                    ...
                    <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(220px, 1fr)); gap:10px;">
                        <div>
                            <button type="button" onclick="window.showTeacherFocusTargets(${E(t)}, ${E(i)}, 'excellentEdges')" style="font-size:12px; color:#0f766e; font-weight:800; margin-bottom:4px; border:0; background:transparent; cursor:pointer; padding:0;">培优边缘生</button>
                            <div style="font-size:12px; color:#475569; line-height:1.7;">${o(R(($=n.focusTargets)==null?void 0:$.excellentEdges,"暂无培优边缘生"))}</div>
                        </div>
                        <div>
                            <button type="button" onclick="window.showTeacherFocusTargets(${E(t)}, ${E(i)}, 'passEdges')" style="font-size:12px; color:#1d4ed8; font-weight:800; margin-bottom:4px; border:0; background:transparent; cursor:pointer; padding:0;">及格临界生</button>
                            <div style="font-size:12px; color:#475569; line-height:1.7;">${o(R((S=n.focusTargets)==null?void 0:S.passEdges,"暂无及格临界生"))}</div>
                        </div>
                        <div>
                            <button type="button" onclick="window.showTeacherFocusTargets(${E(t)}, ${E(i)}, 'lowRisk')" style="font-size:12px; color:#b45309; font-weight:800; margin-bottom:4px; border:0; background:transparent; cursor:pointer; padding:0;">辅差关注生</button>
