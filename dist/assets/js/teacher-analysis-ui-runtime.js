(()=>{if(typeof window=="undefined"||window.__TEACHER_ANALYSIS_UI_RUNTIME_PATCHED__)return;const a=typeof window.teacherToNumber=="function"?window.teacherToNumber:((t,s=0)=>{const i=Number(t);return Number.isFinite(i)?i:s}),$=typeof window.teacherFormatPercent=="function"?window.teacherFormatPercent:((t,s=1)=>`${(a(t,0)*100).toFixed(s)}%`),A=typeof window.teacherFormatSigned=="function"?window.teacherFormatSigned:((t,s=1)=>{const i=a(t,0);return`${i>=0?"+":""}${i.toFixed(s)}`}),o=typeof window.teacherEscapeHtml=="function"?window.teacherEscapeHtml:(t=>String(t!=null?t:"").replace(/[&<>"']/g,s=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[s])),M=typeof window.teacherGetWeightConfig=="function"?window.teacherGetWeightConfig:(()=>({avg:60,exc:70,pass:70,total:200})),j=typeof window.getCurrentUser=="function"?window.getCurrentUser:(()=>{var t;return((t=window.Auth)==null?void 0:t.currentUser)||null}),O=typeof window.normalizeSubject=="function"?window.normalizeSubject:(t=>String(t||"").trim()),z=typeof window.sortSubjects=="function"?window.sortSubjects:((t,s)=>String(t||"").localeCompare(String(s||""),"zh-Hans-CN")),I=typeof window.formatRankDisplay=="function"?window.formatRankDisplay:((t,s,i="school",n=!1)=>`${n?`${(a(t,0)*100).toFixed(2)}%`:a(t,0).toFixed(2)} <span style="font-size:0.9em; color:#94a3b8">(${s})</span>`),C={cardsSignature:"",cardsHtml:"",comparisonSignature:"",comparisonHtml:""};function Z(){var n;const t=window.Grade9PoliticsReferenceRuntime,s=typeof window.getTeacherAnalysisDisplaySubjects=="function"?window.getTeacherAnalysisDisplaySubjects():[],i=(n=t==null?void 0:t.getSummary)==null?void 0:n.call(t);!t||typeof t.ensureSummary!="function"||!s.some(l=>O(l)==="政治")||Array.isArray(i==null?void 0:i.referenceSchools)&&i.referenceSchools.length||window.__TEACHER_POLITICS_REFERENCE_PROMISE__||(window.__TEACHER_POLITICS_REFERENCE_PROMISE__=Promise.resolve(t.ensureSummary()).then(l=>{var c;if(!Array.isArray(l==null?void 0:l.referenceSchools)||!l.referenceSchools.length)return;typeof window.calculateTeacherTownshipRanking=="function"&&window.calculateTeacherTownshipRanking({force:!0,teacherMetricScope:"admin"});const r=document.getElementById("teacher-township-ranking");(c=r==null?void 0:r.classList)!=null&&c.contains("active")&&V()}).catch(l=>console.warn("[teacher-township] 政治整理表学校参考读取失败:",(l==null?void 0:l.message)||l)).finally(()=>{window.__TEACHER_POLITICS_REFERENCE_PROMISE__=null}))}function P(t,s=""){const i=[String(s||"")];return Object.keys(t||{}).sort().forEach(n=>{i.push(`T:${n}`),Object.keys(t[n]||{}).sort(z).forEach(l=>{const r=t[n][l]||{};i.push([l,r.classesText||r.classes||"",r.studentCount,r.avg,r.avgValue,r.fairScore,r.fairRank,r.leagueScoreRaw,r.leagueScore,r.baselineAdjustment,r.baselineCoverageText,r.excellentRate,r.passRate,r.lowRate,r.conversionScore,r.conversionAdjustment,r.focusSummary,r.sampleStabilityText,r.teacherContinuityText].join("|"))})}),i.join("::")}function N(){return typeof window.getVisibleTeacherStats=="function"?window.getVisibleTeacherStats():window.TEACHER_STATS||{}}function ee(t){return typeof window.getVisibleSubjectsForTeacherUser=="function"?window.getVisibleSubjectsForTeacherUser(t):null}function L(t){const s=a(t==null?void 0:t.fairScore,(t==null?void 0:t.finalScore)||0),i=a(t==null?void 0:t.baselineAdjustment,0);return s>=85&&i>=0?{class:"performance-excellent",text:"优秀"}:s>=75?{class:"performance-good",text:"良好"}:s>=65?{class:"performance-average",text:"稳健"}:{class:"performance-poor",text:"待改进"}}function B(t,s,i="",n="guest"){const l=[];Object.keys(t||{}).forEach(c=>{Object.keys(t[c]||{}).forEach(d=>{var g,v;const e=t[c][d],w=L(e),b=((v=(g=s==null?void 0:s[c])==null?void 0:g[d])==null?void 0:v.rank)||"-";l.push({id:`${c}-${d}`,name:c,subject:d,classes:e.classesText||e.classes||"",avg:e.avg,fairScore:a(e.fairScore,0).toFixed(1),leagueScoreRaw:a(e.leagueScoreRaw,0).toFixed(1),leagueScore:a(e.leagueScore,0).toFixed(1),baselineAdjustment:A(e.baselineAdjustment,1),baselineCoverage:e.baselineCoverageText||"0%",sampleSummary:e.sampleSummary||"共同样本待识别",sampleStability:e.sampleStabilityText||"0%",conversionSummary:e.conversionSummary||"暂无转化样本",conversionScore:a(e.conversionScore,50).toFixed(1),excRate:$(e.excellentRate,1),passRate:$(e.passRate,1),lowRate:$(e.lowRate,1),focusSummary:e.focusSummary||"培优0 / 临界0 / 辅差0",count:e.studentCount,rank:b,badgeClass:w.class,badgeText:w.text})})});const r=String(i||"").replace(/\s+/g,"").toLowerCase();return l.sort((c,d)=>{if((n==="teacher"||n==="class_teacher")&&r){const b=String(c.name||"").replace(/\s+/g,"").toLowerCase(),g=String(d.name||"").replace(/\s+/g,"").toLowerCase(),v=b===r||b.startsWith(`${r}(`)||b.startsWith(`${r}（`),p=g===r||g.startsWith(`${r}(`)||g.startsWith(`${r}（`);if(v!==p)return v?-1:1}const e=a(d.fairScore,0)-a(c.fairScore,0);if(e!==0)return e;const w=a(d.leagueScore,0)-a(c.leagueScore,0);return w!==0?w:String(c.name||"").localeCompare(String(d.name||""),"zh-Hans-CN")}),l}function U(){const t=document.getElementById("teacherCardsContainer"),s=j(),i=(s==null?void 0:s.role)||"guest",n=N(),l=window.TEACHER_TOWNSHIP_RANKINGS||{},r=B(n,l,(s==null?void 0:s.name)||"",i);try{if(window.Alpine&&typeof window.Alpine.store=="function"){const e=window.Alpine.store("teacherData");e&&(e.list=r)}}catch(e){console.warn("teacherData store update skipped:",e)}if(!t)return;if(!r.length){t.innerHTML=`
            ...
            `;return}const c=P(n,[i,(s==null?void 0:s.name)||"",Object.keys(l||{}).sort().join("|")].join("|"));if(C.cardsSignature===c&&C.cardsHtml){(t.dataset.teacherCardsSignature!==c||!t.querySelector(".teacher-card"))&&(t.innerHTML=C.cardsHtml,t.dataset.teacherCardsSignature=c);return}const d=r.map(e=>`
        ...
        `).join("");C.cardsSignature=c,C.cardsHtml=d,t.dataset.teacherCardsSignature=c,t.innerHTML=d;try{typeof window.renderTeacherHighlights=="function"&&window.renderTeacherHighlights()}catch(e){console.warn("[teacher-cards] 本次要点渲染失败（不影响卡片）:",e)}}function V(){const t=j(),s=(t==null?void 0:t.role)||"guest",i=s==="teacher"||s==="class_teacher"?ee(t):null,n=document.getElementById("teacher-township-ranking-container"),l=document.getElementById("side-nav-teacher-ranks-container");if(l&&(l.innerHTML=""),!n)return;if(Z(),typeof window.calculateTeacherTownshipRanking=="function"&&window.calculateTeacherTownshipRanking({teacherMetricScope:"admin"}),!window.TOWNSHIP_RANKING_DATA||!Object.keys(window.TOWNSHIP_RANKING_DATA).length){n.innerHTML='<div class="analysis-empty-state">暂无教师乡镇排名数据</div>';return}const r=window.TEACHER_TOWNSHIP_AVERAGES||{},c=u=>{const h=(u||[]).filter(S=>S.type==="school"&&a(S.studentCount,0)>0),x=h.length?h:(u||[]).filter(S=>a(S.studentCount,0)>0);let m=0,y=0,E=0,R=0;return x.forEach(S=>{const f=a(S.studentCount,0);f<=0||(m+=f,y+=a(S.avg,0)*f,E+=a(S.excellentRate,0)*f,R+=a(S.passRate,0)*f)}),m<=0?null:{avg:y/m,excRate:E/m,passRate:R/m,count:m,source:h.length?"ranking-schools":"ranking-rows"}},d=(u,h)=>{const x=a(u,NaN),m=a(h,NaN);if(!Number.isFinite(x)||!Number.isFinite(m)||Math.abs(m)<1e-9)return{text:"—",value:null};const y=(x-m)/m*100;return{text:`${y>=0?"+":""}${y.toFixed(2)}%`,value:y}},e=u=>!u||u.value===null?"rank-muted":u.value>=0?"positive-percent":"negative-percent",w=[],b=(u,h)=>{const x=(h||[]).filter(m=>m.type==="teacher").slice().sort((m,y)=>a(m.rankAvg,99999)-a(y.rankAvg,99999)).slice(0,8);return x.length?`
            ...
            `:""},g=typeof window.getTeacherAnalysisDisplaySubjects=="function"?window.getTeacherAnalysisDisplaySubjects():window.SUBJECTS||[];let v="";if(g.forEach(u=>{var S;if(i&&i.size>0&&!i.has(O(u)))return;const h=(S=window.TOWNSHIP_RANKING_DATA)==null?void 0:S[u];if(!(h!=null&&h.length))return;const x=typeof window.getConfiguredDisplaySubjectLabel=="function"?window.getConfiguredDisplaySubjectLabel(u):u,m=typeof window.getConfiguredDisplaySubjectNotice=="function"?window.getConfiguredDisplaySubjectNotice(u):"",y=r[u]||c(h);let E="";h.forEach(f=>{const _=d(f.avg,y==null?void 0:y.avg),K=d(f.excellentRate,y==null?void 0:y.excRate),Q=d(f.passRate,y==null?void 0:y.passRate),ne=f.type==="teacher"?"text-blue":"",oe=f.type==="teacher"?"analysis-row-emphasis":"",se=f.type==="teacher"?"analysis-row-badge analysis-row-badge-teacher":"analysis-row-badge analysis-row-badge-school",ae=f.type==="teacher"?"教师":"学校";E+=`
                    <tr class="${oe}">
                        <td data-label="教师/学校" class="${ne}">${o(f.name)}</td>
                        <td data-label="类型"><span class="${se}">${ae}</span></td>
                        <td data-label="平均分">${I(f.avg,f.rankAvg,"teacher")}</td>
                        <td data-label="与镇均比" class="${e(_)}">${o(_.text)}</td>
                        <td data-label="镇排">${o(f.rankAvg)}</td>
                        <td data-label="优秀率">${I(f.excellentRate,f.rankExc,"teacher",!0)}</td>
                        <td data-label="与镇均比" class="${e(K)}">${o(K.text)}</td>
                        <td data-label="镇排">${o(f.rankExc)}</td>
                        <td data-label="及格率">${I(f.passRate,f.rankPass,"teacher",!0)}</td>
            ...
            `,l){const f=document.createElement("a");f.className="side-nav-sub-link",f.innerText=x,f.onclick=()=>{typeof window.scrollToSubAnchor=="function"&&window.scrollToSubAnchor(R,f)},l.appendChild(f)}}),!v){n.innerHTML='<div class="analysis-empty-state">当前角色下暂无可见学科的教师乡镇排名数据</div>';return}const p=w.length?`<div class="teacher-township-jumpbar analysis-generated-panel">
                    <div>
                ...
                </div>`:"";n.innerHTML=p+v,n.querySelectorAll("[data-rank-anchor]").forEach(u=>{u.addEventListener("click",()=>{var x;const h=u.getAttribute("data-rank-anchor");if(typeof window.scrollToSubAnchor=="function"){window.scrollToSubAnchor(h,u);return}(x=document.getElementById(h))==null||x.scrollIntoView({behavior:"smooth",block:"start"})})})}function k(t,s="暂无"){const i=(t||[]).slice(0,8);return i.length?i.map(n=>`${n.name}${n.className?`(${n.className})`:""}${Number.isFinite(n.score)?` ${n.score}`:""}`).join("、"):s}const F={excellentEdges:{label:"培优",title:"培优边缘生",color:"#0f766e",empty:"暂无培优边缘生"},passEdges:{label:"临界",title:"及格临界生",color:"#1d4ed8",empty:"暂无及格临界生"},lowRisk:{label:"辅差",title:"辅差关注生",color:"#b45309",empty:"暂无辅差关注生"}};function T(t){return o(JSON.stringify(String(t||"")))}function H(t,s,i,n){var c;const l=F[i]||F.passEdges,r=((c=n==null?void 0:n.focusTargets)==null?void 0:c[i])||[];return`
            <button
                type="button"
        ...
        `}function W(t,s,i){var w,b;const n=N(),l=(w=n==null?void 0:n[t])==null?void 0:w[s],r=F[i]||F.passEdges,c=Array.isArray((b=l==null?void 0:l.focusTargets)==null?void 0:b[i])?l.focusTargets[i]:[],d=`${t} / ${s} · ${r.title}`,e=c.length?`
            <div style="text-align:left;">
                ...
                <div class="table-wrap analysis-table-shell" style="max-height:55vh; overflow:auto;">
                    <table class="analysis-generated-table" style="width:100%; font-size:13px;">
                        ...
                        <tbody>
                            ${c.map(g=>{const v=Number.isFinite(g.gap)?Math.abs(g.gap).toFixed(1):"-",p=g.school||window.MY_SCHOOL||"";return`
                                    <tr>
                                        <td>${o(g.className||"-")}</td>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-sm btn-blue"
                                                onclick="window.openStudentSubjectDialog ? window.openStudentSubjectDialog(${T(g.name)}, ${T(p)}, ${T(g.className)}, ${T(s)}, { focusLabel: ${T(r.title)}, gap: ${Number.isFinite(g.gap)?Number(g.gap):"null"} }) : (window.jumpToStudent && window.jumpToStudent(${T(g.name)}, ${T(p)}, ${T(g.className)}))">
                                                查看${o(s)}情况
                                            </button>
                                        </td>
                                    </tr>
...
`)||r.empty}`)}function te(t){t&&W(t.dataset.teacher||"",t.dataset.subject||"",t.dataset.focusType||"passEdges")}function G(){const t=document.getElementById("teacherComparisonTable"),s=N();if(!t)return;if(!Object.keys(s).length){t.innerHTML=`
            ...
            `;return}const i=P(s,["comparison",window.innerWidth<=860?"mobile":"desktop"].join("|"));if(C.comparisonSignature===i&&C.comparisonHtml){t.dataset.teacherComparisonSignature!==i&&(t.classList.add("comparison-table"),t.innerHTML=C.comparisonHtml,t.dataset.teacherComparisonSignature=i,typeof window.refreshResponsiveMobileTables=="function"&&window.refreshResponsiveMobileTables(t.closest(".section")||t));return}const n={};Object.keys(s).forEach(c=>{Object.keys(s[c]||{}).forEach(d=>{n[d]||(n[d]=[]),n[d].push({teacher:c,data:s[c][d]})})});let r=`
            <thead>
                <tr>
                    <th rowspan="2">教师</th>
                    <th rowspan="2">班级</th>
        ...
        `;Object.keys(n).sort(z).forEach(c=>{r+=`<tr style="background:#f1f5f9; font-weight:bold; color:#64748b;"><td colspan="14" style="text-align:left; padding-left:15px;">${o(c)}</td></tr>`,n[c].sort((d,e)=>a(e.data.fairScore,0)-a(d.data.fairScore,0)).forEach(d=>{var h;const e=d.data,w=a(e.baselineAdjustment,0)>=0?"text-green":"text-red",b=a(e.lowRate,0)>=.12?"color:#dc2626; font-weight:700;":"color:#334155;",g=e.sampleWarning?"color:#b45309; font-weight:700;":"color:#334155;",v=`基线覆盖 ${e.baselineCoverageText||"0%"}；预计均分 ${a(e.expectedAvg,0).toFixed(2)}；预计优率 ${$(e.expectedExcellentRate,1)}；预计及格率 ${$(e.expectedPassRate,1)}；预计低分率 ${$(e.expectedLowRate,1)}；任课连续性 ${e.teacherContinuityText||"任课连续"}${e.baselineExamId?`；基线 ${e.baselineExamId}`:""}`,p=(e.previousSampleCount||0)>0?`新增 ${e.addedSampleCount||0} / 缺考退出 ${e.exitedSampleCount||0}`:"暂无基线",u=`${a(e.conversionScore,50).toFixed(1)}${a(e.conversionAdjustment,0)?` (${A(e.conversionAdjustment,1)})`:""}`;r+=`
                    ...
                    `})}),r+="</tbody>",C.comparisonSignature=i,C.comparisonHtml=r,t.dataset.teacherComparisonSignature=i,t.classList.add("comparison-table"),t.innerHTML=r,typeof window.refreshResponsiveMobileTables=="function"&&window.refreshResponsiveMobileTables(t.closest(".section")||t)}function q(){return typeof window.ensureLazySectionLoaded=="function"&&window.ensureLazySectionLoaded("teacherModal"),document.getElementById("teacherModal")}function X(){if(window.__TEACHER_ANALYSIS_MODAL_BOUND__)return!0;const t=q(),s=document.getElementById("closeModal");return!t||!s?!1:(s.addEventListener("click",()=>{const i=document.getElementById("teacherModal");i&&(i.style.display="none")}),window.addEventListener("click",i=>{const n=document.getElementById("teacherModal");n&&i.target===n&&(n.style.display="none")}),window.__TEACHER_ANALYSIS_MODAL_BOUND__=!0,!0)}function J(t,s){var R,S,f,_;const i=N(),n=i[t]?i[t][s]:null;if(!n){window.UI&&window.UI.toast("当前筛选范围下暂无该教师该学科数据","warning");return}X();const l=q(),r=document.getElementById("modalSubjectTable"),c=document.getElementById("modalAvgProgress");if(!l||!r||!c)return;const d=document.getElementById("modalTeacherName"),e=document.getElementById("modalAvgScore"),w=document.getElementById("modalExcellentRate"),b=document.getElementById("modalPassRate"),g=document.getElementById("modalAvgComparison");d&&(d.textContent=`${t} - ${s} 教学详情`),e&&(e.textContent=n.avg),w&&(w.textContent=$(n.excellentRate,1)),b&&(b.textContent=$(n.passRate,1));const v=a(n.expectedAvg,NaN),p=a(n.avgValue,NaN),u=Number.isFinite(v)&&v>0&&Number.isFinite(p),h=u?(p-v)/v*100:null;g&&(g.textContent=u?`${h>=0?"+":""}${h.toFixed(1)}%`:"—");const x=u?Math.min(Math.max(50+h,0),100):50;c.style.width=`${x}%`,c.className=u?h>=0?"progress-good":"progress-poor":"progress-neutral",c.style.backgroundColor=u?h>=0?"#22c55e":"#ef4444":"#94a3b8";const m=r.querySelector("thead"),y=r.querySelector("tbody");m&&(m.innerHTML=`
                <tr>
                    <th>学科</th>
                    <th>实际均分</th>
                    <th>预计均分</th>
            ...
            `),y&&(y.innerHTML=`
                <tr>
                    ...
                    <td class="${a(n.baselineAdjustment,0)>=0?"positive-percent":"negative-percent"}">${A(n.baselineAdjustment,1)}</td>
                </tr>
            `);let E=document.getElementById("teacherModalExtra");!E&&r.parentNode&&(E=document.createElement("div"),E.id="teacherModalExtra",E.style.marginBottom="16px",r.parentNode.insertBefore(E,r)),E&&(E.innerHTML=`
                <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(160px, 1fr)); gap:12px; margin-bottom:14px;">
                    ...
                    <div class="bg-gray-50" style="padding:12px; border-radius:12px;">
                        ...
                        <div style="font-size:22px; font-weight:800; color:${a(n.baselineAdjustment,0)>=0?"#15803d":"#dc2626"};">${A(n.baselineAdjustment,1)}</div>
                    ...
                    <div class="bg-gray-50" style="padding:12px; border-radius:12px;">
                        ...
                        <div style="font-size:12px; color:#64748b;">工作量修正 ${A(n.workloadAdjustment,1)}</div>
                    </div>
                    <div class="bg-gray-50" style="padding:12px; border-radius:12px;">
                    ...
                    <div class="bg-gray-50" style="padding:12px; border-radius:12px;">
                        ...
                        <div style="font-size:12px; color:#64748b;">${o(n.conversionSummary||"暂无转化样本")}${a(n.conversionAdjustment,0)?` · 调整 ${A(n.conversionAdjustment,1)}`:""}</div>
                    </div>
                    <div class="bg-gray-50" style="padding:12px; border-radius:12px;">
                ...
                <div style="border:1px solid #e2e8f0; border-radius:12px; padding:14px; background:#f8fafc;">
                    ...
                    <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(220px, 1fr)); gap:10px;">
                        <div>
                            ...
                            <div style="font-size:12px; color:#475569; line-height:1.7;">${o(k((R=n.focusTargets)==null?void 0:R.excellentEdges,"暂无培优边缘生"))}</div>
                        </div>
                        <div>
                            ...
                            <div style="font-size:12px; color:#475569; line-height:1.7;">${o(k((S=n.focusTargets)==null?void 0:S.passEdges,"暂无及格临界生"))}</div>
                        </div>
                        <div>
                            ...
                            <div style="font-size:12px; color:#475569; line-height:1.7;">${o(k((f=n.focusTargets)==null?void 0:f.lowRisk,"暂无辅差关注生"))}</div>
                        </div>
                    </div>
