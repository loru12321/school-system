(()=>{if(typeof window=="undefined"||window.__LOGIN_ENTRY_RUNTIME_PATCHED__)return;const _={school:{userPrefix:"User",userPlaceholder:"管理员账号 / 教师姓名",passPrefix:"Password",submit:"进入学校工作台",helper:"当前为学校端，验证通过后进入届别选择和工作台。"},parent:{userPrefix:"Student",userPlaceholder:"请输入学生姓名",passPrefix:"Password",submit:"家长端登录",helper:"家长端统一承接原学生端与家长端入口：填写学生姓名、班级和密码。首次使用默认密钥会被强制修改。"}};function $(){return window.Auth&&typeof window.Auth.getLoginPortal=="function"?window.Auth.getLoginPortal()==="parent"?"parent":"school":localStorage.getItem("LOGIN_PORTAL_V1")==="parent"?"parent":"school"}function A(t,e,n){if(!t)return null;let a=t.closest(".login-entry-field");a||(a=document.createElement("div"),a.className="login-entry-field",a.dataset.loginField=e,t.parentNode.insertBefore(a,t),a.appendChild(t));let o=a.querySelector(".login-entry-prefix");return o||(o=document.createElement("span"),o.className="login-entry-prefix",a.insertBefore(o,a.firstChild)),o.textContent!==n&&(o.textContent=n),a}function E(t=new Date){return String(R(t)-3)}function R(t=new Date){return t.getMonth()>=8?t.getFullYear():t.getFullYear()-1}function N(t=new Date){const e=Number(E(t)),n=[];for(let a=0;a<5;a+=1)n.push(String(e+a));return n}const I="LOGIN_GRADUATE_COHORT_TARGET_V1";function F(t=new Date){const e=Number(E(t)),n=new Set;for(let a=1;a<=6;a+=1){const o=e-a;o>=2e3&&n.add(String(o))}try{const a=JSON.parse(localStorage.getItem("COHORT_LIST")||"[]");(Array.isArray(a)?a:[]).forEach(o=>{var s;const l=((s=String((o==null?void 0:o.id)||(o==null?void 0:o.year)||"").match(/\d{4}/))==null?void 0:s[0])||"";l&&Number(l)<e&&n.add(l)})}catch(a){}return Array.from(n).sort((a,o)=>Number(o)-Number(a))}function H(){try{const t=sessionStorage.getItem(I)||"";return/^\d{4}$/.test(t)?t:""}catch(t){return""}}function x(t){const e=String(t||"").trim();try{/^\d{4}$/.test(e)?sessionStorage.setItem(I,e):sessionStorage.removeItem(I)}catch(n){}return/^\d{4}$/.test(e)?e:""}function Z(){var t;return H()||String(((t=document.getElementById("login-cohort-select"))==null?void 0:t.value)||"").trim()}function tt(t){const e=document.getElementById("login-graduate-cohort-panel"),n=document.getElementById("login-graduate-cohort-select");if(!e||!n)return;const a=F(),o=t!=="parent"&&a.length>0;if(e.hidden=!o,e.style.display=o?"":"none",e.setAttribute("aria-hidden",o?"false":"true"),!o){x("");return}const l=a.join("|");n.dataset.cohortYears!==l&&(n.innerHTML=a.map(r=>`<option value="${r}">${r}届 · 已毕业</option>`).join(""),n.dataset.cohortYears=l);const s=H();e.classList.toggle("is-selected",!!s&&a.includes(s)),s&&a.includes(s)&&(n.value=s)}function et(){const t=document.getElementById("login-graduate-cohort-button"),e=document.getElementById("login-graduate-cohort-select"),n=document.getElementById("login-graduate-cohort-helper"),a=document.getElementById("login-cohort-select");a&&a.dataset.graduateResetBound!=="1"&&(a.dataset.graduateResetBound="1",a.addEventListener("change",()=>{var o;x(""),(o=document.getElementById("login-graduate-cohort-panel"))==null||o.classList.remove("is-selected")})),!(!t||t.dataset.graduateBound==="1")&&(t.dataset.graduateBound="1",t.addEventListener("click",()=>{var s;const o=x((e==null?void 0:e.value)||"");(s=document.getElementById("login-graduate-cohort-panel"))==null||s.classList.toggle("is-selected",!!o),n&&(n.textContent=o?`已选择 ${o}届毕业生档案，登录后进入该届成绩。`:"请选择毕业届。");const l=document.getElementById("login-portal-helper");l&&o&&(l.textContent=`已选择 ${o}届毕业生成绩档案，请完成登录。`)}))}function at(t){var u;const e=(u=document.getElementById("login-pass"))==null?void 0:u.closest(".login-entry-field"),n=document.getElementById("login-form");if(!e||!n)return;let a=document.getElementById("login-cohort-group");a||(a=document.createElement("div"),a.id="login-cohort-group",a.className="login-clean-cohort",a.innerHTML=['<label for="login-cohort-select" class="login-clean-label">选择届别</label>','<div class="login-entry-field login-entry-field--select" data-login-field="cohort">','<span class="login-entry-prefix">Cohort</span>','<select id="login-cohort-select" data-login-cohort-select="1"></select>',"</div>"].join(""),e.insertAdjacentElement("afterend",a));const o=document.getElementById("login-cohort-select");if(!o)return;const l=N(),s=E(),d=o.dataset.cohortInitialized==="1"&&l.includes(o.value)?o.value:s,p=l.map(h=>`<option value="${h}">${h}届</option>`).join("");o.dataset.cohortYears!==l.join("|")&&(o.innerHTML=p,o.dataset.cohortYears=l.join("|")),o.value=d,o.dataset.cohortInitialized="1",a.style.display=t==="parent"?"none":"",a.setAttribute("aria-hidden",t==="parent"?"true":"false"),et(),tt(t)}function ot(){document.querySelectorAll(["#role-student",'label[for="role-student"]',"#form-student",'[data-portal="student"]','[data-login-open="student"]'].join(",")).forEach(t=>t.remove())}function nt(t){const e=document.querySelectorAll('#btn-role-school, [data-portal="school"], [data-login-open="school"]'),n=document.querySelectorAll('#btn-role-parent, [data-portal="parent"], [data-login-open="parent"]');e.forEach(a=>{a.textContent!=="学校端"&&(a.textContent="学校端"),a.classList.toggle("active",t==="school"),a.setAttribute("aria-pressed",t==="school"?"true":"false")}),n.forEach(a=>{a.textContent!=="家长端登录"&&(a.textContent="家长端登录"),a.classList.toggle("active",t==="parent"),a.setAttribute("aria-pressed",t==="parent"?"true":"false")})}function f(){const t=document.getElementById("login-overlay");if(!t)return;const e=$(),n=_[e]||_.school;ot(),nt(e),t.dataset.loginPortal=e,document.querySelectorAll("#login-overlay .advanced-input-group i, #login-overlay .login-field-icon").forEach(p=>p.remove());const a=document.getElementById("login-user"),o=document.getElementById("login-class"),l=document.getElementById("login-pass");A(a,"user",n.userPrefix),A(o,"class","Class"),A(l,"password",n.passPrefix),at(e),a&&(a.placeholder=n.userPlaceholder),o&&(o.placeholder="请输入学生班级，如 701"),l&&(l.placeholder="输入密码");const s=document.getElementById("login-class-group");if(s){const p=e==="parent";s.style.display=p?"block":"none",s.setAttribute("aria-hidden",p?"false":"true")}const r=document.getElementById("login-submit-button");r&&r.dataset.bootBusy!=="1"&&r.textContent!==n.submit&&(r.textContent=n.submit);const d=document.getElementById("login-portal-helper");d&&!String(d.textContent||"").includes("正在")&&d.textContent!==n.helper&&(d.textContent=n.helper)}const lt={getLoginPortal:function(){return window.Auth&&typeof window.Auth.getLoginPortal=="function"?window.Auth.getLoginPortal():$()},ensureSystemIntroModal:function(){return window.Auth&&typeof window.Auth.ensureSystemIntroModal=="function"?window.Auth.ensureSystemIntroModal():null},rebuildInstagramLoginShell:function(){const t=document.getElementById("login-overlay");if(!t)return null;if(t.dataset.igRebuilt==="true")return t;const e=t.dataset.loginPortal==="parent"?"parent":"school";t.dataset.loginPortal=e;const n=`
            ...
            `,t.dataset.passportRebuilt="true",t},getSystemIntroContent:function(t=this.getLoginPortal()){const e=t==="parent"?"parent":"school";return{chip:e==="parent"?"家长端说明":"学校端说明",title:"校衡台如何使用",copy:"系统介绍集中说明使用流程、模块结构、角色权限、成绩计算和绩效比较规则，首页不再直接展开这些说明。",spotlight:e==="parent"?{label:"当前入口重点",title:"家长端只看学生个人成绩、成长报告与关键提醒",copy:"无论从家长端还是学校端进入，系统都使用同一份成绩数据、同一套比较口径与统一权限边界。"}:{label:"当前入口重点",title:"学校端覆盖数据维护、教学分析、绩效比较与结果输出",copy:"管理员、教务、班主任与教师都在同一套口径下工作，网页端与 Android 端看到的核心结果保持一致。"},quickStats:[{label:"适用角色",value:"管理员 / 教务 / 年级负责人 / 班主任 / 教师 / 家长"},{label:"核心模块",value:"数据导入、综合分析、教师分析、成长报告、绩效比较"},{label:"统一口径",value:"Web、客户端与家长端共用同一套数据和规则"}],sections:[{title:"系统如何使用",copy:"建议按“导入数据 -> 校验参数 -> 进入分析 -> 生成结果 -> 导出或同步”的顺序使用。",type:"steps",items:[{label:"1. 导入与建档",text:"在数据枢纽上传原始成绩、班级名册、任课表与历史考试，系统会自动识别学校、班级和学科。"},{label:"2. 校验口径",text:"按考试或年级配置总分、优良及格线、分层阈值和比较参数，确保不同批次结果可直接对照。"},{label:"3. 进入分析",text:"进入综合分析、教师分析、进退步追踪、学生详情和横向对比模块查看结果。"},{label:"4. 输出结果",text:"生成成绩单、成长报告、整改任务、绩效比较结果，并按需要同步云端或分发移动端。"}]},{title:"系统有哪些模块",copy:"工作区按“数据、分析、管理、报告、服务”组织，常用模块会围绕同一份成绩库联动。",type:"grid",items:[{label:"数据枢纽",text:"导入成绩、历史档案、任课表和基础配置，是全部分析的起点。"},{label:"综合分析 / 两率一分",text:"查看均分、优秀率、及格率、总分、排名、分层和质量预警。"},{label:"教师分析 / 教学评价",text:"结合任课表、历史基线和联考口径比较教师学科绩效。"},{label:"学生详情 / 成长报告",text:"查看单个学生成绩、排名变化、报告卡和家长端展示结果。"},{label:"横向对比 / 绩效比较",text:"按学校、班级、教师、学科和多次考试做同口径比较。"},{label:"系统维护",text:"维护账号、权限、版本信息与云端同步。"}]},{title:"不同角色有哪些权限",copy:"系统按职责分层授权，用户只会看到与自己职责相关的模块和数据范围。",type:"roles",items:[{label:"管理员 / 教务",text:"维护账号与权限、导入全校数据、管理考试参数、查看全部分析和导出结果。"},{label:"年级负责人",text:"查看本年级质量分析、横向比较、分层名单、整改任务和汇总结果。"},{label:"班主任",text:"查看本班学生成绩、成长报告、临界生名单、班级比较和家校提醒。"},{label:"学科教师",text:"聚焦本人任课班级与学科，查看教学绩效、进退步和培优辅差名单。"},{label:"家长 / 学生",text:"只查看个人成绩、成长报告、排名变化与提醒，不参与后台维护。"}]},{title:"如何计算成绩",copy:"所有结果都基于导入成绩与当前参数自动计算，不依赖人工手工拼表。",type:"metrics",items:[{label:"基础汇总",text:"系统会按科目自动生成单科分、总分、均分、班级/年级/镇域排名，并保留缺考、作弊等特殊值处理口径。"},{label:"等级与达线",text:"根据优良及格线、目标线或分层线自动生成优秀率、及格率、达线人数与临界名单。"},{label:"进退步",text:"把本次考试和历史考试按学生或班级匹配，比对总分、单科、排名和达线变化。"},{label:"统一结果",text:"同一套配置会同时作用于网页端、Android 和家长端，保证查看和导出结果一致。"}]},{title:"如何比较绩效",copy:"绩效比较强调同条件、同口径、同维度，避免只看单次原始分数。",type:"metrics",items:[{label:"横向比较",text:"在同年级、同学科、同考试条件下比较学校、班级和教师的均分、两率一分与达线情况。"},{label:"纵向比较",text:"按多次考试连续比较进退步、稳定性、目标达成率和阶段改善幅度。"},{label:"基线校正",text:"教师绩效会结合历史基础或同基础学生分层，比较实际表现与预期表现，减少生源差异影响。"},{label:"结果落地",text:"比较结果会继续联动到培优辅差、整改任务、学生详情和报告生成，形成闭环。"}]},{title:"数据同步与结果输出",copy:"系统既适合办公室 Web，也支持移动端与外部查看。",type:"grid",items:[{label:"Web / 客户端",text:"网页端与客户端共用统一登录入口与主要工作流，便于办公室电脑、手机和本地桌面端切换。"},{label:"导出与分发",text:"可输出成绩单、成长报告、对比结果与分发版页面，便于班主任或家长查看。"},{label:"云端协同",text:"支持账号同步、数据同步与结果一致性校验，版本更新后继续沿用同一套业务规则。"},{label:"使用建议",text:"每次新考试先导入原始数据并核对阈值，再做分析和绩效比较，结果会更稳定。"}]}]}},renderSystemIntroModal:function(t=this.getLoginPortal()){var h,w,k;const e=this.ensureSystemIntroModal();if(!e)return null;const n=this.getSystemIntroContent(t),a=e.querySelector("[data-intro-chip]"),o=e.querySelector("[data-intro-title]"),l=e.querySelector("[data-intro-copy]"),s=e.querySelector("[data-intro-focus-label]"),r=e.querySelector("[data-intro-focus-title]"),d=e.querySelector("[data-intro-focus-copy]"),p=e.querySelector("[data-intro-quickstats]"),u=e.querySelector("[data-intro-body]");if(a&&(a.textContent=n.chip),o&&(o.textContent=n.title),l&&(l.textContent=n.copy),s&&(s.textContent=((h=n.spotlight)==null?void 0:h.label)||""),r&&(r.textContent=((w=n.spotlight)==null?void 0:w.title)||""),d&&(d.textContent=((k=n.spotlight)==null?void 0:k.copy)||""),p&&(p.innerHTML=(n.quickStats||[]).map(v=>`
                    ...
                    `};u.innerHTML=(n.sections||[]).map((g,y)=>`
                    ...
                    `).join("")}return e},syncLoginPortalUI:function(t=this.getLoginPortal()){const e=t==="parent"?"parent":"school",n=document.getElementById("login-overlay");n&&(n.dataset.loginPortal=e);const a=document.getElementById("login-portal-hub");a&&(a.dataset.loginPortal=e),document.querySelectorAll(".login-portal-card[data-portal], .login-portal-chip[data-portal]").forEach(c=>{c.classList.toggle("active",c.dataset.portal===e),c.setAttribute("aria-pressed",c.dataset.portal===e?"true":"false")});const o=document.getElementById("login-portal-badge"),l=document.getElementById("login-portal-copy"),s=document.getElementById("login-user"),r=document.getElementById("login-class"),d=document.getElementById("login-class-group"),p=document.getElementById("login-user-helper"),u=document.getElementById("login-portal-helper"),h=document.getElementById("login-submit-button"),w=document.getElementById("login-user-label"),k=document.getElementById("login-class-label-note"),v=document.getElementById("login-stage-kicker"),g=document.getElementById("login-stage-title"),y=document.getElementById("login-stage-copy"),S=document.querySelector(".login-stage-meta"),P=document.getElementById("login-stage-featured-title"),m=document.getElementById("login-stage-featured-copy"),j=document.getElementById("login-modal-chip"),O=document.getElementById("login-modal-title"),K=document.getElementById("login-modal-copy"),U=document.querySelector(".login-auth-title"),z=document.querySelector(".login-portal-launch-head span"),V=document.querySelector(".login-portal-launch-head p"),J=document.querySelector(".login-portal-note"),Q=document.getElementById("login-auth-facts");Q&&Q.remove();const i=e==="parent"?{badge:"家长成长入口",authTitle:"登录入口",copy:"",userLabel:"学生姓名",userPlaceholder:"请输入学生姓名",userHelper:"建议使用学生姓名登录，并完整填写班级信息。",classNote:"(家长端必填，如 701)",classPlaceholder:"请输入学生班级，如 701",helper:"当前为家长端，验证后进入成长报告与成绩视图。",submit:"进入家长端",stageKicker:"Family Growth Portal",stageTitle:'<span class="login-stage-title-line">查看成长报告</span><span class="login-stage-title-line login-stage-title-line--accent">更轻、更清楚、更直接</span>',stageCopy:"像 Instagram 一样把入口和动作分清楚，让家长端登录页更聚焦，也更适合移动端。",stageMeta:[{icon:"ti ti-heart-handshake",text:"成长报告 / 成绩查询 / 家校提醒"},{icon:"ti ti-devices",text:"手机、安卓与桌面端共用同一套入口"},{icon:"ti ti-sparkles",text:"当前稳定版 v1.0 · 2026-04-08"}],launchKicker:"登录窗口",launchCopy:"先选择家长端，再打开唯一登录窗口；表单和说明各归其位。",launchNote:"系统介绍会说明角色权限、流程和成绩规则。",stageFeatureTitle:"家长端聚焦成绩、报告与提醒",stageFeatureCopy:"首页只留下最重要的入口和价值点，避免像旧版那样把所有信息都堆在首屏。",modalChip:"家长端登录窗口",modalTitle:"进入家长端",modalCopy:"输入学生姓名、班级与密码后，直接查看成长报告、成绩与家校提醒。",navButton:"打开家长端"}:{badge:"学校工作台",authTitle:"登录入口",copy:"",userLabel:"账号 / 姓名",userPlaceholder:"管理员账号 / 教师姓名",userHelper:"支持管理员、教务、年级、班主任与教师账号登录。",classNote:"(学校端无需填写)",classPlaceholder:"学校端无需填写",helper:"当前为学校端，验证通过后直达教学分析与数据维护。",submit:"进入学校工作台",stageKicker:"School Command Center",stageTitle:'<span class="login-stage-title-line">统一登录</span><span class="login-stage-title-line login-stage-title-line--accent">把学校端和家长端放在一张首页里</span>',stageCopy:"借鉴 Instagram 的左右双栏逻辑，把品牌、入口和表单层级重新理顺。",stageMeta:[{icon:"ti ti-layout-dashboard",text:"教学分析 / 数据维护 / 学校工作台"},{icon:"ti ti-devices",text:"Web、Android 与 Desktop 共用入口逻辑"},{icon:"ti ti-sparkles",text:"当前稳定版 v1.0 · 2026-04-08"}],launchKicker:"登录窗口",launchCopy:"先选学校端或家长端，再在唯一登录窗口里完成验证，减少跳转和视觉噪音。",launchNote:"系统介绍会说明模块结构、角色权限和核心逻辑。",stageFeatureTitle:"登录与系统说明各自独立",stageFeatureCopy:"首屏只负责建立品牌感和主入口，不再把所有解释文字都堆到同一块大面板里。",modalChip:"学校端登录窗口",modalTitle:"进入学校端",modalCopy:"输入账号与密码后，直接进入教学分析、数据维护与学校工作台。",navButton:"打开学校端"};if(e==="parent"?Object.assign(i,{badge:"家长身份验证",authTitle:"家长登录",copy:"家长端验证成功后，直接进入成长报告、成绩与提醒页面。",helper:"当前为家长端，验证成功后直接进入成长查看界面。",submit:"进入家长端",stageKicker:"Family Portal",stageTitle:'<span class="login-stage-title-line">家长端登录</span><span class="login-stage-title-line login-stage-title-line--accent">验证后直接查看成长数据</span>',stageCopy:"家长端保持轻量路径，输入学生姓名、班级和密码后，直接查看成长报告、成绩与提醒。",stageFeatureTitle:"家长端保持直接进入成长视图",stageFeatureCopy:"学校端与家长端共用同一张登录页，但家长端不进入届别选择，验证后直接打开成长数据。",launchKicker:"Switch Portal",launchCopy:"切换到家长端后，内联表单会自动改成学生姓名、班级和密码验证。",launchNote:"家长端仍然保留直接进入成长查看的短路径。"}):Object.assign(i,{badge:"学校身份验证",authTitle:"登录验证",copy:"学校端验证成功后，会先进入届别选择界面，再进入对应届别工作台。",helper:"当前为学校端，验证成功后会先进入届别选择界面。",submit:"验证并进入届别选择",stageKicker:"Step 1 / Login",stageTitle:'<span class="login-stage-title-line">先登录</span><span class="login-stage-title-line login-stage-title-line--accent">再选择届别进入工作台</span>',stageCopy:"登录页只负责身份验证，不再把届别选择和主工作台混在同一层里。",stageFeatureTitle:"登录成功后不会直接进入系统",stageFeatureCopy:"学校端固定采用“登录验证 → 届别选择 → 工作台”的路径，避免直接落到错误届别或空模块。",launchKicker:"Two-step Flow",launchCopy:"学校端与家长端共用内联登录页，但学校端验证后必须先经过届别选择。",launchNote:"下载与系统说明都留在辅助入口里，登录动作本身只负责验证。"}),Object.entries({school:{title:"学校端",desc:"教学分析、数据维护与学校管理入口。",meta:"Analysis / Data / Workspace",action:"打开学校端窗口"},parent:{title:"家长端",desc:"成长报告、成绩查询与家校提醒入口。",meta:"Report / Score / Reminder",action:"打开家长端窗口"}}).forEach(([c,C])=>{const b=document.querySelector(`.login-portal-card[data-portal="${c}"], .login-portal-chip[data-portal="${c}"]`);if(!b)return;const B=b.querySelector(".login-portal-title"),T=b.querySelector(".login-portal-desc"),M=b.querySelector(".login-portal-meta"),q=b.querySelector(".login-portal-action");B&&(B.textContent=C.title),T&&(T.textContent=C.desc),M&&(M.textContent=C.meta),q&&(q.textContent=C.action),!B&&!T&&!M&&!q&&(b.textContent=C.title)}),o&&(o.textContent=i.badge),l){const c=String(i.copy||"").trim();l.textContent=c,l.style.display=c?"":"none",l.setAttribute("aria-hidden",c?"false":"true")}w&&(w.textContent=i.userLabel),s&&(s.placeholder=i.userPlaceholder),p&&(p.textContent=i.userHelper),k&&(k.textContent=i.classNote),r&&(r.placeholder=i.classPlaceholder),d&&(d.style.display=e==="parent"?"block":"none",d.setAttribute("aria-hidden",e==="parent"?"false":"true")),u&&(u.textContent=i.helper),h&&(h.textContent=i.submit),v&&(v.textContent=i.stageKicker),g&&(g.innerHTML=i.stageTitle),y&&(y.textContent=i.stageCopy),S&&(S.innerHTML=(i.stageMeta||[]).map(c=>`<span><i class="${c.icon}"></i> ${c.text}</span>`).join("")),P&&(P.textContent=i.stageFeatureTitle),m&&(m.textContent=i.stageFeatureCopy),U&&(U.textContent=i.authTitle),z&&(z.textContent=i.launchKicker),V&&(V.textContent=i.launchCopy),J&&(J.textContent=i.launchNote),j&&(j.textContent=i.modalChip),O&&(O.textContent=i.modalTitle),K&&(K.textContent=i.modalCopy);const X=document.querySelector(".login-stage-nav-login");X&&(X.textContent=i.navButton||"打开登录窗口"),this.renderSystemIntroModal(e)}};window.LoginEntryRuntime=lt;function L(t){if(!window.Auth||window.Auth[`__loginEntryPatched_${t}`])return!1;const e=window.Auth[t];return typeof e!="function"?!1:(window.Auth[t]=function(...a){const o=e.apply(this,a);return setTimeout(f,0),o},window.Auth[`__loginEntryPatched_${t}`]=!0,!0)}function D(){window.Auth&&(L("syncLoginPortalUI"),L("setLoginPortal"),L("rebuildPassportLoginShell"),L("ensureLoginWorkbench"))}function G(){window.Auth&&typeof window.Auth.login=="function"&&window.Auth.login()}function Y(){document.querySelectorAll("[data-login-portal-action]").forEach(t=>{t.dataset.loginEntryBound!=="1"&&(t.dataset.loginEntryBound="1",t.addEventListener("click",()=>{const e=t.dataset.loginPortalAction==="parent"?"parent":"school";window.Auth&&typeof window.Auth.setLoginPortal=="function"&&window.Auth.setLoginPortal(e)}))}),document.querySelectorAll("[data-login-submit]").forEach(t=>{t.dataset.loginEntryBound!=="1"&&(t.dataset.loginEntryBound="1",t.addEventListener("click",G))}),document.querySelectorAll("[data-login-submit-on-enter]").forEach(t=>{t.dataset.loginEntryBound!=="1"&&(t.dataset.loginEntryBound="1",t.addEventListener("keydown",e=>{e.key==="Enter"&&G()}))})}function W(){f(),Y(),D();const t=new MutationObserver(()=>f()),e=document.getElementById("login-overlay");e&&t.observe(e,{childList:!0,subtree:!0});let n=0;const a=setInterval(()=>{n+=1,D(),f(),Y(),n>80&&clearInterval(a)},250)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",W,{once:!0}):W(),window.polishLoginEntryShell=f,window.BootCohortLifecycle=window.BootCohortLifecycle||{getAcademicYear:R,getCurrentGrade9CohortYear:E,getLoginCohortYears:N,getGraduatedCohortYears:F,getSelectedLoginCohortYear:Z,clearGraduateTarget:()=>x("")},window.__LOGIN_ENTRY_RUNTIME_PATCHED__=!0})();
