(()=>{if(typeof window=="undefined"||window.__FRESHMAN_EXAM_RUNTIME_PATCHED__)return;let M=[],v=typeof window.readFbClassesState=="function"?window.readFbClassesState():Array.isArray(window.FB_CLASSES)?window.FB_CLASSES:[],L=-1,se={},$=[],k=[],F=[],re=null;const x={schemeSelectorSignature:"",schemeSelectorHtml:"",dashboardSignature:"",dashboardHtml:"",balanceSignature:"",balanceChartSignature:"",balanceTableHtml:"",examOverviewSignature:"",examOverviewHtml:"",examStudentListSignature:"",examStudentListHtml:"",examProctorSignature:"",examProctorHtml:"",examPrintSignature:"",examPrintHtml:""};let K=!1;function ie(e=v){return(Array.isArray(e)?e:[]).map(n=>[n==null?void 0:n.id,n==null?void 0:n.name,Array.isArray(n==null?void 0:n.students)?n.students.length:0,Array.isArray(n==null?void 0:n.students)?n.students.map(t=>`${t.name}:${t.score}:${t.gender}:${t.isDiff||t._isDiff?1:0}`).join(","):""].join(":")).join("|")}function Ae(e=[]){const n=Array.isArray(e)?e:[],t=n.length;let o=0,a=0,s=0;return n.forEach(r=>{o+=Number(r==null?void 0:r.score)||0,(r==null?void 0:r.gender)==="M"&&(a+=1),(r!=null&&r.isDiff||r!=null&&r._isDiff)&&(s+=1)}),{avg:t?o/t:0,male:a,female:t-a,diff:s,count:t}}function Q(){return(Array.isArray(k)?k:[]).map(e=>{const n=Array.isArray(e==null?void 0:e.students)?e.students:[];return[e==null?void 0:e.id,n.length,n.map(t=>[t==null?void 0:t.examNo,t==null?void 0:t.name,t==null?void 0:t.class,t==null?void 0:t.roomNo,t==null?void 0:t.seatNo,t==null?void 0:t.score].join(":")).join(",")].join("|")}).join("||")}function et(){const e=typeof window.readFbClassesState=="function"?window.readFbClassesState():Array.isArray(window.FB_CLASSES)?window.FB_CLASSES:[];return Array.isArray(e)&&(v=e),window.FB_CLASSES=v,v}function ke(e){const n=typeof window.setFbClassesState=="function"?window.setFbClassesState(e):Array.isArray(e)?e:[];return v=Array.isArray(n)?n:[],window.FB_CLASSES=v,v}function Le(){return window.CONFIG||{name:"学校"}}const tt=Object.freeze(["语文","数学","英语","物理","化学"]),nt=Object.freeze({语文:1,数学:1,英语:1,物理:.9,化学:.6}),j=Object.freeze(["语文","数学","英语"]),Me=150,le=Me*.85,ce=Me*.6;function U(e){return String(e==null?"":e).replace(/\s+/g,"").trim()}function J(e){return String(e==null?"":e).replace(/\s+/g,"").trim()}function at(e){const n=J(e&&(e.id||e.examNo||e.studentId));return n&&n!=="-"&&n!=="0"?"id:"+n:"name:"+U(e&&e.name)}function ot(e=3){const n=typeof window.COHORT_DB=="object"&&window.COHORT_DB?window.COHORT_DB:null,t=n&&n.exams&&typeof n.exams=="object"?n.exams:null;if(!t)return[];const o=Object.keys(t).map(a=>{const s=t[a]||{},r=s.meta||{},i=String(r.date||r.examDate||"").trim(),l=Date.parse(i)||Number(s.updatedAt)||Number(s.createdAt)||0;return{examId:a,meta:r,data:Array.isArray(s.data)?s.data:[],subjects:Array.isArray(s.subjects)?s.subjects:[],ts:l,dateStr:i,label:String(r.type||r.examName||a)}}).filter(a=>a.data.length>0);return o.sort((a,s)=>s.ts-a.ts),o.slice(0,Math.max(1,Math.min(e,3)))}function st(e,n){const t=e&&e.scores&&typeof e.scores=="object"?e.scores:{};if(String(n)==="9"){let s=0,r=0;return tt.forEach(i=>{const l=Number(t[i]);Number.isFinite(l)&&(s+=l*nt[i],r+=1)}),r>0?{score:s,subjectsGot:r}:null}const o=Number(e&&e.total);if(Number.isFinite(o)&&o>0)return{score:o,subjectsGot:-1};const a=Object.values(t).map(Number).filter(Number.isFinite);return a.length?{score:a.reduce((s,r)=>s+r,0),subjectsGot:a.length}:null}let T={},R={},Y=[],Z=[],D=null;function de(e={}){var h,w;const n=String(e.targetGrade||((h=document.getElementById("fb_target_grade"))==null?void 0:h.value)||"7").trim(),t=Math.max(1,Math.min(Number(e.examLimit||((w=document.getElementById("fb_exam_count"))==null?void 0:w.value)||2),3)),o=ot(t);if(!o.length)return window.UI.alert("未找到本届别的云端考试数据，请先在「数据准备」上传并同步成绩。"),null;const a=o.length>=3?[.5,.3,.2]:o.length===2?[.6,.4]:[1],s=Array.isArray(e.weights)&&e.weights.length===o.length?e.weights:a,r=new Map,i=new Map;o.forEach((m,g)=>{const b=s[g]||0;m.data.forEach(y=>{const S=at(y),E=U(y.name);E&&(i.has(E)||i.set(E,new Set),i.get(E).add(J(y.id||y.examNo||y.studentId)||"(无考号)"));const _=st(y,n);if(!_)return;r.has(S)||r.set(S,{name:y.name||"未知",id:J(y.id||y.examNo||y.studentId),class:y.class||"",wSum:0,scoreSum:0,examsGot:0,subj:{语文:{s:0,w:0},数学:{s:0,w:0},英语:{s:0,w:0}}});const I=r.get(S);I.wSum+=b,I.scoreSum+=_.score*b,I.examsGot+=1;const O=y&&y.scores&&typeof y.scores=="object"?y.scores:{};j.forEach(d=>{const B=Number(O[d]);Number.isFinite(B)&&(I.subj[d].s+=B*b,I.subj[d].w+=b)})})});const l=[];i.forEach((m,g)=>{const b=[...m].filter(y=>y&&y!=="(无考号)");(m.size>1||b.length===0&&[...r.values()].filter(y=>U(y.name)===g).length>1)&&l.push({name:g,ids:[...m]})});let c=0,u=0,p=0;const f=[];return r.forEach((m,g)=>{const b=m.wSum>0?m.scoreSum/m.wSum:0;m.wSum<=0&&(p+=1);let y=T[g];y||(y=T["name:"+U(m.name)]),y||(y="F",u+=1);const S=!!(R[g]||R["name:"+U(m.name)]),E={};j.forEach(_=>{const I=m.subj&&m.subj[_];E[_]=I&&I.w>0?I.s/I.w:null}),f.push({_id:c++,key:g,name:m.name,id:m.id,srcClass:m.class,gender:y,score:parseFloat(b.toFixed(2)),subjAvg:E,examsGot:m.examsGot,examsTotal:o.length,height:160,vision:5,isDiff:S,isViolation:S,remarks:"",constraints:{same:[],diff:[]},classIdx:-1})}),M=f,D={targetGrade:n,examCount:o.length,examLabels:o.map(m=>`${m.label}${m.dateStr?"("+m.dateStr+")":""}`),weights:s,matched:f.length,dupGroups:l,missingGender:u,missingScore:p,violationTotal:f.filter(m=>m.isViolation).length,genderUploaded:Object.keys(T).length>0,violationUploaded:Object.keys(R).length>0},D}function Ce(e){const n=e.files[0];if(!n)return;const t=new FileReader;t.onload=function(o){try{const a=XLSX.read(new Uint8Array(o.target.result),{type:"array"}),s=XLSX.utils.sheet_to_json(a.Sheets[a.SheetNames[0]]);T={},Y=[];const r=new Map;s.forEach(c=>{const u=U(c.姓名||c.名字||c.Name);if(!u)return;const p=String(c.性别||c.Gender||"").trim()==="男"||String(c.性别||c.Gender||"").toUpperCase()==="M"?"M":"F",f=J(c.考号||c.学号||c.准考证号||""),h=f?"id:"+f:"name:"+u;T[h]=p,f||(T["name:"+u]=p),Y.push(u),r.set(u,(r.get(u)||0)+1)});const i=[...r.entries()].filter(([,c])=>c>1).map(([c])=>c);let l=`✅ 性别名单导入 ${Y.length} 人。`;i.length&&(l+=`
⚠️ 检测到 ${i.length} 个重名：${i.slice(0,8).join("、")}${i.length>8?"…":""}
重名建议在名单中补「考号」列以精确匹配。`),window.UI.alert(l),te()}catch(a){window.UI.alert("性别名单读取失败："+a.message)}},t.readAsArrayBuffer(n)}function $e(e){const n=e.files[0];if(!n)return;const t=new FileReader;t.onload=function(o){try{const a=XLSX.read(new Uint8Array(o.target.result),{type:"array"}),s=XLSX.utils.sheet_to_json(a.Sheets[a.SheetNames[0]]);R={},Z=[];const r=new Map;s.forEach(c=>{const u=U(c.姓名||c.名字||c.Name);if(!u)return;const p=J(c.考号||c.学号||c.准考证号||""),f=p?"id:"+p:"name:"+u;R[f]=!0,p||(R["name:"+u]=!0),Z.push(u),r.set(u,(r.get(u)||0)+1)});const i=[...r.entries()].filter(([,c])=>c>1).map(([c])=>c);let l=`✅ 违纪名单导入 ${Z.length} 人。`;i.length&&(l+=`
⚠️ 检测到 ${i.length} 个重名：${i.slice(0,8).join("、")}${i.length>8?"…":""}
重名建议补「考号」列。`),window.UI.alert(l),te()}catch(a){window.UI.alert("违纪名单读取失败："+a.message)}},t.readAsArrayBuffer(n)}function ee(){var o;const e=((o=document.getElementById("fb_data_source"))==null?void 0:o.value)||"cloud",n=document.getElementById("fb_manual_upload_row"),t=document.getElementById("fb_assembly_status");n&&(n.style.display=e==="manual"?"flex":"none"),t&&(t.style.display=e==="manual"?"none":"block")}function fe(e=document){const n=e&&typeof e.querySelectorAll=="function"?e:document;n.querySelectorAll("[data-fb-pick]").forEach(t=>{t.dataset.fbPickBound!=="1"&&(t.dataset.fbPickBound="1",t.addEventListener("click",()=>{const o=document.getElementById(String(t.dataset.fbPick||"").trim());o&&o.click()}))}),n.querySelectorAll("[data-fb-change]").forEach(t=>{t.dataset.fbChangeBound!=="1"&&(t.dataset.fbChangeBound="1",t.addEventListener("change",()=>{const o=String(t.dataset.fbChange||"").trim();if(!/^FB_[A-Za-z0-9_]+$/.test(o))return;const a=window[o];typeof a=="function"&&a(t)}))})}function te(){const e=document.getElementById("fb_assembly_status");if(!e)return;const n=Object.keys(T).length,t=Z.length;e.innerHTML=`已载入性别名单 <strong>${Y.length}</strong> 人 · 违纪名单 <strong>${t}</strong> 人。点击「生成分班方案」将读取本届别最近考试成绩并聚合。`}function Fe(e){const n=e.files[0];if(!n)return;const t=new FileReader;t.onload=function(o){try{const a=new Uint8Array(o.target.result),s=XLSX.read(a,{type:"array"}),r=XLSX.utils.sheet_to_json(s.Sheets[s.SheetNames[0]]);if(!r.length)throw new Error("Excel没有数据");M=r.map((l,c)=>{const u=String(l.备注||l.说明||""),p=u.match(/(?:和|与|跟)([\u4e00-\u9fa5\w]+)(?:同班|一起|一班)/),f=u.match(/(?:和|与|跟)([\u4e00-\u9fa5\w]+)(?:分开|不同班|不在一起)/);return{_id:c,name:l.姓名||"未知",gender:l.性别==="男"||l.Gender==="M"?"M":"F",score:parseFloat(l.总分||l.语数英||0),height:parseFloat(l.身高||160),vision:parseFloat(l.视力||l.左眼||5),isDiff:String(l.难管||"").includes("是")||u.includes("难管")||u.includes("调皮"),remarks:u,constraints:{same:p?[p[1]]:[],diff:f?[f[1]]:[]},classIdx:-1}});const i=document.getElementById("fb_data_source");i&&(i.value="manual",typeof ee=="function"&&ee()),window.UI.alert(`✅ 导入成功！共 ${M.length} 人。`),document.getElementById("fb-results-area").classList.add("hidden")}catch(a){window.UI.alert("读取失败："+a.message)}},t.readAsArrayBuffer(n)}function rt(e){const n=ue(e),t=Math.floor(e.length/2),o=e.slice(0,t),a=e.slice(e.length%2===0?t:t+1),s=ue(o),r=ue(a);return{q1:s,q2:n,q3:r}}function ue(e){const n=Math.floor(e.length/2);return e.length%2!==0?e[n]:(e[n-1]+e[n])/2}function Te(e){const n=e.length;if(n===0)return 0;const t=e.reduce((a,s)=>a+s,0)/n,o=e.reduce((a,s)=>a+Math.pow(s-t,2),0)/n;return Math.sqrt(o)}function Ne(){const e=document.getElementById("fb_data_source"),n=e?e.value:"cloud";if(n==="cloud"){const s=de();if(!s)return;if(s.dupGroups&&s.dupGroups.length){const r=s.dupGroups.slice(0,12).map(c=>`· ${c.name}（${c.ids.length} 人）`).join(`
...
是否仍按当前匹配继续分班？`))return}s.missingGender>0&&window.UI&&window.UI.toast&&window.UI.toast(`⚠️ ${s.missingGender} 人未匹配到性别，已暂按女生计入，建议补全性别名单`,"warning")}if(!M.length)return window.UI.alert(n==="cloud"?"云端未聚合到学生成绩，请检查考试数据与名单。":"请先导入数据");const t=parseInt(document.getElementById("fb_cls_num").value)||6,o=document.getElementById("fb_algorithm").value,a=document.querySelector('button[onclick="FB_runDivision()"]');a.innerHTML="⏳ 正在运算多套方案...",a.disabled=!0,setTimeout(()=>{F=[];const s=o==="snake"?1:3;for(let l=0;l<s;l++){const c=me(t,o),u=c.map(h=>h.stats.avg),p=Math.max(...u)-Math.min(...u),f=Te(u);F.push({id:l,name:s===1?"标准方案":`方案 ${String.fromCharCode(65+l)}`,data:c,range:p,sd:f,desc:`均分极差 ${p.toFixed(2)}`})}a.innerHTML="🚀 开始智能分班",a.disabled=!1,pe();const r=[...F].sort((l,c)=>l.range-c.range)[0];ge(r.id),document.getElementById("fb-results-area").classList.remove("hidden");const i=document.getElementById("fb-scheme-panel");s>1?i&&i.classList.remove("hidden"):i&&i.classList.add("hidden")},100)}function me(e,n){window.__FB_K=e,it();let t=Array.from({length:e},(a,s)=>({id:s,name:s+1+"班",students:[],stats:{}})),o=JSON.parse(JSON.stringify(M));if(o.sort((a,s)=>s.score-a.score),o.forEach((a,s)=>{a.globalRank=s+1,a.rankBlock=Math.floor(s/e)}),n==="snake")o.forEach((a,s)=>{const i=Math.floor(s/e)%2===0?s%e:e-1-s%e;t[i].students.push(a),a.classIdx=i});else{o.forEach((r,i)=>{const l=Math.floor(i/e)%2===0?i%e:e-1-i%e;t[l].students.push(r),r.classIdx=l});const a=8e3,s=o.reduce((r,i)=>r+i.score,0)/o.length;for(let r=0;r<a;r++){const i=Math.floor(Math.random()*e),l=Math.floor(Math.random()*e);if(i===l)continue;const c=t[i],u=t[l];if(!c.students.length||!u.students.length)continue;const p=Math.floor(Math.random()*c.students.length),f=Math.floor(Math.random()*u.students.length),h=c.students[p],w=u.students[f],m=z(c,s)+z(u,s);c.students[p]=w,w.classIdx=i,u.students[f]=h,h.classIdx=l;const g=z(c,s)+z(u,s);let b=!1;(ne(h,u.students)||ne(w,c.students))&&(b=!0),(b||g>m)&&(c.students[p]=h,h.classIdx=i,u.students[f]=w,w.classIdx=l)}}return t.forEach(a=>{a.stats=Ae(a.students)}),t}function pe(){const e=document.getElementById("fb-scheme-cards");if(!e)return;const n=F.length?Math.min(...F.map(a=>a.range)):1/0,t=F.map(a=>`${a.id}:${a.range.toFixed(3)}:${a.sd.toFixed(3)}:${ie(a.data)}`).join("|");if(x.schemeSelectorSignature===t){e.dataset.freshmanSchemeSig!==t&&(e.innerHTML=x.schemeSelectorHtml,e.dataset.freshmanSchemeSig=t);return}const o=F.map(a=>{const s=a.range<=n,r=s?"border:2px solid #16a34a; background:#fff;":"border:1px solid #ddd; background:#fff;",i=a.data.map(c=>c.stats.male),l=Math.max(...i)-Math.min(...i);return`
            ...
            `}).join("");x.schemeSelectorSignature=t,x.schemeSelectorHtml=o,e.innerHTML=o,e.dataset.freshmanSchemeSig=t}function ge(e){const n=F.find(o=>o.id===e);if(!n)return;ke(n.data),se={},v.forEach(o=>se[o.name]=o.students),be();const t=document.getElementById("fb-scheme-cards");if(t){const o=t.children;Array.from(o).forEach(a=>{String(a.dataset.schemeId)===String(n.id)?(a.style.borderColor="#16a34a",a.style.boxShadow="0 0 0 3px rgba(22, 163, 74, 0.2)"):(a.style.borderColor="#ddd",a.style.boxShadow="none")})}}let P=null,X=null;function it(){var o,a;const e=M.map(s=>s.score).filter(Number.isFinite).sort((s,r)=>r-s);if(!e.length){P=null,X=null;return}const n=(o=e[Math.floor(e.length*.27)])!=null?o:e[0],t=(a=e[Math.floor(e.length*.73)])!=null?a:e[e.length-1];P={high:n,low:t},X={},j.forEach(s=>{const r=M.map(u=>u.subjAvg&&Number.isFinite(u.subjAvg[s])?u.subjAvg[s]:null).filter(u=>u!=null);if(!r.length){X[s]=null;return}const i=r.reduce((u,p)=>u+p,0)/r.length,l=r.filter(u=>u>=le).length/r.length,c=r.filter(u=>u>=ce).length/r.length;X[s]={avg:i,exc:l,pass:c,n:r.length}})}function G(e){return P?e>=P.high?"high":e<=P.low?"low":"mid":"mid"}function z(e,n){var p,f,h,w;const t=e.students.length;if(t===0)return 1e4;const o=e.students.reduce((m,g)=>m+g.score,0)/t,a=e.students.filter(m=>m.gender==="M").length,s=e.students.filter(m=>m.isViolation||m.isDiff||m._isDiff).length;let r=Math.pow(o-n,2)*100;r+=Math.pow(a/t-.5,2)*5e3;const i=((p=document.getElementById("fb_rule_diff"))==null?void 0:p.value)||"spread";if(i==="spread"?r+=Math.pow(s,2)*600:i==="gather"&&(r-=s*100),(((f=document.getElementById("fb_rule_tier"))==null?void 0:f.value)||"on")==="on"&&P&&M.length){const m=typeof window.__FB_K=="number"&&window.__FB_K>0?window.__FB_K:1,g=M.filter(E=>G(E.score)==="high").length/m,b=M.filter(E=>G(E.score)==="low").length/m,y=e.students.filter(E=>G(E.score)==="high").length,S=e.students.filter(E=>G(E.score)==="low").length;r+=(Math.pow(y-g,2)+Math.pow(S-b,2))*300}if((((h=document.getElementById("fb_rule_rank"))==null?void 0:h.value)||"on")==="on"){const m={};e.students.forEach(b=>{typeof b.rankBlock=="number"&&(m[b.rankBlock]=(m[b.rankBlock]||0)+1)});let g=0;Object.values(m).forEach(b=>{b>1&&(g+=(b-1)*(b-1))}),r+=g*1200}return(((w=document.getElementById("fb_rule_subject"))==null?void 0:w.value)||"on")==="on"&&X&&j.forEach(m=>{const g=X[m];if(!g)return;const b=e.students.map(_=>_.subjAvg&&Number.isFinite(_.subjAvg[m])?_.subjAvg[m]:null).filter(_=>_!=null);if(!b.length)return;const y=b.reduce((_,I)=>_+I,0)/b.length,S=b.filter(_=>_>=le).length/b.length,E=b.filter(_=>_>=ce).length/b.length;r+=Math.pow(y-g.avg,2)*40,r+=Math.pow(S-g.exc,2)*4e3,r+=Math.pow(E-g.pass,2)*4e3}),r}function ne(e,n){if(!e.constraints)return!1;for(let t of e.constraints.diff)if(n.find(o=>o.name===t))return!0;return!1}function he(){const e=document.getElementById("fb-results-area");if(!e)return;let n=document.getElementById("fb_assembly_banner");const t=D;if(!t){n&&n.remove();return}n||(n=document.createElement("div"),n.id="fb_assembly_banner",e.insertBefore(n,e.firstChild));const o=t.targetGrade==="9"?"新9年级（语数英物化，物×0.9 化×0.6，不含政治）":t.targetGrade==="8"?"新8年级":"新7年级",a=[];a.push(`口径：${o}`),a.push(`参考考试：${t.examLabels.join(" + ")||t.examCount+" 次"}`),a.push(`匹配学生：${t.matched} 人`),t.violationUploaded&&a.push(`违纪：${t.violationTotal} 人`),t.missingGender>0&&a.push(`⚠️ 缺性别 ${t.missingGender} 人`);const s=t.dupGroups&&t.dupGroups.length?`<div style="margin-top:8px; color:#b91c1c; font-weight:600;">
...
当前未保存的修改将丢失。`)){e.value="";return}t.seatLayout=JSON.parse(JSON.stringify(t.scenarios[n])),N()}}async function Je(){const e=document.getElementById("seat_scenario_select");if(!e)return;const n=e.value;if(!n)return window.UI.alert("请先选择一个要删除的方案");if(await window.UI.confirm(`确定要永久删除方案 [${n}] 吗？`)){const t=v[L];if(!t)return window.UI.alert("请先打开一个班级座位图");delete t.scenarios[n],V()}}function qe(e){const n=e.files[0];if(!n)return;const t=new FileReader;t.onload=function(o){try{const a=new Uint8Array(o.target.result),s=XLSX.read(a,{type:"array"}),r=XLSX.utils.sheet_to_json(s.Sheets[s.SheetNames[0]]);if(!r.length)throw new Error("Excel没有数据");$=r.map(i=>({name:i.姓名||"未知",class:i.班级||i.班||"未知",school:i.学校||"",score:parseFloat(i.总分||i.score||0)})),window.UI.alert(`✅ 已导入 ${$.length} 名学生，准备进行考场编排。`)}catch(a){window.UI.alert("读取失败："+a.message)}},t.readAsArrayBuffer(n)}function Ve(){if(!$.length)return window.UI.alert("请先导入学生名单");const e=document.getElementById("exam_prefix").value,n=parseInt(document.getElementById("exam_seats_per_room").value)||30,t=document.getElementById("exam_opt_separate").checked,o=document.getElementById("exam_opt_snake").checked;let a=[...$].sort((r,i)=>i.score-r.score);if(t){let r=0;for(let i=1;i<a.length-1;i++)if(a[i].class===a[i-1].class){let l=!1;for(let c=i+1;c<Math.min(i+15,a.length);c++)if(a[c].class!==a[i].class&&a[c].class!==a[i-1].class){[a[i],a[c]]=[a[c],a[i]],l=!0,r++;break}}r>0&&UI.toast(`已智能微调 ${r} 人次以打散同班同学`,"success")}k=[];const s=4;a.forEach((r,i)=>{r.examNo=e+String(i+1).padStart(3,"0"),r.roomNo=Math.floor(i/n)+1;let l=i%n;if(o){const c=Math.floor(l/s);if(c%2!==0){const u=l%s,p=s-1-u;l=c*s+p}}r.seatNo=l+1,k[r.roomNo-1]||(k[r.roomNo-1]={id:r.roomNo,students:[]}),k[r.roomNo-1].students.push(r)}),o&&k.forEach(r=>r.students.sort((i,l)=>i.seatNo-l.seatNo)),document.getElementById("exam-results-area").classList.remove("hidden"),Se(),Ee(),Be(),Ie()}function _e(e,n){const t=Array.from(document.querySelectorAll("#exam-results-area .nav-link"));t.forEach(s=>s.classList.remove("active"));const o=n||t.find(s=>{const r=s.getAttribute("onclick")||"";return r.includes(`'${e}'`)||r.includes(`"${e}"`)});o&&o.classList.add("active"),document.getElementById("exam-view-overview").classList.add("hidden"),document.getElementById("exam-view-students").classList.add("hidden"),document.getElementById("exam-view-proctor").classList.add("hidden");const a=document.getElementById("exam-view-"+e);a&&a.classList.remove("hidden")}function Se(){const e=document.getElementById("exam_room_grid");if(!e)return;const n=Q();if(x.examOverviewSignature===n){e.innerHTML!==x.examOverviewHtml&&(e.innerHTML=x.examOverviewHtml);return}const t=k.map(o=>{const a=o.students[0].examNo,s=o.students[o.students.length-1].examNo;return`<div class="exam-room-card analysis-exam-room-card" onclick="window.UI.alert('提示：请使用“打印桌贴”功能查看该考场的详细座次表')"><div class="exam-room-title analysis-exam-room-title">第 ${String(o.id).padStart(2,"0")} 考场</div><div class="exam-room-info analysis-exam-room-info"><span>人数: ${o.students.length}</span></div><div class="exam-room-range analysis-exam-room-range">${a} - ${s}</div></div>`}).join("");x.examOverviewSignature=n,x.examOverviewHtml=t,e.innerHTML!==t&&(e.innerHTML=t)}function Ee(){const e=document.querySelector("#exam_student_table tbody");if(!e)return;const n=Q();if(x.examStudentListSignature===n){e.innerHTML!==x.examStudentListHtml&&(e.innerHTML=x.examStudentListHtml);return}let t="";const o=[...$].sort((a,s)=>a.class!==s.class?String(a.class).localeCompare(String(s.class),void 0,{numeric:!0}):a.examNo.localeCompare(s.examNo));o.slice(0,500).forEach(a=>{t+=`<tr><td>${a.examNo}</td><td>${a.name}</td><td>${a.class}</td><td>${String(a.roomNo).padStart(2,"0")}</td><td>${String(a.seatNo).padStart(2,"0")}</td><td>${a.score}</td></tr>`}),o.length>500&&(t+='<tr><td colspan="6" style="text-align:center">...更多数据请导出Excel查看...</td></tr>'),x.examStudentListSignature=n,x.examStudentListHtml=t,e.innerHTML!==t&&(e.innerHTML=t)}function Be(){const e=document.querySelector("#exam_proctor_table tbody");if(!e)return;const n=Q();if(x.examProctorSignature===n){e.innerHTML!==x.examProctorHtml&&(e.innerHTML=x.examProctorHtml);return}let t="";k.forEach(o=>{const a=o.students[0].examNo,s=o.students[o.students.length-1].examNo;t+=`<tr><td>第 ${String(o.id).padStart(2,"0")} 考场</td><td>${o.students.length}</td><td>${a} - ${s}</td><td></td><td></td></tr>`}),x.examProctorSignature=n,x.examProctorHtml=t,e.innerHTML!==t&&(e.innerHTML=t)}function Ie(){const e=document.getElementById("batch-print-area-wrapper")||document.getElementById("batch-print-container");if(!e)return;const n=Q();if(x.examPrintSignature===n){e.innerHTML!==x.examPrintHtml&&(e.innerHTML=x.examPrintHtml);return}let t="";k.forEach(o=>{let a="";o.students.forEach(s=>{a+=`<div class="exam-print-seat"><div class="exam-print-seat-num">第${String(s.seatNo).padStart(2,"0")}号</div><div class="exam-print-seat-name">${s.name}</div><div class="exam-print-seat-id">考号: ${s.examNo}</div><div style="font-size:10px;">${s.class}</div></div>`}),t+=`<div class="exam-print-page"><div class="exam-print-header">第 ${String(o.id).padStart(2,"0")} 考场座位表 (共${o.students.length}人)</div><div class="exam-print-grid">${a}</div><div style="margin-top:20px; font-size:12px;">监考员签字：_________________   &nbsp;&nbsp;&nbsp; 巡考员签字：_________________</div></div>`}),x.examPrintSignature=n,x.examPrintHtml=t,e.innerHTML!==t&&(e.innerHTML=t)}function We(){if(!k||k.length===0)return window.UI.alert("请先点击“一键生成考场安排”");const e=document.getElementById("desk-labels-print-area");e.innerHTML="";let n="";k.forEach(s=>{n+='<div class="desk-label-page">',s.students.forEach(r=>{n+=`
        ...
        `).join(""),t.disabled=!1,o.disabled=!1,setMultiSelectOptions(t,e,s),setMultiSelectOptions(o,e,r)}function Qe(){if(!k.length)return window.UI.alert("请先生成考场安排");const e=[...new Set(Object.values(TEACHER_MAP||{}).map(f=>String(f||"").trim()).filter(Boolean))];if(!e.length)return window.UI.alert("请先导入任课表，当前没有可用于监考分配的教师。");const n=document.getElementById("proctor-role-patrol"),t=document.getElementById("proctor-role-affairs");if(!n||!t)return window.UI.alert("监考配置面板未就绪，请刷新页面后重试。");const o=Array.from(document.querySelectorAll(".exclude-check:checked")).map(f=>f.value),a=[...new Set(Array.from(n.selectedOptions).map(f=>f.value))],s=[...new Set(Array.from(t.selectedOptions).map(f=>f.value))],r=s.filter(f=>a.includes(f)),i=s.filter(f=>!a.includes(f));r.length&&(Array.from(t.options).forEach(f=>{f.selected=i.includes(f.value)}),window.UI&&UI.toast(`已自动去重特殊岗位：${r.join("、")}`,"warning"));let l=e.filter(f=>!o.includes(f)&&!a.includes(f)&&!i.includes(f));const c=k.length*2;if(l.length<c)return window.UI.alert(`❌ 人员不足！
当前考场需要 ${c} 名监考，但排除后仅剩 ${l.length} 人。
请减少排除项或合并岗位。`);l.sort(()=>Math.random()-.5);const u=document.querySelector("#exam_proctor_table tbody");let p="";k.forEach((f,h)=>{const w=l[h*2],m=l[h*2+1],g=f.students[0].examNo,b=f.students[f.students.length-1].examNo;p+=`
                <tr>
