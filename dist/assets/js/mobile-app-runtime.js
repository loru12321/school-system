(()=>{if(typeof window=="undefined"||window.__MOBILE_APP_RUNTIME_PATCHED__)return;const St=960,_=[80,260,900],Et=[140,420,980,1600],Ct={admin:"starter-hub",director:"starter-hub",grade_director:"starter-hub",class_teacher:"student-details",teacher:"teacher-analysis"},Tt=["student-details","summary","teacher-analysis","report-generator","progress-analysis","analysis"],at="apk-recent-modules-v1",D=8,j=6,_t={admin:"管理员",director:"校级管理",grade_director:"级部主任",class_teacher:"班主任",teacher:"教师",parent:"家长",student:"学生",guest:"访客"},F=!!(window.Capacitor&&(typeof window.Capacitor.isNativePlatform=="function"&&window.Capacitor.isNativePlatform()||typeof window.Capacitor.getPlatform=="function"&&window.Capacitor.getPlatform()!=="web"));let it=0,d="",u=!1,m="",y=null,v=null,nt=null,W="",V=null,M=new Map;function i(t){return String(t!=null?t:"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function Mt(t,e){if(!t)return!1;const o=String(e!=null?e:"");return t.textContent===o?!1:(t.textContent=o,!0)}function S(t,e){if(!t)return!1;const o=String(e!=null?e:"");return t.__apkLastHtml===o?!1:(t.innerHTML=o,t.__apkLastHtml=o,!0)}function K(t,e,o){if(!(t!=null&&t.dataset))return!1;const a=String(o!=null?o:"");return t.dataset[e]===a?!1:(t.dataset[e]=a,!0)}function Lt(t,e,o){if(!(t!=null&&t.style))return!1;const a=String(o!=null?o:"");return t.style.getPropertyValue(e)===a?!1:(t.style.setProperty(e,a),!0)}function $t(t,e,o){if(!(t!=null&&t.classList))return!1;const a=!!o;return t.classList.contains(e)===a?!1:(t.classList.toggle(e,a),!0)}function rt(){var e,o,a;const t=[Number(window.innerWidth||0),Number(((e=document.documentElement)==null?void 0:e.clientWidth)||0),Number(window.outerWidth||0),Number(((o=window.screen)==null?void 0:o.width)||0),Number(((a=window.screen)==null?void 0:a.availWidth)||0)].filter(n=>Number.isFinite(n)&&n>0);return t.length?Math.min(...t):0}function g(){return rt()<=St}function st(){return window.matchMedia?window.matchMedia("(max-width: 900px)").matches:rt()<=900}function Q(t=document){document.documentElement.classList.toggle("is-compact-viewport",st()),(t&&typeof t.querySelectorAll=="function"?t:document).querySelectorAll(".analysis-table-shell, .table-wrap").forEach(o=>{o.dataset.mobileHint||(o.dataset.mobileHint="可横向滑动查看完整表格")})}function lt(){Q(document)}function At(t){var a;const e=(a=t==null?void 0:t.querySelector)==null?void 0:a.call(t,"[data-apk-rail]");if(!e)return;const o=e.querySelector(".apk-rail-chip.is-active");!o||typeof o.scrollIntoView!="function"||o.scrollIntoView({inline:"center",block:"nearest",behavior:"auto"})}function L(){return window.AuthState&&typeof window.AuthState.getCurrentUser=="function"?window.AuthState.getCurrentUser():window.Auth&&window.Auth.currentUser?window.Auth.currentUser:null}function q(){var t,e,o;return window.AuthState&&typeof window.AuthState.getCurrentRole=="function"?window.AuthState.getCurrentRole():String(((t=L())==null?void 0:t.role)||((o=(e=document.body)==null?void 0:e.dataset)==null?void 0:o.role)||"guest").trim()||"guest"}function ct(){if(window.AuthState&&typeof window.AuthState.getCurrentRoles=="function")return window.AuthState.getCurrentRoles();const t=L();return(Array.isArray(t==null?void 0:t.roles)&&t.roles.length?t.roles:[t==null?void 0:t.role].filter(Boolean)).map(o=>String(o||"").trim()).filter(Boolean)}function Se(t){const e=new Set(ct());return t.some(o=>e.has(o))}function Y(t=q()){const e=String(t||"").trim();return e==="parent"||e==="student"}function dt(t=q()){return _t[String(t||"").trim()]||String(t||"访客")}function ut(){var t,e;return window.SchoolState&&typeof window.SchoolState.getCurrentSchool=="function"?String(((t=L())==null?void 0:t.school)||window.SchoolState.getCurrentSchool()||"").trim():String(((e=L())==null?void 0:e.school)||window.MY_SCHOOL||localStorage.getItem("MY_SCHOOL")||"").trim()}function z(){const t=document.getElementById("login-overlay"),e=!!(t&&getComputedStyle(t).display!=="none");return!!L()&&!e}function xt(){if(window.NAV_STRUCTURE)return window.NAV_STRUCTURE;try{return NAV_STRUCTURE}catch(t){return null}}function Rt(){W="",V=null,M=new Map}function It(t,e){const o=ct().join("|"),a=t?Object.keys(t).join("|"):"",n=window.CONFIG&&window.CONFIG.showQuery?"report:1":"report:0";return[e,o,a,n].join("::")}function Ot(t){const e=q();return!((e==="teacher"||e==="class_teacher")&&typeof window.canAccessModule=="function"&&!window.canAccessModule(t)||e==="teacher"&&["exam-arranger","freshman-simulator"].includes(t)||t==="report-generator"&&typeof window.CONFIG!="undefined"&&window.CONFIG&&!window.CONFIG.showQuery)}function $(){const t=xt();if(!t)return[];const e=q(),o=It(t,e);if(V&&W===o)return V;const a=e==="teacher"||e==="class_teacher",n=Object.keys(t).filter(r=>!(a&&(r==="data"||r==="tools")||a&&e==="teacher"&&r==="town")).map(r=>{const s=t[r];return{...s,key:r,items:Array.isArray(s==null?void 0:s.items)?s.items.filter(l=>Ot(l.id)):[]}}).filter(r=>r.items.length>0);return W=o,V=n,M=new Map,n}function E(t){if(!t)return null;if(M.has(t))return M.get(t);const e=$();for(const o of e){const a=o.items.find(n=>n.id===t);if(a){const n={...a,categoryKey:o.key,categoryTitle:o.title,categoryColor:o.color};return M.set(t,n),n}}return M.set(t,null),null}function A(){var o,a,n;const t=Ct[q()]||"starter-hub",e=E(t);return e?e.id:((n=(a=(o=$()[0])==null?void 0:o.items)==null?void 0:a[0])==null?void 0:n.id)||"starter-hub"}function x(){var t;return((t=document.querySelector(".section.active"))==null?void 0:t.id)||A()}function N(){return E(x())||E(A())||null}function G(){const t=$(),e=N();if(e){const a=t.find(n=>n.key===e.categoryKey);if(a)return a}const o=typeof window.getCurrentNavCategory=="function"?String(window.getCurrentNavCategory()||"").trim():"";return t.find(a=>a.key===o)||t[0]||null}function B(t){const e=new Set;return t.filter(o=>!o||!o.id||e.has(o.id)?!1:(e.add(o.id),!0))}function pt(){try{const t=JSON.parse(localStorage.getItem(at)||"[]");return Array.isArray(t)?t.map(e=>String(e||"").trim()).filter(Boolean):[]}catch(t){return[]}}function qt(t){try{localStorage.setItem(at,JSON.stringify(t.map(e=>String(e||"").trim()).filter(Boolean).slice(0,D)))}catch(e){}}function Nt(t){const e=E(t);e&&qt([e.id,...pt().filter(o=>o!==e.id)])}function X(t=D){return B(pt().map(e=>E(e)).filter(Boolean)).slice(0,t)}function ht(t=j){const e=[...X(t),N(),E(A()),...Tt.map(o=>E(o))];return B(e).slice(0,t)}function Ee(){var o;const t=document.getElementById("mode-badge"),e=String((t==null?void 0:t.textContent)||"").trim();return e||String(((o=window.CONFIG)==null?void 0:o.name)||"学校工作台").trim()}function J(){var e;const t=document.getElementById("cohort-selector");return(e=t==null?void 0:t.selectedOptions)!=null&&e[0]&&String(t.selectedOptions[0].textContent||t.value||"届别未选择").trim()||"届别未选择"}function Bt(){const t=document.getElementById("cohort-selector");return t?Array.from(t.options||[]).filter(e=>String(e.value||"").trim()).map(e=>({value:String(e.value||"").trim(),label:String(e.textContent||e.value||"").trim()})):[]}function Pt(){return document.querySelector("main.app-main")}function bt(){const t=Pt();if(t&&typeof t.scrollTo=="function"){t.scrollTo({top:0,behavior:"auto"});return}const e=document.scrollingElement||document.documentElement||document.body;if(e&&typeof e.scrollTo=="function"){e.scrollTo({top:0,behavior:"auto"});return}typeof window.scrollTo=="function"&&window.scrollTo({top:0,behavior:"auto"})}function Ht(t=document){if(!g())return;t.querySelectorAll(".table-wrap table, table.comparison-table, table.fluent-table, #tb-query, #studentDetailTable").forEach(o=>{const a=Vt(o);a.length&&(o.classList.add("mobile-card-table"),Array.from(o.querySelectorAll("tbody tr")).forEach(n=>{let r=String(n.getAttribute("data-mobile-card-title")||"").trim();Array.from(n.children).forEach((s,l)=>{if(!(s instanceof HTMLElement)||s.hasAttribute("colspan"))return;const f=String(a[l]||`字段${l+1}`).replace(/\s+/g," ").trim(),T=String(s.textContent||"").replace(/\s+/g," ").trim();!r&&T&&l<=1&&(r=T),s.setAttribute("data-label",f)}),r&&n.setAttribute("data-mobile-card-title",r)}))})}function Vt(t){const e=Array.from(t.querySelectorAll("thead tr"));if(!e.length)return[];const o=[];let a=0;return e.forEach((n,r)=>{o[r]||(o[r]=[]);let s=0;Array.from(n.children).forEach(l=>{for(;o[r][s];)s+=1;const f=Math.max(parseInt(l.getAttribute("colspan")||"1",10)||1,1),T=Math.max(parseInt(l.getAttribute("rowspan")||"1",10)||1,1),h=String(l.textContent||"").replace(/\s+/g," ").trim();for(let H=0;H<T;H+=1){o[r+H]||(o[r+H]=[]);for(let ot=0;ot<f;ot+=1)o[r+H][s+ot]=h}s+=f,s>a&&(a=s)})}),Array.from({length:a},(n,r)=>{const s=[];return o.forEach(l=>{const f=String((l==null?void 0:l[r])||"").trim();!f||s[s.length-1]===f||s.push(f)}),s.join(" / ")})}function Z(t=document){if(!g())return;const e=t&&typeof t.querySelectorAll=="function"?t:document.querySelector(".section.active")||document;Ht(e)}function ft(t=document){if(!g())return;const e=t&&typeof t.querySelectorAll=="function"?t:document.querySelector(".section.active")||document;clearTimeout(window.__RESPONSIVE_TABLE_REFRESH_TIMER__||0),window.__RESPONSIVE_TABLE_REFRESH_TIMER__=window.setTimeout(()=>{Z(e)},60)}function Ut(t=document.querySelector(".section.active")||document.getElementById("app")||document.body){if(typeof MutationObserver!="function")return;const e=t instanceof HTMLElement?t:document.querySelector(".section.active")||document.getElementById("app")||document.body||document.documentElement;if(!e||window.__RESPONSIVE_TABLE_OBSERVER__&&nt===e)return;window.__RESPONSIVE_TABLE_OBSERVER__&&typeof window.__RESPONSIVE_TABLE_OBSERVER__.disconnect=="function"&&window.__RESPONSIVE_TABLE_OBSERVER__.disconnect();const o=new MutationObserver(a=>{if(!g())return;a.some(r=>Array.from(r.addedNodes||[]).some(s=>{var l;return s instanceof HTMLElement?s.matches("table, tbody, tr, td, .table-wrap, .comparison-table, .fluent-table, .section, #parent-view-container")||!!((l=s.querySelector)!=null&&l.call(s,"table, tbody, tr, td, .table-wrap, .comparison-table, .fluent-table")):!1}))&&ft(e)});o.observe(e,{childList:!0,subtree:!0}),window.__RESPONSIVE_TABLE_OBSERVER__=o,nt=e}window.refreshResponsiveMobileTables=Z;function Dt(t=document){g()&&(t.querySelectorAll('.section [style*="grid-template-columns"]').forEach(e=>{e.closest("#parent-view-container")||e.classList.add("mobile-stack-grid")}),t.querySelectorAll('.section [style*="display:flex"]').forEach(e=>{e.closest("#parent-view-container")||e.closest("#apk-mobile-shell")||e.children.length<2||e.classList.add("mobile-wrap-row")}))}function jt(){if(document.getElementById("mobile-experience-styles"))return;const t=document.createElement("style");t.id="mobile-experience-styles",t.textContent=`
        ...
        `}function wt(t,e){const o=b(),a=t.id===e;return`
        ...
        `}function oe(){var T;const t=b(),e=x(),o=String(m||"").trim(),a=te(),n=G(),r=B([...X(6),N()]).slice(0,6),s=new Set(r.map(h=>h.id)),l=ht(6+s.size).filter(h=>!s.has(h.id)).slice(0,6),f=$();return`
            ...
            ${o?`
                ...
                `:`
                    <section class="apk-library-section">
                        ...
                        ${r.length?`<div class="apk-switch-list">${r.map(h=>wt(h,e)).join("")}</div>`:`<div class="apk-sheet-empty">${i(t.noRecent)}</div>`}
                    </section>
                    ${l.length?`
                            <section class="apk-library-section">
        ...
        `,t.addEventListener("click",me),t.addEventListener("input",fe),document.body.appendChild(t),t}function ae(){const t=b(),e=$(),o=x();return e.length?[R(t.moduleOverviewTitle,t.moduleOverviewCopy),...e.map(a=>`
            ...
            `)].join(""):`${R(t.moduleOverviewTitle,t.noModules)}
                <div class="apk-sheet-empty">${i(t.noModules)}</div>`}function ie(){const t=b(),e=x(),o=B([...X(D),N()]).slice(0,4),a=new Set(o.map(s=>s.id)),n=ht(j+a.size).filter(s=>!a.has(s.id)).slice(0,j),r=[w("library",t.allModulesTitle,t.allModulesCopy,"ti ti-layout-sidebar-left-expand"),w("search",t.searchTitle,t.searchCopy,"ti ti-search"),w("cohorts",t.cohortsTitle,t.cohortsCopy,"ti ti-id-badge-2"),typeof window.openUserPasswordModal=="function"?w("password",t.passwordTitle,t.passwordCopy,"ti ti-lock"):"",w("logout",t.logoutTitle,t.logoutCopy,"ti ti-logout","is-danger")].filter(Boolean);return`
            ...
            <section class="apk-sheet-section">
                ${k(t.recentModulesTitle,t.recentModulesNote)}
                ${o.length?`<div class="apk-switch-list">${o.map(s=>wt(s,e)).join("")}</div>`:`<div class="apk-sheet-empty">${i(t.noRecent)}</div>`}
            </section>
            ${n.length?`
                    <section class="apk-sheet-section">
                        ${k(t.suggestedTitle,t.suggestedNote)}
                ...
                <div class="apk-account-card">
                    ...
                    <div class="apk-account-grid">
                        ...
                        <div class="apk-account-row">
                            ...
                            <strong>${i(`${t.followSystem} · ${Jt()}`)}</strong>
                        </div>
                        <div class="apk-account-row">
        ...
        `}function re(){var a;const t=b(),e=Bt(),o=((a=document.getElementById("cohort-selector"))==null?void 0:a.value)||"";return e.length?`
        ...
        `:`${R(t.switchCohortTitle,t.noCohortChoices)}
                <div class="apk-sheet-empty">${i(t.noCohorts)}</div>`}function se(t){const e=t.querySelector("[data-apk-library-panel]");e&&S(e,u?oe():"")}function le(){const e=tt().querySelector("[data-apk-sheet-panel]");if(e){if(!d){S(e,"");return}if(d==="modules"){S(e,ae());return}if(d==="quick"){S(e,ie());return}if(d==="account"){S(e,ne());return}d==="cohorts"&&S(e,re())}}function ce(t){var s;const e=b(),o=t.querySelector("[data-apk-rail]");if(!o)return;const a=G(),n=x();if(!((s=a==null?void 0:a.items)!=null&&s.length)){S(o,`<div class="apk-rail-empty">${i(e.currentCategoryEmpty)}</div>`);return}const r=a.items.map(l=>`
            <button type="button" class="apk-rail-chip${l.id===n?" is-active":""}" data-apk-module="${i(l.id)}">
                ${i(l.text||l.id)}
            </button>
        `).join("");S(o,r)&&window.requestAnimationFrame(()=>At(t))}function de(t){const e=x(),o=A();t.querySelectorAll(".apk-shell-tab").forEach(a=>{const n=a.getAttribute("data-apk-tab");$t(a,"is-active",!u&&(n==="home"&&!d&&e===o||n==="modules"&&d==="modules"||n==="quick"&&d==="quick"||n==="account"&&d==="account"))})}function P(){const t=b(),e=tt(),o=N(),a=G(),n=[ut()||t.unknownSchool,(a==null?void 0:a.title)||t.workbench,J()].filter(Boolean).join(" · ");Lt(e,"--apk-accent",(o==null?void 0:o.categoryColor)||(a==null?void 0:a.color)||"#2563eb"),e.setAttribute("aria-hidden","false"),K(e,"sheetOpen",d?"true":"false"),K(e,"sheetMode",d||""),K(e,"libraryOpen",u?"true":"false");const r={role:`${dt()}工作台`,title:(o==null?void 0:o.text)||"智慧教务",subtitle:n,cohort:J(),mode:t.workbench};Object.entries(r).forEach(([s,l])=>{const f=e.querySelector(`[data-apk-field="${s}"]`);Mt(f,l)}),Wt(e),ce(e),le(),se(e),de(e)}function ue(t,e={}){u=!!t,u&&(d=""),!u&&e.resetQuery!==!1&&(m=""),P()}function I(t){ue(typeof t=="boolean"?t:!u)}function p(t=""){d=t,t&&(u=!1,m=""),P()}function C(t){p(d===t?"":t)}function et(t){!t||typeof window.switchTab!="function"||(d="",u=!1,m="",P(),bt(),window.switchTab(t),Nt(t),t==="student-details"&&Kt(),_.forEach(e=>{window.setTimeout(()=>{var o;(o=document.getElementById(t))!=null&&o.classList.contains("active")&&(mt(),t==="student-details"&&typeof window.requestStudentDetailsPrimaryFocus=="function"&&window.requestStudentDetailsPrimaryFocus()),c()},e)}))}function pe(){u=!1,m="",p(""),typeof window.openSpotlight=="function"&&window.openSpotlight()}function he(){u=!1,m="",p(""),typeof window.openUserPasswordModal=="function"&&window.openUserPasswordModal()}function be(t){if(t==="home"){et(A());return}if(t==="modules"){C("modules");return}if(t==="quick"){C("quick");return}t==="account"&&C("account")}function fe(t){const e=t.target.closest("[data-apk-library-search]");if(!e)return;const o=typeof e.selectionStart=="number"?e.selectionStart:String(e.value||"").length;if(m=String(e.value||""),P(),!u)return;const a=document.querySelector("[data-apk-library-search]");a&&(typeof a.focus=="function"&&a.focus({preventScroll:!0}),typeof a.setSelectionRange=="function"&&a.setSelectionRange(o,o))}function me(t){const e=t.target.closest("[data-apk-action], [data-apk-module], [data-apk-cohort], [data-apk-tab]");if(!e)return;t.preventDefault();const o=e.getAttribute("data-apk-module");if(o){et(o);return}const a=e.getAttribute("data-apk-cohort");if(a){Xt(a);return}const n=e.getAttribute("data-apk-tab");if(n){be(n);return}const r=e.getAttribute("data-apk-action");if(r==="close-sheet"){p("");return}if(r==="library"){I();return}if(r==="close-library"){I(!1);return}if(r==="modules"){C("modules");return}if(r==="quick"){C("quick");return}if(r==="account"){C("account");return}if(r==="cohorts"){C("cohorts");return}if(r==="search"){pe();return}if(r==="password"){he();return}r==="logout"&&window.Auth&&typeof window.Auth.logout=="function"&&(u=!1,m="",p(""),window.Auth.logout())}function ye(t){var o;if(!g()||!z()||Y()||yt())return;const e=(o=t.touches)==null?void 0:o[0];e&&(y={startX:e.clientX,startY:e.clientY,canOpenLibrary:!u&&!d&&e.clientX<=28,canCloseLibrary:u})}function we(t){var n;if(!y)return;const e=(n=t.touches)==null?void 0:n[0];if(!e)return;const o=e.clientX-y.startX,a=e.clientY-y.startY;if(Math.abs(a)>42){y=null;return}if(y.canOpenLibrary&&o>=80){I(!0),y=null;return}y.canCloseLibrary&&o<=-80&&(I(!1),y=null)}function kt(){y=null}function O(t,e,o){if(!t||typeof t[e]!="function"||t[e][o])return;const a=t[e],n=function(){const r=a.apply(this,arguments);return c(),_.forEach(s=>{window.setTimeout(c,s)}),r};n[o]=!0,t[e]=n}function ge(){if(window.Swal&&(O(window.Swal,"close","__apkMobileWrapped__"),typeof window.Swal.fire=="function"&&!window.Swal.fire.__apkMobileWrapped__)){const t=window.Swal.fire,e=function(){const o=t.apply(window.Swal,arguments);return c(),_.forEach(a=>{window.setTimeout(c,a)}),o&&typeof o.finally=="function"&&o.finally(()=>{_.forEach(a=>{window.setTimeout(c,a)})}),o};e.__apkMobileWrapped__=!0,window.Swal.fire=e}}function ke(){O(window,"switchTab","__apkMobileWrapped__"),O(window,"renderNavigation","__apkMobileWrapped__"),O(window,"switchNavCategory","__apkMobileWrapped__"),window.Auth&&(O(window.Auth,"applyRoleView","__apkMobileWrapped__"),O(window.Auth,"renderParentView","__apkMobileWrapped__")),ge()}function ve(){Rt(),ke(),Gt();const t=g(),e=t&&z()&&!Y();document.body.dataset.mobileQuery=t?"true":"false",e?document.body.dataset.mobileArchitecture="apk-v2":delete document.body.dataset.mobileArchitecture,Yt(),Qt();const o=tt();if(o.style.display=e?"block":"none",o.setAttribute("aria-hidden",e?"false":"true"),!e){d="",u=!1,m="",o.dataset.sheetOpen="false",o.dataset.sheetMode="",o.dataset.libraryOpen="false",o.dataset.modalOpen="false";return}mt(),P()}function c(){clearTimeout(it),it=window.setTimeout(ve,60)}const vt={switchTab(t){const e={home:A(),students:"student-details",analysis:"summary"};if(t==="me"){p("account");return}const o=e[t]||t;et(o)},renderStudentList(){c()},showStudentDetail(){c()},renderAnalysis(){c()},openModules(){p("modules")},openLibrary(){I(!0)},openQuickActions(){p("quick")},openAccountSheet(){p("account")},openCohortSheet(){p("cohorts")},refresh:c};window.MobMgr=vt,window.MobileQueryUI={refresh:c,openLibrary:()=>I(!0),openModules:()=>p("modules"),openQuick:()=>p("quick"),openAccount:()=>p("account"),openCohorts:()=>p("cohorts")},window.MobileExperienceRuntime=window.MobileExperienceRuntime||{install:lt,syncCompactState:Q,isCompactViewport:st},window.MobDashboardMgr=window.MobDashboardMgr||{showToast(t){window.UI&&typeof window.UI.toast=="function"?window.UI.toast(t,"info"):typeof window.showToast=="function"?window.showToast(t):window.alert(t)}},window.switchMobileTab=t=>vt.switchTab(t),window.matchMedia&&(v=window.matchMedia("(prefers-color-scheme: dark)"),typeof v.addEventListener=="function"?v.addEventListener("change",c):typeof v.addListener=="function"&&v.addListener(c)),window.addEventListener("cloud-load-state",c),window.addEventListener("resize",c),window.addEventListener("orientationchange",c),window.addEventListener("load",c),window.addEventListener("pageshow",c),window.addEventListener("focus",c),document.addEventListener("touchstart",ye,{passive:!0}),document.addEventListener("touchmove",we,{passive:!0}),document.addEventListener("touchend",kt,{passive:!0}),document.addEventListener("touchcancel",kt,{passive:!0}),document.addEventListener("resume",c,!1),document.addEventListener("visibilitychange",()=>{document.hidden||c()}),lt(),_.forEach(t=>{window.setTimeout(c,t)}),c(),window.__MOBILE_MANAGER_PATCHED__=!0,window.__MOBILE_APP_RUNTIME_PATCHED__=!0})();
