(()=>{if(typeof window=="undefined"||window.__MOBILE_APP_RUNTIME_PATCHED__)return;const Ct=960,T=[80,260,900],xt=[140,420,980,1600],Tt={admin:"starter-hub",director:"starter-hub",grade_director:"teacher-analysis",class_teacher:"student-details",teacher:"teacher-analysis"},_t=["student-details","summary","teacher-analysis","report-generator","progress-analysis","analysis"],Lt={admin:["upload","summary","data-manager","report-generator","teacher-analysis","cohort-growth"],director:["summary","county-analysis","teacher-analysis","report-generator","progress-analysis","cohort-growth"],grade_director:["teacher-analysis","summary","progress-analysis","student-overview","cohort-growth","report-generator"],class_teacher:["student-details","student-overview","progress-analysis","marginal-push","report-generator","summary"],teacher:["teacher-analysis","student-details","student-overview","summary","report-generator","progress-analysis"]},at="apk-recent-modules-v1",D=8,j=6,Mt={admin:"管理员",director:"校级管理",grade_director:"级部主任",class_teacher:"班主任",teacher:"教师",parent:"家长",student:"学生",guest:"访客"},ot=!!(window.Capacitor&&(typeof window.Capacitor.isNativePlatform=="function"&&window.Capacitor.isNativePlatform()||typeof window.Capacitor.getPlatform=="function"&&window.Capacitor.getPlatform()!=="web"));let it=0,d="",u=!1,y="",w=null,v=null,nt=null,F="",V=null,_=new Map;function n(t){const e=window.SchoolRuntime&&typeof window.SchoolRuntime.escapeHtml=="function"?window.SchoolRuntime.escapeHtml:null;return e?e(t):String(t!=null?t:"").replace(/[&<>"']/g,a=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[a])}function $t(t,e){if(!t)return!1;const a=String(e!=null?e:"");return t.textContent===a?!1:(t.textContent=a,!0)}function S(t,e){if(!t)return!1;const a=String(e!=null?e:"");return t.__apkLastHtml===a?!1:(t.innerHTML=a,t.__apkLastHtml=a,!0)}function W(t,e,a){if(!(t!=null&&t.dataset))return!1;const o=String(a!=null?a:"");return t.dataset[e]===o?!1:(t.dataset[e]=o,!0)}function At(t,e,a){if(!(t!=null&&t.style))return!1;const o=String(a!=null?a:"");return t.style.getPropertyValue(e)===o?!1:(t.style.setProperty(e,o),!0)}function Rt(t,e,a){if(!(t!=null&&t.classList))return!1;const o=!!a;return t.classList.contains(e)===o?!1:(t.classList.toggle(e,o),!0)}function rt(){var e,a,o;const t=[Number(window.innerWidth||0),Number(((e=document.documentElement)==null?void 0:e.clientWidth)||0),Number(window.outerWidth||0),Number(((a=window.screen)==null?void 0:a.width)||0),Number(((o=window.screen)==null?void 0:o.availWidth)||0)].filter(i=>Number.isFinite(i)&&i>0);return t.length?Math.min(...t):0}function b(){return rt()<=Ct}function st(){return window.matchMedia?window.matchMedia("(max-width: 900px)").matches:rt()<=900}function K(t=document){document.documentElement.classList.toggle("is-compact-viewport",st()),(t&&typeof t.querySelectorAll=="function"?t:document).querySelectorAll(".analysis-table-shell, .table-wrap").forEach(a=>{a.dataset.mobileHint||(a.dataset.mobileHint="可横向滑动查看完整表格")})}function lt(){K(document)}function It(t){var o;const e=(o=t==null?void 0:t.querySelector)==null?void 0:o.call(t,"[data-apk-rail]");if(!e)return;const a=e.querySelector(".apk-rail-chip.is-active");!a||typeof a.scrollIntoView!="function"||a.scrollIntoView({inline:"center",block:"nearest",behavior:"auto"})}function L(){return window.AuthState&&typeof window.AuthState.getCurrentUser=="function"?window.AuthState.getCurrentUser():window.Auth&&window.Auth.currentUser?window.Auth.currentUser:null}function q(){var t,e,a;return window.AuthState&&typeof window.AuthState.getCurrentRole=="function"?window.AuthState.getCurrentRole():String(((t=L())==null?void 0:t.role)||((a=(e=document.body)==null?void 0:e.dataset)==null?void 0:a.role)||"guest").trim()||"guest"}function ct(){if(window.AuthState&&typeof window.AuthState.getCurrentRoles=="function")return window.AuthState.getCurrentRoles();const t=L();return(Array.isArray(t==null?void 0:t.roles)&&t.roles.length?t.roles:[t==null?void 0:t.role].filter(Boolean)).map(a=>String(a||"").trim()).filter(Boolean)}function Me(t){const e=new Set(ct());return t.some(a=>e.has(a))}function z(t=q()){const e=String(t||"").trim();return e==="parent"||e==="student"}function dt(t=q()){return Mt[String(t||"").trim()]||String(t||"访客")}function ut(){var t,e;return window.SchoolState&&typeof window.SchoolState.getCurrentSchool=="function"?String(((t=L())==null?void 0:t.school)||window.SchoolState.getCurrentSchool()||"").trim():String(((e=L())==null?void 0:e.school)||window.MY_SCHOOL||localStorage.getItem("MY_SCHOOL")||"").trim()}function Q(){const t=document.getElementById("login-overlay"),e=!!(t&&getComputedStyle(t).display!=="none");return!!L()&&!e}function Ot(){if(window.NAV_STRUCTURE)return window.NAV_STRUCTURE;try{return NAV_STRUCTURE}catch(t){return null}}function qt(){F="",V=null,_=new Map}function Nt(t,e){const a=ct().join("|"),o=t?Object.keys(t).join("|"):"",i=window.CONFIG&&window.CONFIG.showQuery?"report:1":"report:0";return[e,a,o,i].join("::")}function Bt(t){return!(typeof window.canAccessModule=="function"&&!window.canAccessModule(t)||t==="indicator"&&typeof window.isIndicatorModuleVisible=="function"&&!window.isIndicatorModuleVisible()||t==="report-generator"&&typeof window.CONFIG!="undefined"&&window.CONFIG&&!window.CONFIG.showQuery)}function M(){const t=Ot();if(!t)return[];const e=q(),a=Nt(t,e);if(V&&F===a)return V;const o=Object.keys(t).map(i=>{const r=t[i];return{...r,key:i,items:Array.isArray(r==null?void 0:r.items)?r.items.filter(s=>Bt(s.id)):[]}}).filter(i=>i.items.length>0);return F=a,V=o,_=new Map,o}function E(t){if(!t)return null;if(_.has(t))return _.get(t);const e=M();for(const a of e){const o=a.items.find(i=>i.id===t);if(o){const i={...o,categoryKey:a.key,categoryTitle:a.title,categoryColor:a.color};return _.set(t,i),i}}return _.set(t,null),null}function $(){var a,o,i;const t=Tt[q()]||"starter-hub",e=E(t);return e?e.id:((i=(o=(a=M()[0])==null?void 0:a.items)==null?void 0:o[0])==null?void 0:i.id)||"starter-hub"}function A(){var t;return((t=document.querySelector(".section.active"))==null?void 0:t.id)||$()}function N(){return E(A())||E($())||null}function Y(){const t=M(),e=N();if(e){const o=t.find(i=>i.key===e.categoryKey);if(o)return o}const a=typeof window.getCurrentNavCategory=="function"?String(window.getCurrentNavCategory()||"").trim():"";return t.find(o=>o.key===a)||t[0]||null}function B(t){const e=new Set;return t.filter(a=>!a||!a.id||e.has(a.id)?!1:(e.add(a.id),!0))}function pt(){try{const t=JSON.parse(localStorage.getItem(at)||"[]");return Array.isArray(t)?t.map(e=>String(e||"").trim()).filter(Boolean):[]}catch(t){return[]}}function Pt(t){try{localStorage.setItem(at,JSON.stringify(t.map(e=>String(e||"").trim()).filter(Boolean).slice(0,D)))}catch(e){}}function Ht(t){const e=E(t);e&&Pt([e.id,...pt().filter(a=>a!==e.id)])}function G(t=D){return B(pt().map(e=>E(e)).filter(Boolean)).slice(0,t)}function ht(t=j){const e=Lt[q()]||[],a=[...G(t),N(),E($()),...e.map(o=>E(o)),..._t.map(o=>E(o))];return B(a).slice(0,t)}function $e(){var a;const t=document.getElementById("mode-badge"),e=String((t==null?void 0:t.textContent)||"").trim();return e||String(((a=window.CONFIG)==null?void 0:a.name)||"学校工作台").trim()}function X(){var e;const t=document.getElementById("cohort-selector");return(e=t==null?void 0:t.selectedOptions)!=null&&e[0]&&String(t.selectedOptions[0].textContent||t.value||"届别未选择").trim()||"届别未选择"}function Vt(){const t=document.getElementById("cohort-selector");return t?Array.from(t.options||[]).filter(e=>String(e.value||"").trim()).map(e=>({value:String(e.value||"").trim(),label:String(e.textContent||e.value||"").trim()})):[]}function Ut(){return document.querySelector("main.app-main")}function bt(){const t=Ut();if(t&&typeof t.scrollTo=="function"){t.scrollTo({top:0,behavior:"auto"});return}const e=document.scrollingElement||document.documentElement||document.body;if(e&&typeof e.scrollTo=="function"){e.scrollTo({top:0,behavior:"auto"});return}typeof window.scrollTo=="function"&&window.scrollTo({top:0,behavior:"auto"})}function Dt(t=document){if(!b())return;t.querySelectorAll(".table-wrap table, table.comparison-table, table.fluent-table, #tb-query, #studentDetailTable").forEach(a=>{const o=jt(a);o.length&&(a.classList.add("mobile-card-table"),Array.from(a.querySelectorAll("tbody tr")).forEach(i=>{let r=String(i.getAttribute("data-mobile-card-title")||"").trim();Array.from(i.children).forEach((s,c)=>{if(!(s instanceof HTMLElement)||s.hasAttribute("colspan"))return;const f=String(o[c]||`字段${c+1}`).replace(/\s+/g," ").trim(),x=String(s.textContent||"").replace(/\s+/g," ").trim();!r&&x&&c<=1&&(r=x),s.setAttribute("data-label",f)}),r&&i.setAttribute("data-mobile-card-title",r)}))})}function jt(t){const e=Array.from(t.querySelectorAll("thead tr"));if(!e.length)return[];const a=[];let o=0;return e.forEach((i,r)=>{a[r]||(a[r]=[]);let s=0;Array.from(i.children).forEach(c=>{for(;a[r][s];)s+=1;const f=Math.max(parseInt(c.getAttribute("colspan")||"1",10)||1,1),x=Math.max(parseInt(c.getAttribute("rowspan")||"1",10)||1,1),h=String(c.textContent||"").replace(/\s+/g," ").trim();for(let H=0;H<x;H+=1){a[r+H]||(a[r+H]=[]);for(let et=0;et<f;et+=1)a[r+H][s+et]=h}s+=f,s>o&&(o=s)})}),Array.from({length:o},(i,r)=>{const s=[];return a.forEach(c=>{const f=String((c==null?void 0:c[r])||"").trim();!f||s[s.length-1]===f||s.push(f)}),s.join(" / ")})}function J(t=document){if(!b())return;const e=t&&typeof t.querySelectorAll=="function"?t:document.querySelector(".section.active")||document;Dt(e)}function mt(t=document){if(!b())return;const e=t&&typeof t.querySelectorAll=="function"?t:document.querySelector(".section.active")||document;clearTimeout(window.__RESPONSIVE_TABLE_REFRESH_TIMER__||0),window.__RESPONSIVE_TABLE_REFRESH_TIMER__=window.setTimeout(()=>{J(e)},60)}function Ft(t=document.querySelector(".section.active")||document.getElementById("app")||document.body){if(typeof MutationObserver!="function")return;const e=t instanceof HTMLElement?t:document.querySelector(".section.active")||document.getElementById("app")||document.body||document.documentElement;if(!e||window.__RESPONSIVE_TABLE_OBSERVER__&&nt===e)return;window.__RESPONSIVE_TABLE_OBSERVER__&&typeof window.__RESPONSIVE_TABLE_OBSERVER__.disconnect=="function"&&window.__RESPONSIVE_TABLE_OBSERVER__.disconnect();const a=new MutationObserver(o=>{if(!b())return;o.some(r=>Array.from(r.addedNodes||[]).some(s=>{var c;return s instanceof HTMLElement?s.matches("table, tbody, tr, td, .table-wrap, .comparison-table, .fluent-table, .section, #parent-view-container")||!!((c=s.querySelector)!=null&&c.call(s,"table, tbody, tr, td, .table-wrap, .comparison-table, .fluent-table")):!1}))&&mt(e)});a.observe(e,{childList:!0,subtree:!0}),window.__RESPONSIVE_TABLE_OBSERVER__=a,nt=e}window.refreshResponsiveMobileTables=J;function Wt(t=document){b()&&(t.querySelectorAll('.section [style*="grid-template-columns"]').forEach(e=>{e.closest("#parent-view-container")||e.classList.add("mobile-stack-grid")}),t.querySelectorAll('.section [style*="display:flex"]').forEach(e=>{e.closest("#parent-view-container")||e.closest("#apk-mobile-shell")||e.children.length<2||e.classList.add("mobile-wrap-row")}))}function Kt(t=document){if(!b())return;t.querySelectorAll(".table-wrap").forEach(a=>{if(a.__scrollListenerAttached__)return;const o=()=>{const i=a.scrollLeft+a.clientWidth>=a.scrollWidth-2;a.classList.toggle("scrolled-end",i)};a.addEventListener("scroll",o,{passive:!0}),a.__scrollListenerAttached__=!0,o()})}function zt(){if(document.getElementById("mobile-experience-styles"))return;const t=document.createElement("style");t.id="mobile-experience-styles",t.textContent=`
        ...
        `}function gt(t,e){const a=m(),o=t.id===e;return`
        ...
        `}function kt(t,e){const a=String(t.text||t.id||"").trim().slice(0,2)||"模块";return`
        ...
        `}function ne(t,e){return`
            <article class="apk-library-card" style="--apk-library-accent:${n(t.color||"#2563eb")}">
                ...
                <div class="apk-library-mini-grid">
                    ${t.items.slice(0,4).map(a=>kt({...a,categoryTitle:t.title},e)).join("")}
                </div>
            </article>
        `}function re(){var x;const t=m(),e=A(),a=String(y||"").trim(),o=ie(),i=Y(),r=B([...G(6),N()]).slice(0,6),s=new Set(r.map(h=>h.id)),c=ht(6+s.size).filter(h=>!s.has(h.id)).slice(0,6),f=M();return`
        ...
        `,t.addEventListener("click",ke),t.addEventListener("input",ge),document.body.appendChild(t),t}function se(){const t=m(),e=M(),a=A();return e.length?[R(t.moduleOverviewTitle,t.moduleOverviewCopy),...e.map(o=>`
            ...
            <section class="apk-sheet-section">
                ${k(t.recentModulesTitle,t.recentModulesNote)}
                ${a.length?`<div class="apk-switch-list">${a.map(s=>gt(s,e)).join("")}</div>`:`<div class="apk-sheet-empty">${n(t.noRecent)}</div>`}
            </section>
            ${i.length?`
                    <section class="apk-sheet-section">
                        ${k(t.suggestedTitle,t.suggestedNote)}
        ...
        `}function ce(){const t=m(),e=L();return`
                ...
                <div class="apk-account-card">
                    ...
                    <div class="apk-account-grid">
                        ...
                        <div class="apk-account-row">
                            ...
                            <strong>${n(`${t.followSystem} · ${ae()}`)}</strong>
                        </div>
                        <div class="apk-account-row">
        ...
        `}function de(){var o;const t=m(),e=Vt(),a=((o=document.getElementById("cohort-selector"))==null?void 0:o.value)||"";return e.length?`
        ...
        `:`${R(t.switchCohortTitle,t.noCohortChoices)}
                <div class="apk-sheet-empty">${n(t.noCohorts)}</div>`}function ue(t){const e=t.querySelector("[data-apk-library-panel]");e&&S(e,u?re():"")}function pe(){const e=Z().querySelector("[data-apk-sheet-panel]");if(e){if(!d){S(e,"");return}if(d==="modules"){S(e,se());return}if(d==="quick"){S(e,le());return}if(d==="account"){S(e,ce());return}d==="cohorts"&&S(e,de())}}function he(t){var s;const e=m(),a=t.querySelector("[data-apk-rail]");if(!a)return;const o=Y(),i=A();if(!((s=o==null?void 0:o.items)!=null&&s.length)){S(a,`<div class="apk-rail-empty">${n(e.currentCategoryEmpty)}</div>`);return}const r=o.items.map(c=>`
            <button type="button" class="apk-rail-chip${c.id===i?" is-active":""}" data-apk-module="${n(c.id)}">
                ${n(c.text||c.id)}
            </button>
        `).join("");S(a,r)&&window.requestAnimationFrame(()=>It(t))}function be(t){const e=A(),a=$();t.querySelectorAll(".apk-shell-tab").forEach(o=>{const i=o.getAttribute("data-apk-tab");Rt(o,"is-active",!u&&(i==="home"&&!d&&e===a||i==="modules"&&d==="modules"||i==="quick"&&d==="quick"||i==="account"&&d==="account"))})}function P(){const t=m(),e=Z(),a=N(),o=Y(),i=[ut()||t.unknownSchool,(o==null?void 0:o.title)||t.workbench,X()].filter(Boolean).join(" · ");At(e,"--apk-accent",(a==null?void 0:a.categoryColor)||(o==null?void 0:o.color)||"#2563eb"),e.setAttribute("aria-hidden","false"),W(e,"sheetOpen",d?"true":"false"),W(e,"sheetMode",d||""),W(e,"libraryOpen",u?"true":"false");const r={role:`${dt()}工作台`,title:(a==null?void 0:a.text)||"澄见",subtitle:i,cohort:X(),mode:t.workbench};Object.entries(r).forEach(([s,c])=>{const f=e.querySelector(`[data-apk-field="${s}"]`);$t(f,c)}),Yt(e),he(e),pe(),ue(e),be(e)}function me(t,e={}){u=!!t,u&&(d=""),!u&&e.resetQuery!==!1&&(y=""),P()}function I(t){me(typeof t=="boolean"?t:!u)}function p(t=""){d=t,t&&(u=!1,y=""),P()}function C(t){p(d===t?"":t)}function tt(t){!t||typeof window.switchTab!="function"||(d="",u=!1,y="",P(),bt(),window.switchTab(t),Ht(t),t==="student-details"&&Gt(),T.forEach(e=>{window.setTimeout(()=>{var a;(a=document.getElementById(t))!=null&&a.classList.contains("active")&&(ft(),t==="student-details"&&typeof window.requestStudentDetailsPrimaryFocus=="function"&&window.requestStudentDetailsPrimaryFocus()),l()},e)}))}function fe(){u=!1,y="",p(""),typeof window.openSpotlight=="function"&&window.openSpotlight()}function ye(){u=!1,y="",p(""),typeof window.openUserPasswordModal=="function"&&window.openUserPasswordModal()}function we(t){if(t==="home"){tt($());return}if(t==="modules"){C("modules");return}if(t==="quick"){C("quick");return}t==="account"&&C("account")}function ge(t){const e=t.target.closest("[data-apk-library-search]");if(!e)return;const a=typeof e.selectionStart=="number"?e.selectionStart:String(e.value||"").length;if(y=String(e.value||""),P(),!u)return;const o=document.querySelector("[data-apk-library-search]");o&&(typeof o.focus=="function"&&o.focus({preventScroll:!0}),typeof o.setSelectionRange=="function"&&o.setSelectionRange(a,a))}function ke(t){const e=t.target.closest("[data-apk-action], [data-apk-module], [data-apk-cohort], [data-apk-tab]");if(!e)return;t.preventDefault();const a=e.getAttribute("data-apk-module");if(a){tt(a);return}const o=e.getAttribute("data-apk-cohort");if(o){ee(o);return}const i=e.getAttribute("data-apk-tab");if(i){we(i);return}const r=e.getAttribute("data-apk-action");if(r==="close-sheet"){p("");return}if(r==="library"){I();return}if(r==="close-library"){I(!1);return}if(r==="modules"){C("modules");return}if(r==="quick"){C("quick");return}if(r==="account"){C("account");return}if(r==="cohorts"){C("cohorts");return}if(r==="search"){fe();return}if(r==="password"){ye();return}r==="logout"&&window.Auth&&typeof window.Auth.logout=="function"&&(u=!1,y="",p(""),window.Auth.logout())}function ve(t){var a;if(!b()||!Q()||z()||yt())return;const e=(a=t.touches)==null?void 0:a[0];e&&(w={startX:e.clientX,startY:e.clientY,canOpenLibrary:!u&&!d&&e.clientX<=28,canCloseLibrary:u})}function Se(t){var i;if(!w)return;const e=(i=t.touches)==null?void 0:i[0];if(!e)return;const a=e.clientX-w.startX,o=e.clientY-w.startY;if(Math.abs(o)>42){w=null;return}if(w.canOpenLibrary&&a>=80){I(!0),w=null;return}w.canCloseLibrary&&a<=-80&&(I(!1),w=null)}function vt(){w=null}function O(t,e,a){if(!t||typeof t[e]!="function"||t[e][a])return;const o=t[e],i=function(){const r=o.apply(this,arguments);return l(),T.forEach(s=>{window.setTimeout(l,s)}),r};i[a]=!0,t[e]=i}function Ee(){if(window.Swal&&(O(window.Swal,"close","__apkMobileWrapped__"),typeof window.Swal.fire=="function"&&!window.Swal.fire.__apkMobileWrapped__)){const t=window.Swal.fire,e=function(){const a=t.apply(window.Swal,arguments);return l(),window.setTimeout(wt,1200),T.forEach(o=>{window.setTimeout(l,o)}),a&&typeof a.finally=="function"&&a.finally(()=>{T.forEach(o=>{window.setTimeout(l,o)})}),a};e.__apkMobileWrapped__=!0,window.Swal.fire=e}}function Ce(){O(window,"switchTab","__apkMobileWrapped__"),O(window,"renderNavigation","__apkMobileWrapped__"),O(window,"switchNavCategory","__apkMobileWrapped__"),window.Auth&&(O(window.Auth,"applyRoleView","__apkMobileWrapped__"),O(window.Auth,"renderParentView","__apkMobileWrapped__")),Ee()}function xe(t){const e=document.querySelector("main.app-main"),a=document.getElementById("app"),o=t.querySelector(".apk-shell-sheet");!e||!o||t.contains(e)||(e.dataset.originalParent||(e.dataset.originalParent="app"),o.appendChild(e))}function Te(){const t=document.querySelector("main.app-main"),e=document.getElementById("app"),a=document.getElementById("apk-mobile-shell");!t||!e||a&&a.contains(t)&&e.appendChild(t)}function _e(){qt(),Ce(),te();const t=b(),e=t&&Q()&&!z();document.body.dataset.mobileQuery=t?"true":"false",e?document.body.dataset.mobileArchitecture="apk-v2":delete document.body.dataset.mobileArchitecture,Jt(),Xt();const a=Z();if(a.style.display=e?"block":"none",a.setAttribute("aria-hidden",e?"false":"true"),!e){d="",u=!1,y="",a.dataset.sheetOpen="false",a.dataset.sheetMode="",a.dataset.libraryOpen="false",a.dataset.modalOpen="false",Te();return}xe(a),ft(),P()}function l(){clearTimeout(it),it=window.setTimeout(_e,60)}const St={switchTab(t){const e={home:$(),students:"student-details",analysis:"summary"};if(t==="me"){p("account");return}const a=e[t]||t;tt(a)},renderStudentList(){l()},showStudentDetail(){l()},renderAnalysis(){l()},openModules(){p("modules")},openLibrary(){I(!0)},openQuickActions(){p("quick")},openAccountSheet(){p("account")},openCohortSheet(){p("cohorts")},refresh:l};window.MobMgr=St,window.MobileQueryUI={refresh:l,openLibrary:()=>I(!0),openModules:()=>p("modules"),openQuick:()=>p("quick"),openAccount:()=>p("account"),openCohorts:()=>p("cohorts")},window.MobileExperienceRuntime=window.MobileExperienceRuntime||{install:lt,syncCompactState:K,isCompactViewport:st},window.MobDashboardMgr=window.MobDashboardMgr||{showToast(t){window.UI&&typeof window.UI.toast=="function"?window.UI.toast(t,"info"):typeof window.showToast=="function"?window.showToast(t):window.alert(t)}},window.switchMobileTab=t=>St.switchTab(t),window.matchMedia&&(v=window.matchMedia("(prefers-color-scheme: dark)"),typeof v.addEventListener=="function"?v.addEventListener("change",l):typeof v.addListener=="function"&&v.addListener(l)),window.addEventListener("cloud-load-state",l),window.addEventListener("resize",l),window.addEventListener("orientationchange",l),window.addEventListener("load",l);function Le(){const t=document.getElementById("mobile-skeleton");t&&b()&&(t.classList.add("hidden"),setTimeout(()=>{t.remove()},350))}function Et(){b()&&setTimeout(Le,200)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Et):Et(),window.addEventListener("pageshow",l),window.addEventListener("focus",l),document.addEventListener("touchstart",ve,{passive:!0}),document.addEventListener("touchmove",Se,{passive:!0}),document.addEventListener("touchend",vt,{passive:!0}),document.addEventListener("touchcancel",vt,{passive:!0}),document.addEventListener("resume",l,!1),document.addEventListener("visibilitychange",()=>{document.hidden||l()}),lt(),T.forEach(t=>{window.setTimeout(l,t)}),l(),window.__MOBILE_MANAGER_PATCHED__=!0,window.__MOBILE_APP_RUNTIME_PATCHED__=!0})();
