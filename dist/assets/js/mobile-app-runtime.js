(()=>{if(typeof window=="undefined"||window.__MOBILE_APP_RUNTIME_PATCHED__)return;const wt=960,_=[80,260,900],gt=[140,420,980,1600],kt={admin:"starter-hub",director:"starter-hub",grade_director:"starter-hub",class_teacher:"student-details",teacher:"teacher-analysis"},vt=["student-details","summary","teacher-analysis","report-generator","progress-analysis","analysis"],ot="apk-recent-modules-v1",D=8,j=6,St={admin:"管理员",director:"校级管理",grade_director:"级部主任",class_teacher:"班主任",teacher:"教师",parent:"家长",student:"学生",guest:"访客"},F=!!(window.Capacitor&&(typeof window.Capacitor.isNativePlatform=="function"&&window.Capacitor.isNativePlatform()||typeof window.Capacitor.getPlatform=="function"&&window.Capacitor.getPlatform()!=="web"));let at=0,u="",d=!1,m="",y=null,v=null,it=null,W="",H=null,L=new Map;function i(t){return String(t!=null?t:"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function Ct(t,e){if(!t)return!1;const o=String(e!=null?e:"");return t.textContent===o?!1:(t.textContent=o,!0)}function S(t,e){if(!t)return!1;const o=String(e!=null?e:"");return t.__apkLastHtml===o?!1:(t.innerHTML=o,t.__apkLastHtml=o,!0)}function K(t,e,o){if(!(t!=null&&t.dataset))return!1;const a=String(o!=null?o:"");return t.dataset[e]===a?!1:(t.dataset[e]=a,!0)}function Et(t,e,o){if(!(t!=null&&t.style))return!1;const a=String(o!=null?o:"");return t.style.getPropertyValue(e)===a?!1:(t.style.setProperty(e,a),!0)}function Tt(t,e,o){if(!(t!=null&&t.classList))return!1;const a=!!o;return t.classList.contains(e)===a?!1:(t.classList.toggle(e,a),!0)}function _t(){var e,o,a;const t=[Number(window.innerWidth||0),Number(((e=document.documentElement)==null?void 0:e.clientWidth)||0),Number(window.outerWidth||0),Number(((o=window.screen)==null?void 0:o.width)||0),Number(((a=window.screen)==null?void 0:a.availWidth)||0)].filter(n=>Number.isFinite(n)&&n>0);return t.length?Math.min(...t):0}function g(){return _t()<=wt}function Lt(t){var a;const e=(a=t==null?void 0:t.querySelector)==null?void 0:a.call(t,"[data-apk-rail]");if(!e)return;const o=e.querySelector(".apk-rail-chip.is-active");!o||typeof o.scrollIntoView!="function"||o.scrollIntoView({inline:"center",block:"nearest",behavior:"auto"})}function $(){return window.AuthState&&typeof window.AuthState.getCurrentUser=="function"?window.AuthState.getCurrentUser():window.Auth&&window.Auth.currentUser?window.Auth.currentUser:null}function q(){var t,e,o;return window.AuthState&&typeof window.AuthState.getCurrentRole=="function"?window.AuthState.getCurrentRole():String(((t=$())==null?void 0:t.role)||((o=(e=document.body)==null?void 0:e.dataset)==null?void 0:o.role)||"guest").trim()||"guest"}function nt(){if(window.AuthState&&typeof window.AuthState.getCurrentRoles=="function")return window.AuthState.getCurrentRoles();const t=$();return(Array.isArray(t==null?void 0:t.roles)&&t.roles.length?t.roles:[t==null?void 0:t.role].filter(Boolean)).map(o=>String(o||"").trim()).filter(Boolean)}function ge(t){const e=new Set(nt());return t.some(o=>e.has(o))}function Q(t=q()){const e=String(t||"").trim();return e==="parent"||e==="student"}function rt(t=q()){return St[String(t||"").trim()]||String(t||"访客")}function st(){var t,e;return window.SchoolState&&typeof window.SchoolState.getCurrentSchool=="function"?String(((t=$())==null?void 0:t.school)||window.SchoolState.getCurrentSchool()||"").trim():String(((e=$())==null?void 0:e.school)||window.MY_SCHOOL||localStorage.getItem("MY_SCHOOL")||"").trim()}function Y(){const t=document.getElementById("login-overlay"),e=!!(t&&getComputedStyle(t).display!=="none");return!!$()&&!e}function $t(){if(window.NAV_STRUCTURE)return window.NAV_STRUCTURE;try{return NAV_STRUCTURE}catch(t){return null}}function Mt(){W="",H=null,L=new Map}function At(t,e){const o=nt().join("|"),a=t?Object.keys(t).join("|"):"",n=window.CONFIG&&window.CONFIG.showQuery?"report:1":"report:0";return[e,o,a,n].join("::")}function xt(t){const e=q();return!((e==="teacher"||e==="class_teacher")&&typeof window.canAccessModule=="function"&&!window.canAccessModule(t)||e==="teacher"&&["exam-arranger","freshman-simulator"].includes(t)||t==="report-generator"&&typeof window.CONFIG!="undefined"&&window.CONFIG&&!window.CONFIG.showQuery)}function M(){const t=$t();if(!t)return[];const e=q(),o=At(t,e);if(H&&W===o)return H;const a=e==="teacher"||e==="class_teacher",n=Object.keys(t).filter(r=>!(a&&(r==="data"||r==="tools")||a&&e==="teacher"&&r==="town")).map(r=>{const s=t[r];return{...s,key:r,items:Array.isArray(s==null?void 0:s.items)?s.items.filter(l=>xt(l.id)):[]}}).filter(r=>r.items.length>0);return W=o,H=n,L=new Map,n}function C(t){if(!t)return null;if(L.has(t))return L.get(t);const e=M();for(const o of e){const a=o.items.find(n=>n.id===t);if(a){const n={...a,categoryKey:o.key,categoryTitle:o.title,categoryColor:o.color};return L.set(t,n),n}}return L.set(t,null),null}function A(){var o,a,n;const t=kt[q()]||"starter-hub",e=C(t);return e?e.id:((n=(a=(o=M()[0])==null?void 0:o.items)==null?void 0:a[0])==null?void 0:n.id)||"starter-hub"}function x(){var t;return((t=document.querySelector(".section.active"))==null?void 0:t.id)||A()}function N(){return C(x())||C(A())||null}function z(){const t=M(),e=N();if(e){const a=t.find(n=>n.key===e.categoryKey);if(a)return a}const o=typeof window.getCurrentNavCategory=="function"?String(window.getCurrentNavCategory()||"").trim():"";return t.find(a=>a.key===o)||t[0]||null}function B(t){const e=new Set;return t.filter(o=>!o||!o.id||e.has(o.id)?!1:(e.add(o.id),!0))}function lt(){try{const t=JSON.parse(localStorage.getItem(ot)||"[]");return Array.isArray(t)?t.map(e=>String(e||"").trim()).filter(Boolean):[]}catch(t){return[]}}function Rt(t){try{localStorage.setItem(ot,JSON.stringify(t.map(e=>String(e||"").trim()).filter(Boolean).slice(0,D)))}catch(e){}}function It(t){const e=C(t);e&&Rt([e.id,...lt().filter(o=>o!==e.id)])}function G(t=D){return B(lt().map(e=>C(e)).filter(Boolean)).slice(0,t)}function ct(t=j){const e=[...G(t),N(),C(A()),...vt.map(o=>C(o))];return B(e).slice(0,t)}function ke(){var o;const t=document.getElementById("mode-badge"),e=String((t==null?void 0:t.textContent)||"").trim();return e||String(((o=window.CONFIG)==null?void 0:o.name)||"学校工作台").trim()}function X(){var e;const t=document.getElementById("cohort-selector");return(e=t==null?void 0:t.selectedOptions)!=null&&e[0]&&String(t.selectedOptions[0].textContent||t.value||"届别未选择").trim()||"届别未选择"}function Ot(){const t=document.getElementById("cohort-selector");return t?Array.from(t.options||[]).filter(e=>String(e.value||"").trim()).map(e=>({value:String(e.value||"").trim(),label:String(e.textContent||e.value||"").trim()})):[]}function qt(){return document.querySelector("main.app-main")}function ut(){const t=qt();if(t&&typeof t.scrollTo=="function"){t.scrollTo({top:0,behavior:"auto"});return}const e=document.scrollingElement||document.documentElement||document.body;if(e&&typeof e.scrollTo=="function"){e.scrollTo({top:0,behavior:"auto"});return}typeof window.scrollTo=="function"&&window.scrollTo({top:0,behavior:"auto"})}function Nt(t=document){if(!g())return;t.querySelectorAll(".table-wrap table, table.comparison-table, table.fluent-table, #tb-query, #studentDetailTable").forEach(o=>{const a=Bt(o);a.length&&(o.classList.add("mobile-card-table"),Array.from(o.querySelectorAll("tbody tr")).forEach(n=>{let r=String(n.getAttribute("data-mobile-card-title")||"").trim();Array.from(n.children).forEach((s,l)=>{if(!(s instanceof HTMLElement)||s.hasAttribute("colspan"))return;const f=String(a[l]||`字段${l+1}`).replace(/\s+/g," ").trim(),T=String(s.textContent||"").replace(/\s+/g," ").trim();!r&&T&&l<=1&&(r=T),s.setAttribute("data-label",f)}),r&&n.setAttribute("data-mobile-card-title",r)}))})}function Bt(t){const e=Array.from(t.querySelectorAll("thead tr"));if(!e.length)return[];const o=[];let a=0;return e.forEach((n,r)=>{o[r]||(o[r]=[]);let s=0;Array.from(n.children).forEach(l=>{for(;o[r][s];)s+=1;const f=Math.max(parseInt(l.getAttribute("colspan")||"1",10)||1,1),T=Math.max(parseInt(l.getAttribute("rowspan")||"1",10)||1,1),h=String(l.textContent||"").replace(/\s+/g," ").trim();for(let V=0;V<T;V+=1){o[r+V]||(o[r+V]=[]);for(let et=0;et<f;et+=1)o[r+V][s+et]=h}s+=f,s>a&&(a=s)})}),Array.from({length:a},(n,r)=>{const s=[];return o.forEach(l=>{const f=String((l==null?void 0:l[r])||"").trim();!f||s[s.length-1]===f||s.push(f)}),s.join(" / ")})}function J(t=document){if(!g())return;const e=t&&typeof t.querySelectorAll=="function"?t:document.querySelector(".section.active")||document;Nt(e)}function dt(t=document){if(!g())return;const e=t&&typeof t.querySelectorAll=="function"?t:document.querySelector(".section.active")||document;clearTimeout(window.__RESPONSIVE_TABLE_REFRESH_TIMER__||0),window.__RESPONSIVE_TABLE_REFRESH_TIMER__=window.setTimeout(()=>{J(e)},60)}function Pt(t=document.querySelector(".section.active")||document.getElementById("app")||document.body){if(typeof MutationObserver!="function")return;const e=t instanceof HTMLElement?t:document.querySelector(".section.active")||document.getElementById("app")||document.body||document.documentElement;if(!e||window.__RESPONSIVE_TABLE_OBSERVER__&&it===e)return;window.__RESPONSIVE_TABLE_OBSERVER__&&typeof window.__RESPONSIVE_TABLE_OBSERVER__.disconnect=="function"&&window.__RESPONSIVE_TABLE_OBSERVER__.disconnect();const o=new MutationObserver(a=>{if(!g())return;a.some(r=>Array.from(r.addedNodes||[]).some(s=>{var l;return s instanceof HTMLElement?s.matches("table, tbody, tr, td, .table-wrap, .comparison-table, .fluent-table, .section, #parent-view-container")||!!((l=s.querySelector)!=null&&l.call(s,"table, tbody, tr, td, .table-wrap, .comparison-table, .fluent-table")):!1}))&&dt(e)});o.observe(e,{childList:!0,subtree:!0}),window.__RESPONSIVE_TABLE_OBSERVER__=o,it=e}window.refreshResponsiveMobileTables=J;function Vt(t=document){g()&&(t.querySelectorAll('.section [style*="grid-template-columns"]').forEach(e=>{e.closest("#parent-view-container")||e.classList.add("mobile-stack-grid")}),t.querySelectorAll('.section [style*="display:flex"]').forEach(e=>{e.closest("#parent-view-container")||e.closest("#apk-mobile-shell")||e.children.length<2||e.classList.add("mobile-wrap-row")}))}function Ht(){if(document.getElementById("mobile-experience-styles"))return;const t=document.createElement("style");t.id="mobile-experience-styles",t.textContent=`
        ...
        `}function Zt(){var T;const t=b(),e=x(),o=String(m||"").trim(),a=Xt(),n=z(),r=B([...G(6),N()]).slice(0,6),s=new Set(r.map(h=>h.id)),l=ct(6+s.size).filter(h=>!s.has(h.id)).slice(0,6),f=M();return`
        ...
        `,t.addEventListener("click",he),t.addEventListener("input",pe),document.body.appendChild(t),t}function te(){const t=b(),e=M(),o=x();return e.length?[R(t.moduleOverviewTitle,t.moduleOverviewCopy),...e.map(a=>`
            ...
            `)].join(""):`${R(t.moduleOverviewTitle,t.noModules)}
                <div class="apk-sheet-empty">${i(t.noModules)}</div>`}function ee(){const t=b(),e=x(),o=B([...G(D),N()]).slice(0,4),a=new Set(o.map(s=>s.id)),n=ct(j+a.size).filter(s=>!a.has(s.id)).slice(0,j),r=[w("library",t.allModulesTitle,t.allModulesCopy,"ti ti-layout-sidebar-left-expand"),w("search",t.searchTitle,t.searchCopy,"ti ti-search"),w("cohorts",t.cohortsTitle,t.cohortsCopy,"ti ti-id-badge-2"),typeof window.openUserPasswordModal=="function"?w("password",t.passwordTitle,t.passwordCopy,"ti ti-lock"):"",w("logout",t.logoutTitle,t.logoutCopy,"ti ti-logout","is-danger")].filter(Boolean);return`
        ...
        `}function oe(){const t=b(),e=$();return`
                ...
                <div class="apk-account-card">
                    ...
                    <div class="apk-account-grid">
                        ...
                        <div class="apk-account-row">
                            ...
                            <strong>${i(`${t.followSystem} · ${zt()}`)}</strong>
                        </div>
                        <div class="apk-account-row">
        ...
        `}function ae(){var a;const t=b(),e=Ot(),o=((a=document.getElementById("cohort-selector"))==null?void 0:a.value)||"";return e.length?`
        ...
        `:`${R(t.switchCohortTitle,t.noCohortChoices)}
                <div class="apk-sheet-empty">${i(t.noCohorts)}</div>`}function ie(t){const e=t.querySelector("[data-apk-library-panel]");e&&S(e,d?Zt():"")}function ne(){const e=Z().querySelector("[data-apk-sheet-panel]");if(e){if(!u){S(e,"");return}if(u==="modules"){S(e,te());return}if(u==="quick"){S(e,ee());return}if(u==="account"){S(e,oe());return}u==="cohorts"&&S(e,ae())}}function re(t){var s;const e=b(),o=t.querySelector("[data-apk-rail]");if(!o)return;const a=z(),n=x();if(!((s=a==null?void 0:a.items)!=null&&s.length)){S(o,`<div class="apk-rail-empty">${i(e.currentCategoryEmpty)}</div>`);return}const r=a.items.map(l=>`
            <button type="button" class="apk-rail-chip${l.id===n?" is-active":""}" data-apk-module="${i(l.id)}">
                ${i(l.text||l.id)}
            </button>
        `).join("");S(o,r)&&window.requestAnimationFrame(()=>Lt(t))}function se(t){const e=x(),o=A();t.querySelectorAll(".apk-shell-tab").forEach(a=>{const n=a.getAttribute("data-apk-tab");Tt(a,"is-active",!d&&(n==="home"&&!u&&e===o||n==="modules"&&u==="modules"||n==="quick"&&u==="quick"||n==="account"&&u==="account"))})}function P(){const t=b(),e=Z(),o=N(),a=z(),n=[st()||t.unknownSchool,(a==null?void 0:a.title)||t.workbench,X()].filter(Boolean).join(" · ");Et(e,"--apk-accent",(o==null?void 0:o.categoryColor)||(a==null?void 0:a.color)||"#2563eb"),e.setAttribute("aria-hidden","false"),K(e,"sheetOpen",u?"true":"false"),K(e,"sheetMode",u||""),K(e,"libraryOpen",d?"true":"false");const r={role:`${rt()}工作台`,title:(o==null?void 0:o.text)||"智慧教务",subtitle:n,cohort:X(),mode:t.workbench};Object.entries(r).forEach(([s,l])=>{const f=e.querySelector(`[data-apk-field="${s}"]`);Ct(f,l)}),Dt(e),re(e),ne(),ie(e),se(e)}function le(t,e={}){d=!!t,d&&(u=""),!d&&e.resetQuery!==!1&&(m=""),P()}function I(t){le(typeof t=="boolean"?t:!d)}function p(t=""){u=t,t&&(d=!1,m=""),P()}function E(t){p(u===t?"":t)}function tt(t){!t||typeof window.switchTab!="function"||(u="",d=!1,m="",P(),ut(),window.switchTab(t),It(t),t==="student-details"&&jt(),_.forEach(e=>{window.setTimeout(()=>{var o;(o=document.getElementById(t))!=null&&o.classList.contains("active")&&(pt(),t==="student-details"&&typeof window.requestStudentDetailsPrimaryFocus=="function"&&window.requestStudentDetailsPrimaryFocus()),c()},e)}))}function ce(){d=!1,m="",p(""),typeof window.openSpotlight=="function"&&window.openSpotlight()}function ue(){d=!1,m="",p(""),typeof window.openUserPasswordModal=="function"&&window.openUserPasswordModal()}function de(t){if(t==="home"){tt(A());return}if(t==="modules"){E("modules");return}if(t==="quick"){E("quick");return}t==="account"&&E("account")}function pe(t){const e=t.target.closest("[data-apk-library-search]");if(!e)return;const o=typeof e.selectionStart=="number"?e.selectionStart:String(e.value||"").length;if(m=String(e.value||""),P(),!d)return;const a=document.querySelector("[data-apk-library-search]");a&&(typeof a.focus=="function"&&a.focus({preventScroll:!0}),typeof a.setSelectionRange=="function"&&a.setSelectionRange(o,o))}function he(t){const e=t.target.closest("[data-apk-action], [data-apk-module], [data-apk-cohort], [data-apk-tab]");if(!e)return;t.preventDefault();const o=e.getAttribute("data-apk-module");if(o){tt(o);return}const a=e.getAttribute("data-apk-cohort");if(a){Yt(a);return}const n=e.getAttribute("data-apk-tab");if(n){de(n);return}const r=e.getAttribute("data-apk-action");if(r==="close-sheet"){p("");return}if(r==="library"){I();return}if(r==="close-library"){I(!1);return}if(r==="modules"){E("modules");return}if(r==="quick"){E("quick");return}if(r==="account"){E("account");return}if(r==="cohorts"){E("cohorts");return}if(r==="search"){ce();return}if(r==="password"){ue();return}r==="logout"&&window.Auth&&typeof window.Auth.logout=="function"&&(d=!1,m="",p(""),window.Auth.logout())}function be(t){var o;if(!g()||!Y()||Q()||ht())return;const e=(o=t.touches)==null?void 0:o[0];e&&(y={startX:e.clientX,startY:e.clientY,canOpenLibrary:!d&&!u&&e.clientX<=28,canCloseLibrary:d})}function fe(t){var n;if(!y)return;const e=(n=t.touches)==null?void 0:n[0];if(!e)return;const o=e.clientX-y.startX,a=e.clientY-y.startY;if(Math.abs(a)>42){y=null;return}if(y.canOpenLibrary&&o>=80){I(!0),y=null;return}y.canCloseLibrary&&o<=-80&&(I(!1),y=null)}function mt(){y=null}function O(t,e,o){if(!t||typeof t[e]!="function"||t[e][o])return;const a=t[e],n=function(){const r=a.apply(this,arguments);return c(),_.forEach(s=>{window.setTimeout(c,s)}),r};n[o]=!0,t[e]=n}function me(){if(window.Swal&&(O(window.Swal,"close","__apkMobileWrapped__"),typeof window.Swal.fire=="function"&&!window.Swal.fire.__apkMobileWrapped__)){const t=window.Swal.fire,e=function(){const o=t.apply(window.Swal,arguments);return c(),_.forEach(a=>{window.setTimeout(c,a)}),o&&typeof o.finally=="function"&&o.finally(()=>{_.forEach(a=>{window.setTimeout(c,a)})}),o};e.__apkMobileWrapped__=!0,window.Swal.fire=e}}function ye(){O(window,"switchTab","__apkMobileWrapped__"),O(window,"renderNavigation","__apkMobileWrapped__"),O(window,"switchNavCategory","__apkMobileWrapped__"),window.Auth&&(O(window.Auth,"applyRoleView","__apkMobileWrapped__"),O(window.Auth,"renderParentView","__apkMobileWrapped__")),me()}function we(){Mt(),ye(),Qt();const t=g(),e=t&&Y()&&!Q();document.body.dataset.mobileQuery=t?"true":"false",e?document.body.dataset.mobileArchitecture="apk-v2":delete document.body.dataset.mobileArchitecture,Wt(),Ft();const o=Z();if(o.style.display=e?"block":"none",o.setAttribute("aria-hidden",e?"false":"true"),!e){u="",d=!1,m="",o.dataset.sheetOpen="false",o.dataset.sheetMode="",o.dataset.libraryOpen="false",o.dataset.modalOpen="false";return}pt(),P()}function c(){clearTimeout(at),at=window.setTimeout(we,60)}const yt={switchTab(t){const e={home:A(),students:"student-details",analysis:"summary"};if(t==="me"){p("account");return}const o=e[t]||t;tt(o)},renderStudentList(){c()},showStudentDetail(){c()},renderAnalysis(){c()},openModules(){p("modules")},openLibrary(){I(!0)},openQuickActions(){p("quick")},openAccountSheet(){p("account")},openCohortSheet(){p("cohorts")},refresh:c};window.MobMgr=yt,window.MobileQueryUI={refresh:c,openLibrary:()=>I(!0),openModules:()=>p("modules"),openQuick:()=>p("quick"),openAccount:()=>p("account"),openCohorts:()=>p("cohorts")},window.switchMobileTab=t=>yt.switchTab(t),window.matchMedia&&(v=window.matchMedia("(prefers-color-scheme: dark)"),typeof v.addEventListener=="function"?v.addEventListener("change",c):typeof v.addListener=="function"&&v.addListener(c)),window.addEventListener("cloud-load-state",c),window.addEventListener("resize",c),window.addEventListener("orientationchange",c),window.addEventListener("load",c),window.addEventListener("pageshow",c),window.addEventListener("focus",c),document.addEventListener("touchstart",be,{passive:!0}),document.addEventListener("touchmove",fe,{passive:!0}),document.addEventListener("touchend",mt,{passive:!0}),document.addEventListener("touchcancel",mt,{passive:!0}),document.addEventListener("resume",c,!1),document.addEventListener("visibilitychange",()=>{document.hidden||c()}),_.forEach(t=>{window.setTimeout(c,t)}),c(),window.__MOBILE_MANAGER_PATCHED__=!0,window.__MOBILE_APP_RUNTIME_PATCHED__=!0})();
