(()=>{if(typeof window=="undefined"||window.__MOBILE_APP_RUNTIME_PATCHED__)return;const Et=960,_=[80,260,900],Ct=[140,420,980,1600],Tt={admin:"starter-hub",director:"starter-hub",grade_director:"teacher-analysis",class_teacher:"student-details",teacher:"teacher-analysis"},_t=["student-details","summary","teacher-analysis","report-generator","progress-analysis","analysis"],ot="apk-recent-modules-v1",D=8,j=6,Mt={admin:"管理员",director:"校级管理",grade_director:"级部主任",class_teacher:"班主任",teacher:"教师",parent:"家长",student:"学生",guest:"访客"},it=!!(window.Capacitor&&(typeof window.Capacitor.isNativePlatform=="function"&&window.Capacitor.isNativePlatform()||typeof window.Capacitor.getPlatform=="function"&&window.Capacitor.getPlatform()!=="web"));let nt=0,d="",u=!1,m="",w=null,v=null,at=null,F="",H=null,M=new Map;function n(t){return String(t!=null?t:"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function Lt(t,e){if(!t)return!1;const o=String(e!=null?e:"");return t.textContent===o?!1:(t.textContent=o,!0)}function S(t,e){if(!t)return!1;const o=String(e!=null?e:"");return t.__apkLastHtml===o?!1:(t.innerHTML=o,t.__apkLastHtml=o,!0)}function W(t,e,o){if(!(t!=null&&t.dataset))return!1;const i=String(o!=null?o:"");return t.dataset[e]===i?!1:(t.dataset[e]=i,!0)}function $t(t,e,o){if(!(t!=null&&t.style))return!1;const i=String(o!=null?o:"");return t.style.getPropertyValue(e)===i?!1:(t.style.setProperty(e,i),!0)}function At(t,e,o){if(!(t!=null&&t.classList))return!1;const i=!!o;return t.classList.contains(e)===i?!1:(t.classList.toggle(e,i),!0)}function rt(){var e,o,i;const t=[Number(window.innerWidth||0),Number(((e=document.documentElement)==null?void 0:e.clientWidth)||0),Number(window.outerWidth||0),Number(((o=window.screen)==null?void 0:o.width)||0),Number(((i=window.screen)==null?void 0:i.availWidth)||0)].filter(a=>Number.isFinite(a)&&a>0);return t.length?Math.min(...t):0}function y(){return rt()<=Et}function st(){return window.matchMedia?window.matchMedia("(max-width: 900px)").matches:rt()<=900}function K(t=document){document.documentElement.classList.toggle("is-compact-viewport",st()),(t&&typeof t.querySelectorAll=="function"?t:document).querySelectorAll(".analysis-table-shell, .table-wrap").forEach(o=>{o.dataset.mobileHint||(o.dataset.mobileHint="可横向滑动查看完整表格")})}function lt(){K(document)}function xt(t){var i;const e=(i=t==null?void 0:t.querySelector)==null?void 0:i.call(t,"[data-apk-rail]");if(!e)return;const o=e.querySelector(".apk-rail-chip.is-active");!o||typeof o.scrollIntoView!="function"||o.scrollIntoView({inline:"center",block:"nearest",behavior:"auto"})}function L(){return window.AuthState&&typeof window.AuthState.getCurrentUser=="function"?window.AuthState.getCurrentUser():window.Auth&&window.Auth.currentUser?window.Auth.currentUser:null}function V(){var t,e,o;return window.AuthState&&typeof window.AuthState.getCurrentRole=="function"?window.AuthState.getCurrentRole():String(((t=L())==null?void 0:t.role)||((o=(e=document.body)==null?void 0:e.dataset)==null?void 0:o.role)||"guest").trim()||"guest"}function ct(){if(window.AuthState&&typeof window.AuthState.getCurrentRoles=="function")return window.AuthState.getCurrentRoles();const t=L();return(Array.isArray(t==null?void 0:t.roles)&&t.roles.length?t.roles:[t==null?void 0:t.role].filter(Boolean)).map(o=>String(o||"").trim()).filter(Boolean)}function Ee(t){const e=new Set(ct());return t.some(o=>e.has(o))}function Q(t=V()){const e=String(t||"").trim();return e==="parent"||e==="student"}function dt(t=V()){return Mt[String(t||"").trim()]||String(t||"访客")}function ut(){var t,e;return window.SchoolState&&typeof window.SchoolState.getCurrentSchool=="function"?String(((t=L())==null?void 0:t.school)||window.SchoolState.getCurrentSchool()||"").trim():String(((e=L())==null?void 0:e.school)||window.MY_SCHOOL||localStorage.getItem("MY_SCHOOL")||"").trim()}function Y(){const t=document.getElementById("login-overlay"),e=!!(t&&getComputedStyle(t).display!=="none");return!!L()&&!e}function Rt(){if(window.NAV_STRUCTURE)return window.NAV_STRUCTURE;try{return NAV_STRUCTURE}catch(t){return null}}function It(){F="",H=null,M=new Map}function Ot(t,e){const o=ct().join("|"),i=t?Object.keys(t).join("|"):"",a=window.CONFIG&&window.CONFIG.showQuery?"report:1":"report:0";return[e,o,i,a].join("::")}function qt(t){return!(typeof window.canAccessModule=="function"&&!window.canAccessModule(t)||t==="report-generator"&&typeof window.CONFIG!="undefined"&&window.CONFIG&&!window.CONFIG.showQuery)}function $(){const t=Rt();if(!t)return[];const e=V(),o=Ot(t,e);if(H&&F===o)return H;const i=Object.keys(t).map(a=>{const r=t[a];return{...r,key:a,items:Array.isArray(r==null?void 0:r.items)?r.items.filter(s=>qt(s.id)):[]}}).filter(a=>a.items.length>0);return F=o,H=i,M=new Map,i}function E(t){if(!t)return null;if(M.has(t))return M.get(t);const e=$();for(const o of e){const i=o.items.find(a=>a.id===t);if(i){const a={...i,categoryKey:o.key,categoryTitle:o.title,categoryColor:o.color};return M.set(t,a),a}}return M.set(t,null),null}function A(){var o,i,a;const t=Tt[V()]||"starter-hub",e=E(t);return e?e.id:((a=(i=(o=$()[0])==null?void 0:o.items)==null?void 0:i[0])==null?void 0:a.id)||"starter-hub"}function x(){var t;return((t=document.querySelector(".section.active"))==null?void 0:t.id)||A()}function q(){return E(x())||E(A())||null}function z(){const t=$(),e=q();if(e){const i=t.find(a=>a.key===e.categoryKey);if(i)return i}const o=typeof window.getCurrentNavCategory=="function"?String(window.getCurrentNavCategory()||"").trim():"";return t.find(i=>i.key===o)||t[0]||null}function N(t){const e=new Set;return t.filter(o=>!o||!o.id||e.has(o.id)?!1:(e.add(o.id),!0))}function pt(){try{const t=JSON.parse(localStorage.getItem(ot)||"[]");return Array.isArray(t)?t.map(e=>String(e||"").trim()).filter(Boolean):[]}catch(t){return[]}}function Nt(t){try{localStorage.setItem(ot,JSON.stringify(t.map(e=>String(e||"").trim()).filter(Boolean).slice(0,D)))}catch(e){}}function Bt(t){const e=E(t);e&&Nt([e.id,...pt().filter(o=>o!==e.id)])}function G(t=D){return N(pt().map(e=>E(e)).filter(Boolean)).slice(0,t)}function ht(t=j){const e=[...G(t),q(),E(A()),..._t.map(o=>E(o))];return N(e).slice(0,t)}function Ce(){var o;const t=document.getElementById("mode-badge"),e=String((t==null?void 0:t.textContent)||"").trim();return e||String(((o=window.CONFIG)==null?void 0:o.name)||"学校工作台").trim()}function X(){var e;const t=document.getElementById("cohort-selector");return(e=t==null?void 0:t.selectedOptions)!=null&&e[0]&&String(t.selectedOptions[0].textContent||t.value||"届别未选择").trim()||"届别未选择"}function Pt(){const t=document.getElementById("cohort-selector");return t?Array.from(t.options||[]).filter(e=>String(e.value||"").trim()).map(e=>({value:String(e.value||"").trim(),label:String(e.textContent||e.value||"").trim()})):[]}function Ht(){return document.querySelector("main.app-main")}function ft(){const t=Ht();if(t&&typeof t.scrollTo=="function"){t.scrollTo({top:0,behavior:"auto"});return}const e=document.scrollingElement||document.documentElement||document.body;if(e&&typeof e.scrollTo=="function"){e.scrollTo({top:0,behavior:"auto"});return}typeof window.scrollTo=="function"&&window.scrollTo({top:0,behavior:"auto"})}function Vt(t=document){if(!y())return;t.querySelectorAll(".table-wrap table, table.comparison-table, table.fluent-table, #tb-query, #studentDetailTable").forEach(o=>{const i=Ut(o);i.length&&(o.classList.add("mobile-card-table"),Array.from(o.querySelectorAll("tbody tr")).forEach(a=>{let r=String(a.getAttribute("data-mobile-card-title")||"").trim();Array.from(a.children).forEach((s,c)=>{if(!(s instanceof HTMLElement)||s.hasAttribute("colspan"))return;const b=String(i[c]||`字段${c+1}`).replace(/\s+/g," ").trim(),T=String(s.textContent||"").replace(/\s+/g," ").trim();!r&&T&&c<=1&&(r=T),s.setAttribute("data-label",b)}),r&&a.setAttribute("data-mobile-card-title",r)}))})}function Ut(t){const e=Array.from(t.querySelectorAll("thead tr"));if(!e.length)return[];const o=[];let i=0;return e.forEach((a,r)=>{o[r]||(o[r]=[]);let s=0;Array.from(a.children).forEach(c=>{for(;o[r][s];)s+=1;const b=Math.max(parseInt(c.getAttribute("colspan")||"1",10)||1,1),T=Math.max(parseInt(c.getAttribute("rowspan")||"1",10)||1,1),h=String(c.textContent||"").replace(/\s+/g," ").trim();for(let P=0;P<T;P+=1){o[r+P]||(o[r+P]=[]);for(let et=0;et<b;et+=1)o[r+P][s+et]=h}s+=b,s>i&&(i=s)})}),Array.from({length:i},(a,r)=>{const s=[];return o.forEach(c=>{const b=String((c==null?void 0:c[r])||"").trim();!b||s[s.length-1]===b||s.push(b)}),s.join(" / ")})}function J(t=document){if(!y())return;const e=t&&typeof t.querySelectorAll=="function"?t:document.querySelector(".section.active")||document;Vt(e)}function bt(t=document){if(!y())return;const e=t&&typeof t.querySelectorAll=="function"?t:document.querySelector(".section.active")||document;clearTimeout(window.__RESPONSIVE_TABLE_REFRESH_TIMER__||0),window.__RESPONSIVE_TABLE_REFRESH_TIMER__=window.setTimeout(()=>{J(e)},60)}function Dt(t=document.querySelector(".section.active")||document.getElementById("app")||document.body){if(typeof MutationObserver!="function")return;const e=t instanceof HTMLElement?t:document.querySelector(".section.active")||document.getElementById("app")||document.body||document.documentElement;if(!e||window.__RESPONSIVE_TABLE_OBSERVER__&&at===e)return;window.__RESPONSIVE_TABLE_OBSERVER__&&typeof window.__RESPONSIVE_TABLE_OBSERVER__.disconnect=="function"&&window.__RESPONSIVE_TABLE_OBSERVER__.disconnect();const o=new MutationObserver(i=>{if(!y())return;i.some(r=>Array.from(r.addedNodes||[]).some(s=>{var c;return s instanceof HTMLElement?s.matches("table, tbody, tr, td, .table-wrap, .comparison-table, .fluent-table, .section, #parent-view-container")||!!((c=s.querySelector)!=null&&c.call(s,"table, tbody, tr, td, .table-wrap, .comparison-table, .fluent-table")):!1}))&&bt(e)});o.observe(e,{childList:!0,subtree:!0}),window.__RESPONSIVE_TABLE_OBSERVER__=o,at=e}window.refreshResponsiveMobileTables=J;function jt(t=document){y()&&(t.querySelectorAll('.section [style*="grid-template-columns"]').forEach(e=>{e.closest("#parent-view-container")||e.classList.add("mobile-stack-grid")}),t.querySelectorAll('.section [style*="display:flex"]').forEach(e=>{e.closest("#parent-view-container")||e.closest("#apk-mobile-shell")||e.children.length<2||e.classList.add("mobile-wrap-row")}))}function Ft(){if(document.getElementById("mobile-experience-styles"))return;const t=document.createElement("style");t.id="mobile-experience-styles",t.textContent=`
        ...
        `}function ie(){var T;const t=f(),e=x(),o=String(m||"").trim(),i=ee(),a=z(),r=N([...G(6),q()]).slice(0,6),s=new Set(r.map(h=>h.id)),c=ht(6+s.size).filter(h=>!s.has(h.id)).slice(0,6),b=$();return`
