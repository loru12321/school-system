(()=>{if(typeof window=="undefined"||window.__MOBILE_APP_RUNTIME_PATCHED__)return;const Et=960,_=[80,260,900],Ct=[140,420,980,1600],Tt={admin:"starter-hub",director:"starter-hub",grade_director:"teacher-analysis",class_teacher:"student-details",teacher:"teacher-analysis"},_t=["student-details","summary","teacher-analysis","report-generator","progress-analysis","analysis"],it="apk-recent-modules-v1",D=8,j=6,Mt={admin:"管理员",director:"校级管理",grade_director:"级部主任",class_teacher:"班主任",teacher:"教师",parent:"家长",student:"学生",guest:"访客"},F=!!(window.Capacitor&&(typeof window.Capacitor.isNativePlatform=="function"&&window.Capacitor.isNativePlatform()||typeof window.Capacitor.getPlatform=="function"&&window.Capacitor.getPlatform()!=="web"));let nt=0,d="",u=!1,m="",w=null,v=null,at=null,W="",H=null,M=new Map;function n(t){return String(t!=null?t:"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function Lt(t,e){if(!t)return!1;const o=String(e!=null?e:"");return t.textContent===o?!1:(t.textContent=o,!0)}function S(t,e){if(!t)return!1;const o=String(e!=null?e:"");return t.__apkLastHtml===o?!1:(t.innerHTML=o,t.__apkLastHtml=o,!0)}function K(t,e,o){if(!(t!=null&&t.dataset))return!1;const i=String(o!=null?o:"");return t.dataset[e]===i?!1:(t.dataset[e]=i,!0)}function $t(t,e,o){if(!(t!=null&&t.style))return!1;const i=String(o!=null?o:"");return t.style.getPropertyValue(e)===i?!1:(t.style.setProperty(e,i),!0)}function At(t,e,o){if(!(t!=null&&t.classList))return!1;const i=!!o;return t.classList.contains(e)===i?!1:(t.classList.toggle(e,i),!0)}function rt(){var e,o,i;const t=[Number(window.innerWidth||0),Number(((e=document.documentElement)==null?void 0:e.clientWidth)||0),Number(window.outerWidth||0),Number(((o=window.screen)==null?void 0:o.width)||0),Number(((i=window.screen)==null?void 0:i.availWidth)||0)].filter(a=>Number.isFinite(a)&&a>0);return t.length?Math.min(...t):0}function y(){return rt()<=Et}function st(){return window.matchMedia?window.matchMedia("(max-width: 900px)").matches:rt()<=900}function Q(t=document){document.documentElement.classList.toggle("is-compact-viewport",st()),(t&&typeof t.querySelectorAll=="function"?t:document).querySelectorAll(".analysis-table-shell, .table-wrap").forEach(o=>{o.dataset.mobileHint||(o.dataset.mobileHint="可横向滑动查看完整表格")})}function lt(){Q(document)}function xt(t){var i;const e=(i=t==null?void 0:t.querySelector)==null?void 0:i.call(t,"[data-apk-rail]");if(!e)return;const o=e.querySelector(".apk-rail-chip.is-active");!o||typeof o.scrollIntoView!="function"||o.scrollIntoView({inline:"center",block:"nearest",behavior:"auto"})}function L(){return window.AuthState&&typeof window.AuthState.getCurrentUser=="function"?window.AuthState.getCurrentUser():window.Auth&&window.Auth.currentUser?window.Auth.currentUser:null}function V(){var t,e,o;return window.AuthState&&typeof window.AuthState.getCurrentRole=="function"?window.AuthState.getCurrentRole():String(((t=L())==null?void 0:t.role)||((o=(e=document.body)==null?void 0:e.dataset)==null?void 0:o.role)||"guest").trim()||"guest"}function ct(){if(window.AuthState&&typeof window.AuthState.getCurrentRoles=="function")return window.AuthState.getCurrentRoles();const t=L();return(Array.isArray(t==null?void 0:t.roles)&&t.roles.length?t.roles:[t==null?void 0:t.role].filter(Boolean)).map(o=>String(o||"").trim()).filter(Boolean)}function Ee(t){const e=new Set(ct());return t.some(o=>e.has(o))}function Y(t=V()){const e=String(t||"").trim();return e==="parent"||e==="student"}function dt(t=V()){return Mt[String(t||"").trim()]||String(t||"访客")}function ut(){var t,e;return window.SchoolState&&typeof window.SchoolState.getCurrentSchool=="function"?String(((t=L())==null?void 0:t.school)||window.SchoolState.getCurrentSchool()||"").trim():String(((e=L())==null?void 0:e.school)||window.MY_SCHOOL||localStorage.getItem("MY_SCHOOL")||"").trim()}function z(){const t=document.getElementById("login-overlay"),e=!!(t&&getComputedStyle(t).display!=="none");return!!L()&&!e}function Rt(){if(window.NAV_STRUCTURE)return window.NAV_STRUCTURE;try{return NAV_STRUCTURE}catch(t){return null}}function It(){W="",H=null,M=new Map}function Ot(t,e){const o=ct().join("|"),i=t?Object.keys(t).join("|"):"",a=window.CONFIG&&window.CONFIG.showQuery?"report:1":"report:0";return[e,o,i,a].join("::")}function qt(t){return!(typeof window.canAccessModule=="function"&&!window.canAccessModule(t)||t==="report-generator"&&typeof window.CONFIG!="undefined"&&window.CONFIG&&!window.CONFIG.showQuery)}function $(){const t=Rt();if(!t)return[];const e=V(),o=Ot(t,e);if(H&&W===o)return H;const i=Object.keys(t).map(a=>{const r=t[a];return{...r,key:a,items:Array.isArray(r==null?void 0:r.items)?r.items.filter(s=>qt(s.id)):[]}}).filter(a=>a.items.length>0);return W=o,H=i,M=new Map,i}function E(t){if(!t)return null;if(M.has(t))return M.get(t);const e=$();for(const o of e){const i=o.items.find(a=>a.id===t);if(i){const a={...i,categoryKey:o.key,categoryTitle:o.title,categoryColor:o.color};return M.set(t,a),a}}return M.set(t,null),null}function A(){var o,i,a;const t=Tt[V()]||"starter-hub",e=E(t);return e?e.id:((a=(i=(o=$()[0])==null?void 0:o.items)==null?void 0:i[0])==null?void 0:a.id)||"starter-hub"}function x(){var t;return((t=document.querySelector(".section.active"))==null?void 0:t.id)||A()}function q(){return E(x())||E(A())||null}function G(){const t=$(),e=q();if(e){const i=t.find(a=>a.key===e.categoryKey);if(i)return i}const o=typeof window.getCurrentNavCategory=="function"?String(window.getCurrentNavCategory()||"").trim():"";return t.find(i=>i.key===o)||t[0]||null}function N(t){const e=new Set;return t.filter(o=>!o||!o.id||e.has(o.id)?!1:(e.add(o.id),!0))}function pt(){try{const t=JSON.parse(localStorage.getItem(it)||"[]");return Array.isArray(t)?t.map(e=>String(e||"").trim()).filter(Boolean):[]}catch(t){return[]}}function Nt(t){try{localStorage.setItem(it,JSON.stringify(t.map(e=>String(e||"").trim()).filter(Boolean).slice(0,D)))}catch(e){}}function Bt(t){const e=E(t);e&&Nt([e.id,...pt().filter(o=>o!==e.id)])}function X(t=D){return N(pt().map(e=>E(e)).filter(Boolean)).slice(0,t)}function ht(t=j){const e=[...X(t),q(),E(A()),..._t.map(o=>E(o))];return N(e).slice(0,t)}function Ce(){var o;const t=document.getElementById("mode-badge"),e=String((t==null?void 0:t.textContent)||"").trim();return e||String(((o=window.CONFIG)==null?void 0:o.name)||"学校工作台").trim()}function J(){var e;const t=document.getElementById("cohort-selector");return(e=t==null?void 0:t.selectedOptions)!=null&&e[0]&&String(t.selectedOptions[0].textContent||t.value||"届别未选择").trim()||"届别未选择"}function Pt(){const t=document.getElementById("cohort-selector");return t?Array.from(t.options||[]).filter(e=>String(e.value||"").trim()).map(e=>({value:String(e.value||"").trim(),label:String(e.textContent||e.value||"").trim()})):[]}function Ht(){return document.querySelector("main.app-main")}function ft(){const t=Ht();if(t&&typeof t.scrollTo=="function"){t.scrollTo({top:0,behavior:"auto"});return}const e=document.scrollingElement||document.documentElement||document.body;if(e&&typeof e.scrollTo=="function"){e.scrollTo({top:0,behavior:"auto"});return}typeof window.scrollTo=="function"&&window.scrollTo({top:0,behavior:"auto"})}function Vt(t=document){if(!y())return;t.querySelectorAll(".table-wrap table, table.comparison-table, table.fluent-table, #tb-query, #studentDetailTable").forEach(o=>{const i=Ut(o);i.length&&(o.classList.add("mobile-card-table"),Array.from(o.querySelectorAll("tbody tr")).forEach(a=>{let r=String(a.getAttribute("data-mobile-card-title")||"").trim();Array.from(a.children).forEach((s,c)=>{if(!(s instanceof HTMLElement)||s.hasAttribute("colspan"))return;const b=String(i[c]||`字段${c+1}`).replace(/\s+/g," ").trim(),T=String(s.textContent||"").replace(/\s+/g," ").trim();!r&&T&&c<=1&&(r=T),s.setAttribute("data-label",b)}),r&&a.setAttribute("data-mobile-card-title",r)}))})}function Ut(t){const e=Array.from(t.querySelectorAll("thead tr"));if(!e.length)return[];const o=[];let i=0;return e.forEach((a,r)=>{o[r]||(o[r]=[]);let s=0;Array.from(a.children).forEach(c=>{for(;o[r][s];)s+=1;const b=Math.max(parseInt(c.getAttribute("colspan")||"1",10)||1,1),T=Math.max(parseInt(c.getAttribute("rowspan")||"1",10)||1,1),h=String(c.textContent||"").replace(/\s+/g," ").trim();for(let P=0;P<T;P+=1){o[r+P]||(o[r+P]=[]);for(let ot=0;ot<b;ot+=1)o[r+P][s+ot]=h}s+=b,s>i&&(i=s)})}),Array.from({length:i},(a,r)=>{const s=[];return o.forEach(c=>{const b=String((c==null?void 0:c[r])||"").trim();!b||s[s.length-1]===b||s.push(b)}),s.join(" / ")})}function Z(t=document){if(!y())return;const e=t&&typeof t.querySelectorAll=="function"?t:document.querySelector(".section.active")||document;Vt(e)}function bt(t=document){if(!y())return;const e=t&&typeof t.querySelectorAll=="function"?t:document.querySelector(".section.active")||document;clearTimeout(window.__RESPONSIVE_TABLE_REFRESH_TIMER__||0),window.__RESPONSIVE_TABLE_REFRESH_TIMER__=window.setTimeout(()=>{Z(e)},60)}function Dt(t=document.querySelector(".section.active")||document.getElementById("app")||document.body){if(typeof MutationObserver!="function")return;const e=t instanceof HTMLElement?t:document.querySelector(".section.active")||document.getElementById("app")||document.body||document.documentElement;if(!e||window.__RESPONSIVE_TABLE_OBSERVER__&&at===e)return;window.__RESPONSIVE_TABLE_OBSERVER__&&typeof window.__RESPONSIVE_TABLE_OBSERVER__.disconnect=="function"&&window.__RESPONSIVE_TABLE_OBSERVER__.disconnect();const o=new MutationObserver(i=>{if(!y())return;i.some(r=>Array.from(r.addedNodes||[]).some(s=>{var c;return s instanceof HTMLElement?s.matches("table, tbody, tr, td, .table-wrap, .comparison-table, .fluent-table, .section, #parent-view-container")||!!((c=s.querySelector)!=null&&c.call(s,"table, tbody, tr, td, .table-wrap, .comparison-table, .fluent-table")):!1}))&&bt(e)});o.observe(e,{childList:!0,subtree:!0}),window.__RESPONSIVE_TABLE_OBSERVER__=o,at=e}window.refreshResponsiveMobileTables=Z;function jt(t=document){y()&&(t.querySelectorAll('.section [style*="grid-template-columns"]').forEach(e=>{e.closest("#parent-view-container")||e.classList.add("mobile-stack-grid")}),t.querySelectorAll('.section [style*="display:flex"]').forEach(e=>{e.closest("#parent-view-container")||e.closest("#apk-mobile-shell")||e.children.length<2||e.classList.add("mobile-wrap-row")}))}function Ft(){if(document.getElementById("mobile-experience-styles"))return;const t=document.createElement("style");t.id="mobile-experience-styles",t.textContent=`
        ...
        `}function ie(){var T;const t=f(),e=x(),o=String(m||"").trim(),i=ee(),a=G(),r=N([...X(6),q()]).slice(0,6),s=new Set(r.map(h=>h.id)),c=ht(6+s.size).filter(h=>!s.has(h.id)).slice(0,6),b=$();return`
            ...
            ${o?`
                ...
                `}
        `}function tt(){let t=document.getElementById("apk-mobile-shell");if(t)return t;const e=f();return t=document.createElement("div"),t.id="apk-mobile-shell",t.setAttribute("aria-hidden","true"),t.innerHTML=`
        ...
        `,t.addEventListener("click",we),t.addEventListener("input",me),document.body.appendChild(t),t}function ne(){const t=f(),e=$(),o=x();return e.length?[R(t.moduleOverviewTitle,t.moduleOverviewCopy),...e.map(i=>`
        ...
        `}function re(){const t=f(),e=L();return`
                ...
                <div class="apk-account-card">
                    ...
                    <div class="apk-account-grid">
                        ...
                        <div class="apk-account-row">
                            ...
                            <strong>${n(`${t.followSystem} · ${Zt()}`)}</strong>
                        </div>
                        <div class="apk-account-row">
                            <span>${n(t.runtimeEnv)}</span>
                            <strong>${n(F?"Android APK":t.mobileBrowser)}</strong>
                        </div>
                    </div>
                </div>
            </section>
        ...
        `}function se(){var i;const t=f(),e=Pt(),o=((i=document.getElementById("cohort-selector"))==null?void 0:i.value)||"";return e.length?`
        ...
        `:`${R(t.switchCohortTitle,t.noCohortChoices)}
                <div class="apk-sheet-empty">${n(t.noCohorts)}</div>`}function le(t){const e=t.querySelector("[data-apk-library-panel]");e&&S(e,u?ie():"")}function ce(){const e=tt().querySelector("[data-apk-sheet-panel]");if(e){if(!d){S(e,"");return}if(d==="modules"){S(e,ne());return}if(d==="quick"){S(e,ae());return}if(d==="account"){S(e,re());return}d==="cohorts"&&S(e,se())}}function de(t){var s;const e=f(),o=t.querySelector("[data-apk-rail]");if(!o)return;const i=G(),a=x();if(!((s=i==null?void 0:i.items)!=null&&s.length)){S(o,`<div class="apk-rail-empty">${n(e.currentCategoryEmpty)}</div>`);return}const r=i.items.map(c=>`
            <button type="button" class="apk-rail-chip${c.id===a?" is-active":""}" data-apk-module="${n(c.id)}">
                ${n(c.text||c.id)}
            </button>
        `).join("");S(o,r)&&window.requestAnimationFrame(()=>xt(t))}function ue(t){const e=x(),o=A();t.querySelectorAll(".apk-shell-tab").forEach(i=>{const a=i.getAttribute("data-apk-tab");At(i,"is-active",!u&&(a==="home"&&!d&&e===o||a==="modules"&&d==="modules"||a==="quick"&&d==="quick"||a==="account"&&d==="account"))})}function B(){const t=f(),e=tt(),o=q(),i=G(),a=[ut()||t.unknownSchool,(i==null?void 0:i.title)||t.workbench,J()].filter(Boolean).join(" · ");$t(e,"--apk-accent",(o==null?void 0:o.categoryColor)||(i==null?void 0:i.color)||"#2563eb"),e.setAttribute("aria-hidden","false"),K(e,"sheetOpen",d?"true":"false"),K(e,"sheetMode",d||""),K(e,"libraryOpen",u?"true":"false");const r={role:`${dt()}工作台`,title:(o==null?void 0:o.text)||"校衡台",subtitle:a,cohort:J(),mode:t.workbench};Object.entries(r).forEach(([s,c])=>{const b=e.querySelector(`[data-apk-field="${s}"]`);Lt(b,c)}),Kt(e),de(e),ce(),le(e),ue(e)}function pe(t,e={}){u=!!t,u&&(d=""),!u&&e.resetQuery!==!1&&(m=""),B()}function I(t){pe(typeof t=="boolean"?t:!u)}function p(t=""){d=t,t&&(u=!1,m=""),B()}function C(t){p(d===t?"":t)}function et(t){!t||typeof window.switchTab!="function"||(d="",u=!1,m="",B(),ft(),window.switchTab(t),Bt(t),t==="student-details"&&Qt(),_.forEach(e=>{window.setTimeout(()=>{var o;(o=document.getElementById(t))!=null&&o.classList.contains("active")&&(mt(),t==="student-details"&&typeof window.requestStudentDetailsPrimaryFocus=="function"&&window.requestStudentDetailsPrimaryFocus()),l()},e)}))}function he(){u=!1,m="",p(""),typeof window.openSpotlight=="function"&&window.openSpotlight()}function fe(){u=!1,m="",p(""),typeof window.openUserPasswordModal=="function"&&window.openUserPasswordModal()}function be(t){if(t==="home"){et(A());return}if(t==="modules"){C("modules");return}if(t==="quick"){C("quick");return}t==="account"&&C("account")}function me(t){const e=t.target.closest("[data-apk-library-search]");if(!e)return;const o=typeof e.selectionStart=="number"?e.selectionStart:String(e.value||"").length;if(m=String(e.value||""),B(),!u)return;const i=document.querySelector("[data-apk-library-search]");i&&(typeof i.focus=="function"&&i.focus({preventScroll:!0}),typeof i.setSelectionRange=="function"&&i.setSelectionRange(o,o))}function we(t){const e=t.target.closest("[data-apk-action], [data-apk-module], [data-apk-cohort], [data-apk-tab]");if(!e)return;t.preventDefault();const o=e.getAttribute("data-apk-module");if(o){et(o);return}const i=e.getAttribute("data-apk-cohort");if(i){Jt(i);return}const a=e.getAttribute("data-apk-tab");if(a){be(a);return}const r=e.getAttribute("data-apk-action");if(r==="close-sheet"){p("");return}if(r==="library"){I();return}if(r==="close-library"){I(!1);return}if(r==="modules"){C("modules");return}if(r==="quick"){C("quick");return}if(r==="account"){C("account");return}if(r==="cohorts"){C("cohorts");return}if(r==="search"){he();return}if(r==="password"){fe();return}r==="logout"&&window.Auth&&typeof window.Auth.logout=="function"&&(u=!1,m="",p(""),window.Auth.logout())}function ye(t){var o;if(!y()||!z()||Y()||wt())return;const e=(o=t.touches)==null?void 0:o[0];e&&(w={startX:e.clientX,startY:e.clientY,canOpenLibrary:!u&&!d&&e.clientX<=28,canCloseLibrary:u})}function ge(t){var a;if(!w)return;const e=(a=t.touches)==null?void 0:a[0];if(!e)return;const o=e.clientX-w.startX,i=e.clientY-w.startY;if(Math.abs(i)>42){w=null;return}if(w.canOpenLibrary&&o>=80){I(!0),w=null;return}w.canCloseLibrary&&o<=-80&&(I(!1),w=null)}function vt(){w=null}function O(t,e,o){if(!t||typeof t[e]!="function"||t[e][o])return;const i=t[e],a=function(){const r=i.apply(this,arguments);return l(),_.forEach(s=>{window.setTimeout(l,s)}),r};a[o]=!0,t[e]=a}function ke(){if(window.Swal&&(O(window.Swal,"close","__apkMobileWrapped__"),typeof window.Swal.fire=="function"&&!window.Swal.fire.__apkMobileWrapped__)){const t=window.Swal.fire,e=function(){const o=t.apply(window.Swal,arguments);return l(),window.setTimeout(yt,1200),_.forEach(i=>{window.setTimeout(l,i)}),o&&typeof o.finally=="function"&&o.finally(()=>{_.forEach(i=>{window.setTimeout(l,i)})}),o};e.__apkMobileWrapped__=!0,window.Swal.fire=e}}function ve(){O(window,"switchTab","__apkMobileWrapped__"),O(window,"renderNavigation","__apkMobileWrapped__"),O(window,"switchNavCategory","__apkMobileWrapped__"),window.Auth&&(O(window.Auth,"applyRoleView","__apkMobileWrapped__"),O(window.Auth,"renderParentView","__apkMobileWrapped__")),ke()}function Se(){It(),ve(),Xt();const t=y(),e=t&&z()&&!Y();document.body.dataset.mobileQuery=t?"true":"false",e?document.body.dataset.mobileArchitecture="apk-v2":delete document.body.dataset.mobileArchitecture,zt(),Yt();const o=tt();if(o.style.display=e?"block":"none",o.setAttribute("aria-hidden",e?"false":"true"),!e){d="",u=!1,m="",o.dataset.sheetOpen="false",o.dataset.sheetMode="",o.dataset.libraryOpen="false",o.dataset.modalOpen="false";return}mt(),B()}function l(){clearTimeout(nt),nt=window.setTimeout(Se,60)}const St={switchTab(t){const e={home:A(),students:"student-details",analysis:"summary"};if(t==="me"){p("account");return}const o=e[t]||t;et(o)},renderStudentList(){l()},showStudentDetail(){l()},renderAnalysis(){l()},openModules(){p("modules")},openLibrary(){I(!0)},openQuickActions(){p("quick")},openAccountSheet(){p("account")},openCohortSheet(){p("cohorts")},refresh:l};window.MobMgr=St,window.MobileQueryUI={refresh:l,openLibrary:()=>I(!0),openModules:()=>p("modules"),openQuick:()=>p("quick"),openAccount:()=>p("account"),openCohorts:()=>p("cohorts")},window.MobileExperienceRuntime=window.MobileExperienceRuntime||{install:lt,syncCompactState:Q,isCompactViewport:st},window.MobDashboardMgr=window.MobDashboardMgr||{showToast(t){window.UI&&typeof window.UI.toast=="function"?window.UI.toast(t,"info"):typeof window.showToast=="function"?window.showToast(t):window.alert(t)}},window.switchMobileTab=t=>St.switchTab(t),window.matchMedia&&(v=window.matchMedia("(prefers-color-scheme: dark)"),typeof v.addEventListener=="function"?v.addEventListener("change",l):typeof v.addListener=="function"&&v.addListener(l)),window.addEventListener("cloud-load-state",l),window.addEventListener("resize",l),window.addEventListener("orientationchange",l),window.addEventListener("load",l),window.addEventListener("pageshow",l),window.addEventListener("focus",l),document.addEventListener("touchstart",ye,{passive:!0}),document.addEventListener("touchmove",ge,{passive:!0}),document.addEventListener("touchend",vt,{passive:!0}),document.addEventListener("touchcancel",vt,{passive:!0}),document.addEventListener("resume",l,!1),document.addEventListener("visibilitychange",()=>{document.hidden||l()}),lt(),_.forEach(t=>{window.setTimeout(l,t)}),l(),window.__MOBILE_MANAGER_PATCHED__=!0,window.__MOBILE_APP_RUNTIME_PATCHED__=!0})();
