(()=>{if(typeof window=="undefined"||window.__REPORT_RENDER_RUNTIME_PATCHED__)return;function vt(){try{return localStorage.getItem("PARENT_REPORT_SHOW_RANK")==="1"}catch(e){return!1}}window.shouldShowParentReportRank=vt;const V=window.CompareSessionState||null,pt=window.ReportSessionState||null,Ut=typeof window.readCloudStudentCompareContextState=="function"?window.readCloudStudentCompareContextState:(()=>V&&typeof V.getCloudStudentCompareContext=="function"&&V.getCloudStudentCompareContext()||null),me=typeof window.readCurrentReportStudentState=="function"?window.readCurrentReportStudentState:(()=>pt&&typeof pt.getCurrentReportStudent=="function"?pt.getCurrentReportStudent()||null:window.CURRENT_REPORT_STUDENT&&typeof window.CURRENT_REPORT_STUDENT=="object"?window.CURRENT_REPORT_STUDENT:null),qt=typeof window.readDuplicateCompareExamsState=="function"?window.readDuplicateCompareExamsState:(()=>V&&typeof V.getDuplicateCompareExams=="function"?V.getDuplicateCompareExams()||[]:[]),o={signature:"",html:new Map,comparisonStudent:new WeakMap,comparisonStudentByKey:new Map,cloudHint:new WeakMap,cloudHintByKey:new Map,previousRecord:new WeakMap,previousRecordByKey:new Map,examHistory:new WeakMap,examHistoryByKey:new Map,im:new Map,scopeMapRaw:"",scopeMap:{},schoolCandidatesSignature:"",schoolCandidates:[],townshipRank:new Map,countyRank:new Map,countyDirect:new WeakMap};function I(){const e=[window.CURRENT_EXAM_ID||"",window.__REPORT_HISTORY_VERSION||0,window.__RAW_DATA_VERSION||0,Array.isArray(window.RAW_DATA)?window.RAW_DATA.length:0,Array.isArray(window.SUBJECTS)?window.SUBJECTS.join("|"):"",Object.keys(window.SCHOOLS||{}).join("|")].join("::");return o.signature!==e&&(o.signature=e,o.html.clear(),o.comparisonStudent=new WeakMap,o.comparisonStudentByKey.clear(),o.cloudHint=new WeakMap,o.cloudHintByKey.clear(),o.previousRecord=new WeakMap,o.previousRecordByKey.clear(),o.examHistory=new WeakMap,o.examHistoryByKey.clear(),o.townshipRank.clear(),o.countyRank.clear(),o.countyDirect=new WeakMap),e}function U(e){return[String((e==null?void 0:e.school)||"").trim(),String((e==null?void 0:e.class)||"").trim(),String((e==null?void 0:e.name)||"").trim(),String((e==null?void 0:e.id)||(e==null?void 0:e.examNo)||"").trim()].join("::")}function Jt(e,r){if(!Array.isArray(e)||!e.length)return null;for(let s=e.length-1;s>=0;s--){const a=e[s],g=(a==null?void 0:a.examFullKey)||(a==null?void 0:a.examId);if(!r||!isExamKeyEquivalentForCompare(g,r)&&!isExamKeyEquivalentForCompare(a==null?void 0:a.examId,r))return a||null}return null}function ft(e){if(!e||typeof e!="object")return e;if(I(),o.comparisonStudent.has(e))return o.comparisonStudent.get(e);const r=U(e);if(o.comparisonStudentByKey.has(r)){const a=o.comparisonStudentByKey.get(r);return o.comparisonStudent.set(e,a),a}const s=typeof getComparisonStudentView=="function"?getComparisonStudentView(e,RAW_DATA):e;return o.comparisonStudent.set(e,s),o.comparisonStudentByKey.set(r,s),s}function St(e){if(!e||typeof e!="object")return null;if(I(),o.cloudHint.has(e))return o.cloudHint.get(e);const r=U(e);if(o.cloudHintByKey.has(r)){const a=o.cloudHintByKey.get(r);return o.cloudHint.set(e,a),a}const s=ne(e);return o.cloudHint.set(e,s||null),o.cloudHintByKey.set(r,s||null),s||null}function Yt(e){if(!e||typeof e!="object")return null;if(I(),o.previousRecord.has(e))return o.previousRecord.get(e);const r=U(e);if(o.previousRecordByKey.has(r)){const a=o.previousRecordByKey.get(r);return o.previousRecord.set(e,a),a}const s=typeof findPreviousRecord=="function"?findPreviousRecord(e):null;return o.previousRecord.set(e,s||null),o.previousRecordByKey.set(r,s||null),s||null}function Rt(e){if(!e||typeof e!="object")return[];if(I(),o.examHistory.has(e))return o.examHistory.get(e);const r=U(e);if(o.examHistoryByKey.has(r)){const g=o.examHistoryByKey.get(r);return o.examHistory.set(e,g),g}const s=typeof getStudentExamHistory=="function"?getStudentExamHistory(e):[],a=Array.isArray(s)?s:[];return o.examHistory.set(e,a),o.examHistoryByKey.set(r,a),a}function Zt(e,r=null){const s=Array.isArray(r)?r:[],a=s[s.length-1]||{},g=`${I()}::${U(e)}::${s.length}:${a.examFullKey||a.examId||""}`;if(o.im.has(g))return o.im.get(g);const q=window.ReportInsightRuntime.buildStudentInsightModel(e,r,{getCachedComparisonStudentView:ft,getCachedStudentExamHistory:Rt});return o.im.set(g,q),q}function Xt(e){return window.ReportInsightRuntime.renderStudentInsightOverview(e)}function Qt(e){return window.ReportInsightRuntime.renderStudentActionPlan(e)}function Lt(e){return window.ReportInsightRuntime.renderStudentSubjectBoard(e)}function te(e){return window.ReportInsightRuntime.renderStudentRealityNote(e)}function at(e,r){const s=`${I()}::${e}::${(r||[]).join("|")}`,a=e==="township"?o.townshipRank:o.countyRank;if(a.has(s))return a.get(s);const g=e==="township"?typeof hasStudentTownshipRankData=="function"?hasStudentTownshipRankData(RAW_DATA,r):Object.keys(SCHOOLS).length>1:typeof hasStudentCountyRankData=="function"?hasStudentCountyRankData(RAW_DATA,r):null;return a.set(s,g),g}function ee(){let e="";try{e=localStorage.getItem("COUNTY_ANALYSIS_SCOPE_V1")||""}catch(r){e=""}if(o.scopeMapRaw!==e){o.scopeMapRaw=e;try{o.scopeMap=e?JSON.parse(e):{}}catch(r){o.scopeMap={}}}return o.scopeMap}function oe(){const e=I();return o.schoolCandidatesSignature===e||(o.schoolCandidatesSignature=e,o.schoolCandidates=Array.from(new Set([...Object.keys(SCHOOLS||{}),...(RAW_DATA||[]).map(r=>r==null?void 0:r.school)].map(r=>String(r||"").trim()).filter(Boolean)))),o.schoolCandidates}function ne(e){var r,s;return typeof getCloudCompareHint=="function"?getCloudCompareHint(e):(r=window.isCloudContextMatchStudent)!=null&&r.call(window,e)||(s=window.isCloudContextLikelyCurrentTarget)!=null&&s.call(window,e)?Ut():null}function Ct(e,r,s="score"){return window.ReportInsightRuntime.getTrendBadge(e,r,s)}function $t(e,r,s={}){var Mt,Ot,Kt,Ft,Bt,Pt,Wt,Gt,Vt;if(navigator.userAgent.toLowerCase().includes("android")&&window.innerWidth<=768&&!window.Chart)return console.warn("⚠️ Android Canvas 异常，强制切换 PC 模式"),$t(e,"PC",s);const gt=window.innerWidth<=768,ot=r==="FULL",it=r==="A4"||r==="PC"||ot,j=it,J=j?`${I()}::${U(e)}::${r||""}::${new Date().toLocaleDateString()}`:"";if(j&&o.html.has(J))return o.html.get(J);if(!it&&gt||r==="IG"){const t=Tt(e);return setTimeout(()=>{typeof renderIGCharts=="function"&&renderIGCharts(e)},50),t}const Ht=RAW_DATA.length,At=new Date().toLocaleDateString(),p=ft(e),z=St(p),M=Array.isArray(s.reportExamHistory)?s.reportExamHistory:Rt(p),kt=getEffectiveCurrentExamId(),k=Jt(M,kt),C=k?k.student||k:null,st=!!(C&&C.scores&&C.ranks),u=(z==null?void 0:z.previousRecord)||(st?null:Yt(p)),m=C&&C.scores?C:u,b=t=>typeof t=="number"&&Number.isFinite(t)?t:t&&typeof t=="object"&&typeof t.score=="number"&&Number.isFinite(t.score)?t.score:"-",Dt=t=>String(t!=null?t:"").replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),f=(t,n,l="")=>`<td data-label="${Dt(t)}"${l?` style="${l}"`:""}>${n}</td>`,Y=t=>{var n,l,i,y,d,w,R,h;return{class:(l=(n=t==null?void 0:t.class)!=null?n:t==null?void 0:t.rankClass)!=null?l:"-",school:(y=(i=t==null?void 0:t.school)!=null?i:t==null?void 0:t.rankSchool)!=null?y:"-",township:(w=(d=t==null?void 0:t.township)!=null?d:t==null?void 0:t.rankTown)!=null?w:"-",county:(h=(R=t==null?void 0:t.county)!=null?R:t==null?void 0:t.rankCounty)!=null?h:"-"}},Z=((Mt=m==null?void 0:m.ranks)==null?void 0:Mt.total)||{},X=(t,n,l="total",i="county")=>{var w,R,h,D,B,E,N,_;const y=l==="total"?((w=n==null?void 0:n.ranks)==null?void 0:w.total)||n||t||{}:((R=n==null?void 0:n.ranks)==null?void 0:R[l])||((h=n==null?void 0:n.subjectRanks)==null?void 0:h[l])||((D=t==null?void 0:t.subjectRanks)==null?void 0:D[l])||{},d=Y(y)[i];return d!=null&&d!==""?d:i==="county"&&l==="total"&&(_=(N=(E=(B=n==null?void 0:n.rankCounty)!=null?B:n==null?void 0:n.countyRank)!=null?E:t==null?void 0:t.rankCounty)!=null?N:t==null?void 0:t.countyRank)!=null?_:"-"},jt=(t,n=null)=>{const l=String((t==null?void 0:t.examFullKey)||(t==null?void 0:t.examId)||(n==null?void 0:n._sourceExam)||(n==null?void 0:n.examFullKey)||(n==null?void 0:n.examId)||"").trim();if(!l)return null;const i=ee();return(i==null?void 0:i[l])||null},nt=(t,n="total",l=null)=>{var d,w,R,h,D,B,E,N,_;if(!t||typeof t!="object")return!1;const i=n==="total"?(h=(R=(w=(d=t==null?void 0:t.ranks)==null?void 0:d.total)==null?void 0:w.county)!=null?R:t==null?void 0:t.rankCounty)!=null?h:t==null?void 0:t.countyRank:(_=(B=(D=t==null?void 0:t.ranks)==null?void 0:D[n])==null?void 0:B.county)!=null?_:(N=(E=t==null?void 0:t.subjectRanks)==null?void 0:E[n])==null?void 0:N.county;if(i!=null&&i!==""&&i!=="-")return!0;const y=jt(l,t);return!y||y.includesCounty!==!0?!1:i!=null&&i!==""},lt=t=>{var i;const n=String((i=t==null?void 0:t.class)!=null?i:"").trim(),l=typeof normalizeClass=="function"?normalizeClass(n):n;return!l||l==="-"?!1:!/^(?:无|未分班|无班级|暂无|undefined|null|nan)$/i.test(l)},O=t=>{if(typeof isCountyDirectStudentForRank=="function")return isCountyDirectStudentForRank(t);const n=String((t==null?void 0:t.school)||"").trim();if(!n||typeof getCountyDirectSchoolNames!="function"||typeof getTownshipManagedSchoolNames!="function")return!1;if(o.countyDirect.has(t))return o.countyDirect.get(t);const l=oe();if(!getTownshipManagedSchoolNames(l).length)return o.countyDirect.set(t,!1),!1;const y=getCountyDirectSchoolNames(l).some(d=>d===n||typeof areSchoolNamesEquivalent=="function"&&areSchoolNamesEquivalent(d,n)||typeof areSchoolNamesMatched=="function"&&areSchoolNamesMatched(d,n,!0));return o.countyDirect.set(t,y),y},$=(t,n=!0)=>n?t==null||t===""?"-":t:"-",v=window.ReportInsightRuntime.renderMetricComparison,Q=p&&typeof p=="object"&&p.scores&&typeof p.scores=="object"?p.scores:{},P=((Ot=window.getConfiguredReadOnlyDisplaySubjects)==null?void 0:Ot.call(window))||SUBJECTS,L=((Kt=window.RankingDataService)==null?void 0:Kt.buildStudentRankSnapshot(RAW_DATA,p,P))||null,T=(t,n)=>{var i;const l=safeGet(p,`ranks.${t}.${n}`,"-");return l!=null&&l!==""&&l!=="-"&&l!=="—"?l:(i=L==null?void 0:L.getRank(p,t,n,"-"))!=null?i:"-"},c=at("township",P),x=at("county",P),K=x===null?getStudentCountyRankValue(p,"total")!=="-":x,H=lt(p),tt=c&&!O(p),S=K,ut=$(T("total","township"),tt),mt=$((Bt=(Ft=Z.township)!=null?Ft:u==null?void 0:u.townRank)!=null?Bt:"-",tt),et=$(T("total","class"),H),W=$((Wt=(Pt=Z.class)!=null?Pt:u==null?void 0:u.classRank)!=null?Wt:"-",H),ct=T("total","school"),xt=(Vt=(Gt=Z.school)!=null?Gt:u==null?void 0:u.schoolRank)!=null?Vt:"-",ht=$(T("total","county"),S),rt=nt(m,"total",k)?X(k,m,"total","county"):"-",G=c?"":"display:none !important;",A=S?"":"display:none !important;",F=getComparisonTotalSubjects(),re=getComparisonTotalValue(p,F),bt=typeof window.getTotalSubjectLabel=="function"?window.getTotalSubjectLabel({subjects:F,withScoreUnit:!0}):CONFIG.name==="9年级"&&F.length?"五科总分":CONFIG.label,ae=m?recalcPrevTotal(m):"-";let zt=`<tr style="background:rgba(239,246,255,0.7); backdrop-filter:blur(4px); border-bottom:2px solid #fff;">
            ${f("科目",`🏆 ${bt}`,"font-weight:bold; color:#1e3a8a;")}
            ${f("成绩对比",v(re,ae,"score",2),"font-weight:800; color:#1e40af;")}
            ...
            ${f("县排对比",v(ht,rt,"rank"),`${A} font-weight:bold; color:#334155;`)}
                ...
                </tr>`}});const Et=[...new Set(P.filter(t=>Q[t]!==void 0).map(t=>typeof window.getConfiguredDisplaySubjectNotice=="function"?window.getConfiguredDisplaySubjectNotice(t):"").filter(Boolean))],Nt=Et.length?`<div style="font-size:10px; color:#94a3b8; line-height:1.6; margin-top:8px;">${Et.map(t=>`注：${tmEscapeHtml(t)}`).join("<br>")}</div>`:"",ie=`
            <style>
        ...
        `,se=typeof buildChartNarrative=="function"?buildChartNarrative(p):"",dt=Zt(p,M),le=Xt(dt),ce=Qt(dt),de=Lt(dt),pe=te(dt),fe=z?`
