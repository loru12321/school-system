(()=>{if(typeof window=="undefined"||window.__REPORT_RENDER_RUNTIME_PATCHED__)return;const P=window.CompareSessionState||null,pt=window.ReportSessionState||null,Ft=typeof window.readCloudStudentCompareContextState=="function"?window.readCloudStudentCompareContextState:(()=>P&&typeof P.getCloudStudentCompareContext=="function"&&P.getCloudStudentCompareContext()||null),ie=typeof window.readCurrentReportStudentState=="function"?window.readCurrentReportStudentState:(()=>pt&&typeof pt.getCurrentReportStudent=="function"?pt.getCurrentReportStudent()||null:window.CURRENT_REPORT_STUDENT&&typeof window.CURRENT_REPORT_STUDENT=="object"?window.CURRENT_REPORT_STUDENT:null),Kt=typeof window.readDuplicateCompareExamsState=="function"?window.readDuplicateCompareExamsState:(()=>P&&typeof P.getDuplicateCompareExams=="function"?P.getDuplicateCompareExams()||[]:[]),o={signature:"",html:new Map,comparisonStudent:new WeakMap,comparisonStudentByKey:new Map,cloudHint:new WeakMap,cloudHintByKey:new Map,previousRecord:new WeakMap,previousRecordByKey:new Map,examHistory:new WeakMap,examHistoryByKey:new Map,scopeMapRaw:"",scopeMap:{},schoolCandidatesSignature:"",schoolCandidates:[],townshipRank:new Map,countyRank:new Map,countyDirect:new WeakMap};function K(){const e=[window.CURRENT_EXAM_ID||"",window.__RAW_DATA_VERSION||0,Array.isArray(window.RAW_DATA)?window.RAW_DATA.length:0,Array.isArray(window.SUBJECTS)?window.SUBJECTS.join("|"):"",Object.keys(window.SCHOOLS||{}).join("|")].join("::");return o.signature!==e&&(o.signature=e,o.html.clear(),o.comparisonStudent=new WeakMap,o.comparisonStudentByKey.clear(),o.cloudHint=new WeakMap,o.cloudHintByKey.clear(),o.previousRecord=new WeakMap,o.previousRecordByKey.clear(),o.examHistory=new WeakMap,o.examHistoryByKey.clear(),o.townshipRank.clear(),o.countyRank.clear(),o.countyDirect=new WeakMap),e}function J(e){return[String((e==null?void 0:e.school)||"").trim(),String((e==null?void 0:e.class)||"").trim(),String((e==null?void 0:e.name)||"").trim(),String((e==null?void 0:e.id)||(e==null?void 0:e.examNo)||"").trim()].join("::")}function Ot(e,r){if(!Array.isArray(e)||!e.length)return null;for(let s=e.length-1;s>=0;s--){const n=e[s],g=(n==null?void 0:n.examFullKey)||(n==null?void 0:n.examId);if(!r||!isExamKeyEquivalentForCompare(g,r)&&!isExamKeyEquivalentForCompare(n==null?void 0:n.examId,r))return n||null}return null}function wt(e){if(!e||typeof e!="object")return e;if(K(),o.comparisonStudent.has(e))return o.comparisonStudent.get(e);const r=J(e);if(o.comparisonStudentByKey.has(r)){const n=o.comparisonStudentByKey.get(r);return o.comparisonStudent.set(e,n),n}const s=typeof getComparisonStudentView=="function"?getComparisonStudentView(e,RAW_DATA):e;return o.comparisonStudent.set(e,s),o.comparisonStudentByKey.set(r,s),s}function St(e){if(!e||typeof e!="object")return null;if(K(),o.cloudHint.has(e))return o.cloudHint.get(e);const r=J(e);if(o.cloudHintByKey.has(r)){const n=o.cloudHintByKey.get(r);return o.cloudHint.set(e,n),n}const s=Wt(e);return o.cloudHint.set(e,s||null),o.cloudHintByKey.set(r,s||null),s||null}function It(e){if(!e||typeof e!="object")return null;if(K(),o.previousRecord.has(e))return o.previousRecord.get(e);const r=J(e);if(o.previousRecordByKey.has(r)){const n=o.previousRecordByKey.get(r);return o.previousRecord.set(e,n),n}const s=typeof findPreviousRecord=="function"?findPreviousRecord(e):null;return o.previousRecord.set(e,s||null),o.previousRecordByKey.set(r,s||null),s||null}function Bt(e){if(!e||typeof e!="object")return[];if(K(),o.examHistory.has(e))return o.examHistory.get(e);const r=J(e);if(o.examHistoryByKey.has(r)){const g=o.examHistoryByKey.get(r);return o.examHistory.set(e,g),g}const s=typeof getStudentExamHistory=="function"?getStudentExamHistory(e):[],n=Array.isArray(s)?s:[];return o.examHistory.set(e,n),o.examHistoryByKey.set(r,n),n}function tt(e,r){const s=`${K()}::${e}::${(r||[]).join("|")}`,n=e==="township"?o.townshipRank:o.countyRank;if(n.has(s))return n.get(s);const g=e==="township"?typeof hasStudentTownshipRankData=="function"?hasStudentTownshipRankData(RAW_DATA,r):Object.keys(SCHOOLS).length>1:typeof hasStudentCountyRankData=="function"?hasStudentCountyRankData(RAW_DATA,r):null;return n.set(s,g),g}function Gt(){let e="";try{e=localStorage.getItem("COUNTY_ANALYSIS_SCOPE_V1")||""}catch(r){e=""}if(o.scopeMapRaw!==e){o.scopeMapRaw=e;try{o.scopeMap=e?JSON.parse(e):{}}catch(r){o.scopeMap={}}}return o.scopeMap}function Pt(){const e=K();return o.schoolCandidatesSignature===e||(o.schoolCandidatesSignature=e,o.schoolCandidates=Array.from(new Set([...Object.keys(SCHOOLS||{}),...(RAW_DATA||[]).map(r=>r==null?void 0:r.school)].map(r=>String(r||"").trim()).filter(Boolean)))),o.schoolCandidates}function Wt(e){return typeof getCloudCompareHint=="function"?getCloudCompareHint(e):isCloudContextMatchStudent(e)||isCloudContextLikelyCurrentTarget(e)?Ft():null}function H(e,r,s="score"){if(r==null||r==="-"||r==="")return"";const n=parseFloat(e),g=parseFloat(r);if(isNaN(n)||isNaN(g))return"";const D=n-g;if(Math.abs(D)<.01)return'<span style="color:#94a3b8; font-size:11px; margin-left:4px; font-weight:normal;">(持平)</span>';let z="",C="",$="";s==="score"?D>0?(z="#15803d",$="#dcfce7",C="▲"):(z="#b91c1c",$="#fee2e2",C="▼"):D<0?(z="#15803d",$="#dcfce7",C="▲"):(z="#b91c1c",$="#fee2e2",C="▼");const v=Math.abs(D);return`<span style="display:inline-flex; align-items:center; background:${$}; color:${z}; padding:1px 6px; border-radius:10px; font-size:11px; font-weight:bold; margin-left:5px; vertical-align:middle;">
            ${C} ${s==="score"?v.toFixed(1):v}
        </span>`}function Ct(e,r){var At,Dt,jt,kt,Nt,Et,Mt,_t;if(navigator.userAgent.toLowerCase().includes("android")&&window.innerWidth<=768&&!window.Chart)return console.warn("⚠️ Android Canvas 异常，强制切换 PC 模式"),Ct(e,"PC");const D=window.innerWidth<=768,z=r==="FULL",C=r==="A4"||r==="PC"||z,$=C,v=$?`${K()}::${J(e)}::${r||""}::${new Date().toLocaleDateString()}`:"";if($&&o.html.has(v))return o.html.get(v);if(!C&&D||r==="IG"){const t=$t(e);return setTimeout(()=>{typeof renderIGCharts=="function"&&renderIGCharts(e)},50),t}const ft=RAW_DATA.length,gt=new Date().toLocaleDateString(),p=wt(e),R=St(p),Y=Bt(p),W=getEffectiveCurrentExamId(),V=Ot(Y,W),k=V?V.student||V:null,U=!!(k&&k.scores&&k.ranks),f=(R==null?void 0:R.previousRecord)||(U?null:It(p)),u=k&&k.scores?k:f,Z=((At=u==null?void 0:u.ranks)==null?void 0:At.total)||{},x=t=>typeof t=="number"&&Number.isFinite(t)?t:t&&typeof t=="object"&&typeof t.score=="number"&&Number.isFinite(t.score)?t.score:"-",Rt=t=>String(t!=null?t:"").replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),l=(t,a,c="")=>`<td data-label="${Rt(t)}"${c?` style="${c}"`:""}>${a}</td>`,X=t=>{var a,c,i,b,m,T,j,S;return{class:(c=(a=t==null?void 0:t.class)!=null?a:t==null?void 0:t.rankClass)!=null?c:"-",school:(b=(i=t==null?void 0:t.school)!=null?i:t==null?void 0:t.rankSchool)!=null?b:"-",township:(T=(m=t==null?void 0:t.township)!=null?m:t==null?void 0:t.rankTown)!=null?T:"-",county:(S=(j=t==null?void 0:t.county)!=null?j:t==null?void 0:t.rankCounty)!=null?S:"-"}},et=(t,a=null)=>{const c=String((t==null?void 0:t.examFullKey)||(t==null?void 0:t.examId)||(a==null?void 0:a._sourceExam)||(a==null?void 0:a.examFullKey)||(a==null?void 0:a.examId)||"").trim();if(!c)return null;const i=Gt();return(i==null?void 0:i[c])||null},Q=(t,a="total",c=null)=>{var m,T,j,S,G,vt,lt,ct,dt;if(!t||typeof t!="object")return!1;const i=et(c,t);if(!i||i.includesCounty!==!0)return!1;const b=a==="total"?(S=(j=(T=(m=t==null?void 0:t.ranks)==null?void 0:m.total)==null?void 0:T.county)!=null?j:t==null?void 0:t.rankCounty)!=null?S:t==null?void 0:t.countyRank:(dt=(vt=(G=t==null?void 0:t.ranks)==null?void 0:G[a])==null?void 0:vt.county)!=null?dt:(ct=(lt=t==null?void 0:t.subjectRanks)==null?void 0:lt[a])==null?void 0:ct.county;return b!=null&&b!==""},Tt=t=>{var i;const a=String((i=t==null?void 0:t.class)!=null?i:"").trim(),c=typeof normalizeClass=="function"?normalizeClass(a):a;return!c||c==="-"?!1:!/^(?:无|未分班|无班级|暂无|undefined|null|nan)$/i.test(c)},ot=t=>{if(typeof isCountyDirectStudentForRank=="function")return isCountyDirectStudentForRank(t);const a=String((t==null?void 0:t.school)||"").trim();if(!a||typeof getCountyDirectSchoolNames!="function"||typeof getTownshipManagedSchoolNames!="function")return!1;if(o.countyDirect.has(t))return o.countyDirect.get(t);const c=Pt();if(!getTownshipManagedSchoolNames(c).length)return o.countyDirect.set(t,!1),!1;const b=getCountyDirectSchoolNames(c).some(m=>m===a||typeof areSchoolNamesEquivalent=="function"&&areSchoolNamesEquivalent(m,a)||typeof areSchoolNamesMatched=="function"&&areSchoolNamesMatched(m,a,!0));return o.countyDirect.set(t,b),b},O=(t,a=!0)=>a?t==null||t===""?"-":t:"-",I=p&&typeof p=="object"&&p.scores&&typeof p.scores=="object"?p.scores:{},L=[...new Set(SUBJECTS)],B=tt("township",L),d=tt("county",L),h=d===null?getStudentCountyRankValue(p,"total")!=="-":d,A=Tt(p),y=B&&!ot(p),N=h,E=O(safeGet(p,"ranks.total.township","-"),y),ut=O((jt=(Dt=Z.township)!=null?Dt:f==null?void 0:f.townRank)!=null?jt:"-",y),nt=O(safeGet(p,"ranks.total.class","-"),A),q=O((Nt=(kt=Z.class)!=null?kt:f==null?void 0:f.classRank)!=null?Nt:"-",A),M=safeGet(p,"ranks.total.school","-"),rt=(Mt=(Et=Z.school)!=null?Et:f==null?void 0:f.schoolRank)!=null?Mt:"-",at=getStudentCountyRankValue(p,"total"),mt=Q(u,"total",V)&&(_t=Z.county)!=null?_t:"-",it=Object.keys(SCHOOLS).length<=1,_=B?"":"display:none !important;",w=N?"":"display:none !important;";let F="";if(CONFIG.name==="9年级"){let t=0,a=0;["语文","数学","英语","物理","化学"].forEach(c=>{I[c]!==void 0&&(t+=I[c],a++)}),a>0&&(F+=`<tr style="background:rgba(248,250,252,0.5);">
                    ...
                    ${l("全镇排名","-",_)}
                    ${l("全县排名","-",w)}
                </tr>`)}const xt=getComparisonTotalSubjects(),ht=getComparisonTotalValue(p,xt),bt=CONFIG.name==="9年级"&&xt.length?"五科总分":CONFIG.label,Vt=u?recalcPrevTotal(u):"-",Ut=H(ht,Vt,"score"),qt=A?H(nt,q,"rank"):"",Jt=H(M,rt,"rank"),Yt=y?H(E,ut,"rank"):"",Zt=N?H(at,mt,"rank"):"";F+=`<tr style="background:rgba(239,246,255,0.7); backdrop-filter:blur(4px); border-bottom:2px solid #fff;">
            ${l("科目",`🏆 ${bt}`,"font-weight:bold; color:#1e3a8a;")}
            ${l("成绩（对比）",`${Number.isFinite(ht)?ht.toFixed(2):"-"} ${Ut}`,"font-weight:800; font-size:16px; color:#1e40af;")}
            ${l("班级排名",`${nt} ${qt}`,"font-weight:bold; color:#334155;")}
            ${l("校级排名",`${M} ${Jt}`,"font-weight:bold; color:#334155;")}
            ${l("全镇排名",`${E} ${Yt}`,`${_} font-weight:bold; color:#334155;`)}
            ${l("全县排名",`${N?at:"-"} ${Zt}`,`${w} font-weight:bold; color:#334155;`)}
        </tr>`,[...new Set(SUBJECTS)].forEach(t=>{if(I[t]!==void 0){const a=u&&u.scores?x(u.scores[t]):"-",c=H(I[t],a,"score");let i=X(u&&u.ranks?u.ranks[t]:null);i.class==="-"&&i.school==="-"&&i.township==="-"&&f&&f.ranks&&f.ranks[t]&&(i=X(f.ranks[t]));const b=safeGet(p,`ranks.${t}.school`,"-"),m=H(b,i.school||"-","rank"),T=O(safeGet(p,`ranks.${t}.township`,"-"),y),j=y?H(T,i.township||"-","rank"):"",S=getStudentCountyRankValue(p,t),G=N&&Q(u,t,V)?H(S,i.county||"-","rank"):"";F+=`<tr style="transition:0.2s;" onmouseover="this.style.background='rgba(241,245,249,0.5)'" onmouseout="this.style.background='transparent'">
                    ${l("科目",t,"font-weight:600; color:#475569;")}
                    ${l("成绩（对比）",`${I[t]} ${c}`,"font-weight:bold; color:#334155;")}
                    ${l("班级排名","-","color:#cbd5e1;")}
                    ${l("校级排名",`${b} <span style="font-size:0.9em;">${m}</span>`,"color:#64748b;")}
                    ${l("全镇排名",`${T} <span style="font-size:0.9em;">${j}</span>`,`color:#64748b; ${_}`)}
                    ${l("全县排名",`${N?S:"-"} <span style="font-size:0.9em;">${G}</span>`,`color:#64748b; ${w}`)}
                </tr>`}});const Xt=`
            <style>
        ...
        `,Qt=buildChartNarrative(p),st=buildStudentInsightModel(p,Y),Lt=renderStudentInsightOverview(st),te=renderStudentActionPlan(st),ee=renderStudentSubjectBoard(st),oe=renderStudentRealityNote(st),ne=R?`
        <div class="fluent-card" style="padding:10px 14px; margin-bottom:12px; background:#eef2ff; border:1px solid #c7d2fe; color:#3730a3;">
            <div style="display:flex; align-items:center; gap:8px; font-size:12px; flex-wrap:wrap;">
                ...
                <span>当前对比：${R.prevExamId||"上次"} → ${R.latestExamId||"本次"}</span>
                <span style="color:#6366f1;">来源：${R.title||"云端记录"}</span>
            </div>
        </div>`:"",re=Kt().length>0?`
        ...
        ${Xt}
        <div class="${z?"student-report-shell student-report-shell-full":"student-report-shell"}">
        <div class="report-header" style="border-bottom:none; margin-bottom:10px; text-align:center;">
            ...
            <p style="color:#94a3b8; font-size:12px; margin-top:5px;">生成日期: ${gt}</p>
        </div>
        ${ne}
        ${re}
        ...
        <div class="fluent-card student-report-table-card" style="padding:0; overflow:hidden;">
            <table class="fluent-table" id="tb-query">
                <thead><tr><th style="text-align:left; padding-left:20px;">科目</th><th>成绩 (对比)</th><th>总分班排</th><th>校排</th><th style="${_}">全镇排名</th><th style="${w}">全县排名</th></tr></thead>
                <tbody>${F}</tbody>
            </table>
        </div>
        </div>`,yt=Y;let Ht="";if(yt.length>1){let t="",a=`<th style="text-align:left; padding-left:20px;">考试名称</th><th>${bt}</th><th>校排</th>`;B&&(a+="<th>镇排</th>");for(let c=yt.length-1;c>=0;c--){const i=yt[c],b=i.examFullKey||i.examId,m=getEffectiveCurrentExamId(),T=!!m&&(isExamKeyEquivalentForCompare(b,m)||isExamKeyEquivalentForCompare(i.examId,m)),j=T?"background:rgba(239,246,255,0.7); font-weight:bold;":"",S=i.student||i,G=getComparisonTotalValue(S,xt),lt=Number.isFinite(G)?G.toFixed(1):"-",ct=safeGet(S,"ranks.total.school",i.rankSchool||"-"),dt=safeGet(S,"ranks.total.township",i.rankTown||"-");t+=`<tr style="${j}">
                ${l("考试名称",`${T?"⭐ ":""}${i.examLabel||i.examId||i.examFullKey||"-"}`,"text-align:left; padding-left:20px; color:#475569;")}
                ${l(bt,lt,"color:#2563eb;")}
                ${l("校级排名",ct,"color:#64748b;")}
                ${B?l("全镇排名",dt,"color:#64748b;"):""}
            </tr>`}Ht=`
        ...
        <div style="text-align:center; font-size:11px; color:#cbd5e1; margin-top:20px;">系统自动生成 · 仅供家校沟通参考</div>
        </div>`;return $&&o.html.set(v,zt),zt}function $t(e){var L,B;const r=new Date().toLocaleDateString(),s=RAW_DATA.length,n=wt(e),g=getComparisonTotalSubjects(),D=getComparisonTotalValue(n,g),z=tt("township",g),C=tt("county",g),$=C===null?getStudentCountyRankValue(n,"total")!=="-":C,v=z&&!isCountyDirectStudent(n),ft=v?safeGet(n,"ranks.total.township","-"):safeGet(n,"ranks.total.school","-"),gt=(n==null?void 0:n.school)&&((B=(L=SCHOOLS==null?void 0:SCHOOLS[n.school])==null?void 0:L.students)==null?void 0:B.length)||s||1,R=typeof ft=="number"?((1-ft/(v?s||1:gt))*100).toFixed(0):"-",Y=e.name.charAt(0),W=St(n),k=Object.keys(SCHOOLS).length<=1?"全校":v?"全镇":"本校";let U="";R>=90?U="🌟 卓越之星":R>=75?U="🔥 进步飞速":U="📚 持续努力";let f="";g.forEach(d=>{if(n.scores[d]!==void 0){const h=n.scores[d],A=safeGet(n,`ranks.${d}.school`,"-"),y=v?safeGet(n,`ranks.${d}.township`,"-"):"-",N=getStudentCountyRankValue(n,d),E=[`级#${A}`];v&&E.push(`镇#${y}`),$&&E.push(`县#${N}`),f+=`
                    <div class="insta-comment-row">
                        ...
                        <div>
                            ...
                            <span class="insta-comm-rank">${E.join(" | ")}</span>
                        </div>
                    </div>
                `}});const u=`
        ...
        `,x=(()=>{let d=[],h=[],A=[],y=[];getComparisonTotalSubjects().forEach(q=>{if(e.scores[q]!==void 0){const M=RAW_DATA.map(w=>w.scores[q]).filter(w=>typeof w=="number");if(M.length<2)return;const rt=M.reduce((w,F)=>w+F,0)/M.length,at=M.reduce((w,F)=>w+Math.pow(F-rt,2),0)/M.length,mt=Math.sqrt(at)||1,it=(e.scores[q]-rt)/mt;y.push(it);const _=`${q}`;it>=.8?d.push(_):it<=-.8?h.push(_):A.push(_)}});const E=y.length?Math.max(...y):0,ut=y.length?Math.min(...y):0,nt=E-ut;return{strong:d,weak:h,mid:A,range:nt}})(),l=(d=>d>=2.5?{tag:"⚠️ 严重偏科",color:"#b91c1c",bg:"#fee2e2",text:"不同学科成绩差异极大，存在明显优势科目与薄弱科目，需要针对性调整学习重心，补齐短板。"}:d>=1.2?{tag:"⚖️ 相对均衡",color:"#0369a1",bg:"#e0f2fe",text:"各学科成绩整体较为均衡，个别学科略有波动，保持稳定发挥是关键。"}:{tag:"🌟 结构优秀",color:"#15803d",bg:"#dcfce7",text:"各学科发展极其均衡，无明显短板，心理素质稳定，是冲刺更高目标的理想状态。"})(x.range),X=`
            <div style="margin: 15px 14px 0 14px; background: #fff; border: 1px solid #e2e8f0; border-radius: 8px; padding: 15px;">
                <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:8px;">
                    ...
                    <span style="font-size:12px; background:${l.bg}; color:${l.color}; padding:2px 8px; border-radius:12px; font-weight:bold;">
                        ${l.tag}
                    </span>
                </div>
        ...
        `,et=(d,h)=>!d||d.length===0?`<div style="font-size:12px; color:#ccc; padding:5px;">${h}</div>`:d.map(A=>`<span style="display:inline-block; background:#f1f5f9; color:#334155; font-size:12px; padding:4px 10px; border-radius:4px; margin:0 5px 5px 0;">${A}</span>`).join(""),Q=`
            <div style="margin: 15px 14px 0 14px;">
                ...
                <details open style="margin-bottom:10px; background:#fff; border:1px solid #e2e8f0; border-radius:8px; overflow:hidden;">
                    <summary style="padding:10px 15px; font-size:13px; font-weight:bold; color:#333; cursor:pointer; background:#f8fafc; list-style:none; display:flex; align-items:center;">
                        ...
                        <span style="margin-left:auto; font-size:10px; color:#999;">${x.strong.length}科</span>
                    </summary>
                    <div style="padding:15px;">
                        ${et(x.strong,"暂无明显优势学科，继续加油")}
                    </div>
                </details>

                <!-- 薄弱科目 -->
                <details ${x.weak.length>0?"open":""} style="background:#fff; border:1px solid #e2e8f0; border-radius:8px; overflow:hidden;">
                    <summary style="padding:10px 15px; font-size:13px; font-weight:bold; color:#333; cursor:pointer; background:#fff1f2; list-style:none; display:flex; align-items:center;">
                        ...
                        <span style="margin-left:auto; font-size:10px; color:#dc2626;">${x.weak.length}科</span>
                    </summary>
                    <div style="padding:15px;">
                        ${et(x.weak,"暂无明显短板，保持均衡")}
                    </div>
                </details>
            </div>
        `,ot=`
            <div style="margin: 15px 14px 20px 14px; background: #fffbeb; border: 1px solid #fcd34d; border-radius: 8px; padding: 15px;">
                ...
                <ul style="padding-left:15px; margin:0; font-size:12px; color:#78350f;">
                    ${(()=>{const d=[];if(x.weak.length>0){const h=x.weak.join("、");d.push(`🎯 <strong>精准攻坚：</strong>针对 ${h}，建议每天安排 15 分钟回归课本基础概念，不盲目刷题。`)}if(x.strong.length>0){const h=x.strong.join("、");d.push(`🛡️ <strong>保持自信：</strong>${h} 是孩子的信心来源，请多给予具体表扬，稳住优势。`)}return x.strong.length===0&&x.weak.length===0&&d.push("🚀 <strong>寻找突破：</strong>目前成绩非常稳定。建议选定一门孩子最感兴趣的学科，尝试增加 5% 的投入，培养成优势学科。"),d.push("📅 <strong>习惯养成：</strong>检查孩子是否养成了“先复习，后作业”的习惯。"),d.map(h=>`<li style="margin-bottom:8px; line-height:1.5;">${h}</li>`).join("")})()}
                </ul>
            </div>
        `,O=`
            <div class="insta-visual-area">
                <div style="width:100%; height:100%; display:flex; flex-direction:column; justify-content:center; align-items:center; background:linear-gradient(135deg, #833ab4, #fd1d1d, #fcb045); border-radius:8px; color:white; padding:40px 0;">
                    ...
                    <div style="margin-top:10px; font-size:18px; font-weight:bold; background:rgba(255,255,255,0.2); padding:5px 15px; border-radius:20px;">
                        全校排名: ${safeGet(n,"ranks.total.school","-")}
                    </div>
                    <div style="margin-top:20px; font-size:12px; opacity:0.8;">击败了${k} ${R}% 的考生</div>
                </div>
            </div>
        `,I=W?`
        ...
        `}Object.assign(window,{getTrendBadge:H,renderSingleReportCardHTML:Ct,renderInstagramCard:$t}),window.__REPORT_RENDER_RUNTIME_PATCHED__=!0})();
