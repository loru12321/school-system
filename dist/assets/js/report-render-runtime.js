(()=>{if(typeof window=="undefined"||window.__REPORT_RENDER_RUNTIME_PATCHED__)return;const W=window.CompareSessionState||null,ct=window.ReportSessionState||null,Bt=typeof window.readCloudStudentCompareContextState=="function"?window.readCloudStudentCompareContextState:(()=>W&&typeof W.getCloudStudentCompareContext=="function"&&W.getCloudStudentCompareContext()||null),me=typeof window.readCurrentReportStudentState=="function"?window.readCurrentReportStudentState:(()=>ct&&typeof ct.getCurrentReportStudent=="function"?ct.getCurrentReportStudent()||null:window.CURRENT_REPORT_STUDENT&&typeof window.CURRENT_REPORT_STUDENT=="object"?window.CURRENT_REPORT_STUDENT:null),Pt=typeof window.readDuplicateCompareExamsState=="function"?window.readDuplicateCompareExamsState:(()=>W&&typeof W.getDuplicateCompareExams=="function"?W.getDuplicateCompareExams()||[]:[]),o={signature:"",html:new Map,comparisonStudent:new WeakMap,comparisonStudentByKey:new Map,cloudHint:new WeakMap,cloudHintByKey:new Map,previousRecord:new WeakMap,previousRecordByKey:new Map,examHistory:new WeakMap,examHistoryByKey:new Map,im:new Map,scopeMapRaw:"",scopeMap:{},schoolCandidatesSignature:"",schoolCandidates:[],townshipRank:new Map,countyRank:new Map,countyDirect:new WeakMap};function I(){const e=[window.CURRENT_EXAM_ID||"",window.__RAW_DATA_VERSION||0,Array.isArray(window.RAW_DATA)?window.RAW_DATA.length:0,Array.isArray(window.SUBJECTS)?window.SUBJECTS.join("|"):"",Object.keys(window.SCHOOLS||{}).join("|")].join("::");return o.signature!==e&&(o.signature=e,o.html.clear(),o.comparisonStudent=new WeakMap,o.comparisonStudentByKey.clear(),o.cloudHint=new WeakMap,o.cloudHintByKey.clear(),o.previousRecord=new WeakMap,o.previousRecordByKey.clear(),o.examHistory=new WeakMap,o.examHistoryByKey.clear(),o.townshipRank.clear(),o.countyRank.clear(),o.countyDirect=new WeakMap),e}function G(e){return[String((e==null?void 0:e.school)||"").trim(),String((e==null?void 0:e.class)||"").trim(),String((e==null?void 0:e.name)||"").trim(),String((e==null?void 0:e.id)||(e==null?void 0:e.examNo)||"").trim()].join("::")}function Wt(e,a){if(!Array.isArray(e)||!e.length)return null;for(let s=e.length-1;s>=0;s--){const r=e[s],u=(r==null?void 0:r.examFullKey)||(r==null?void 0:r.examId);if(!a||!isExamKeyEquivalentForCompare(u,a)&&!isExamKeyEquivalentForCompare(r==null?void 0:r.examId,a))return r||null}return null}function dt(e){if(!e||typeof e!="object")return e;if(I(),o.comparisonStudent.has(e))return o.comparisonStudent.get(e);const a=G(e);if(o.comparisonStudentByKey.has(a)){const r=o.comparisonStudentByKey.get(a);return o.comparisonStudent.set(e,r),r}const s=typeof getComparisonStudentView=="function"?getComparisonStudentView(e,RAW_DATA):e;return o.comparisonStudent.set(e,s),o.comparisonStudentByKey.set(a,s),s}function vt(e){if(!e||typeof e!="object")return null;if(I(),o.cloudHint.has(e))return o.cloudHint.get(e);const a=G(e);if(o.cloudHintByKey.has(a)){const r=o.cloudHintByKey.get(a);return o.cloudHint.set(e,r),r}const s=Qt(e);return o.cloudHint.set(e,s||null),o.cloudHintByKey.set(a,s||null),s||null}function Gt(e){if(!e||typeof e!="object")return null;if(I(),o.previousRecord.has(e))return o.previousRecord.get(e);const a=G(e);if(o.previousRecordByKey.has(a)){const r=o.previousRecordByKey.get(a);return o.previousRecord.set(e,r),r}const s=typeof findPreviousRecord=="function"?findPreviousRecord(e):null;return o.previousRecord.set(e,s||null),o.previousRecordByKey.set(a,s||null),s||null}function St(e){if(!e||typeof e!="object")return[];if(I(),o.examHistory.has(e))return o.examHistory.get(e);const a=G(e);if(o.examHistoryByKey.has(a)){const u=o.examHistoryByKey.get(a);return o.examHistory.set(e,u),u}const s=typeof getStudentExamHistory=="function"?getStudentExamHistory(e):[],r=Array.isArray(s)?s:[];return o.examHistory.set(e,r),o.examHistoryByKey.set(a,r),r}function Vt(e,a=null){const s=Array.isArray(a)?a:[],r=s[s.length-1]||{},u=`${I()}::${G(e)}::${s.length}:${r.examFullKey||r.examId||""}`;if(o.im.has(u))return o.im.get(u);const V=window.ReportInsightRuntime.buildStudentInsightModel(e,a,{getCachedComparisonStudentView:dt,getCachedStudentExamHistory:St});return o.im.set(u,V),V}function Ut(e){return window.ReportInsightRuntime.renderStudentInsightOverview(e)}function qt(e){return window.ReportInsightRuntime.renderStudentActionPlan(e)}function Jt(e){return window.ReportInsightRuntime.renderStudentSubjectBoard(e)}function Yt(e){return window.ReportInsightRuntime.renderStudentRealityNote(e)}function nt(e,a){const s=`${I()}::${e}::${(a||[]).join("|")}`,r=e==="township"?o.townshipRank:o.countyRank;if(r.has(s))return r.get(s);const u=e==="township"?typeof hasStudentTownshipRankData=="function"?hasStudentTownshipRankData(RAW_DATA,a):Object.keys(SCHOOLS).length>1:typeof hasStudentCountyRankData=="function"?hasStudentCountyRankData(RAW_DATA,a):null;return r.set(s,u),u}function Zt(){let e="";try{e=localStorage.getItem("COUNTY_ANALYSIS_SCOPE_V1")||""}catch(a){e=""}if(o.scopeMapRaw!==e){o.scopeMapRaw=e;try{o.scopeMap=e?JSON.parse(e):{}}catch(a){o.scopeMap={}}}return o.scopeMap}function Xt(){const e=I();return o.schoolCandidatesSignature===e||(o.schoolCandidatesSignature=e,o.schoolCandidates=Array.from(new Set([...Object.keys(SCHOOLS||{}),...(RAW_DATA||[]).map(a=>a==null?void 0:a.school)].map(a=>String(a||"").trim()).filter(Boolean)))),o.schoolCandidates}function Qt(e){return typeof getCloudCompareHint=="function"?getCloudCompareHint(e):isCloudContextMatchStudent(e)||isCloudContextLikelyCurrentTarget(e)?Bt():null}function $(e,a,s="score"){return window.ReportInsightRuntime.getTrendBadge(e,a,s)}function Ct(e,a,s={}){var Et,Nt,Mt,It,_t,Kt,Ft,Ot;if(navigator.userAgent.toLowerCase().includes("android")&&window.innerWidth<=768&&!window.Chart)return console.warn("⚠️ Android Canvas 异常，强制切换 PC 模式"),Ct(e,"PC",s);const pt=window.innerWidth<=768,Q=a==="FULL",rt=a==="A4"||a==="PC"||Q,z=rt,U=z?`${I()}::${G(e)}::${a||""}::${new Date().toLocaleDateString()}`:"";if(z&&o.html.has(U))return o.html.get(U);if(!rt&&pt||a==="IG"){const t=Rt(e);return setTimeout(()=>{typeof renderIGCharts=="function"&&renderIGCharts(e)},50),t}const $t=RAW_DATA.length,Tt=new Date().toLocaleDateString(),d=dt(e),D=vt(d),_=Array.isArray(s.reportExamHistory)?s.reportExamHistory:St(d),Ht=getEffectiveCurrentExamId(),j=Wt(_,Ht),T=j?j.student||j:null,at=!!(T&&T.scores&&T.ranks),g=(D==null?void 0:D.previousRecord)||(at?null:Gt(d)),m=T&&T.scores?T:g,x=((Et=m==null?void 0:m.ranks)==null?void 0:Et.total)||{},At=t=>typeof t=="number"&&Number.isFinite(t)?t:t&&typeof t=="object"&&typeof t.score=="number"&&Number.isFinite(t.score)?t.score:"-",q=t=>String(t!=null?t:"").replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),p=(t,n,l="")=>`<td data-label="${q(t)}"${l?` style="${l}"`:""}>${n}</td>`,J=t=>{var n,l,i,w,f,S,R,b;return{class:(l=(n=t==null?void 0:t.class)!=null?n:t==null?void 0:t.rankClass)!=null?l:"-",school:(w=(i=t==null?void 0:t.school)!=null?i:t==null?void 0:t.rankSchool)!=null?w:"-",township:(S=(f=t==null?void 0:t.township)!=null?f:t==null?void 0:t.rankTown)!=null?S:"-",county:(b=(R=t==null?void 0:t.county)!=null?R:t==null?void 0:t.rankCounty)!=null?b:"-"}},Y=(t,n,l="total",i="county")=>{var S,R,b,k,E,N,M,P;const w=l==="total"?((S=n==null?void 0:n.ranks)==null?void 0:S.total)||n||t||{}:((R=n==null?void 0:n.ranks)==null?void 0:R[l])||((b=n==null?void 0:n.subjectRanks)==null?void 0:b[l])||((k=t==null?void 0:t.subjectRanks)==null?void 0:k[l])||{},f=J(w)[i];return f!=null&&f!==""?f:i==="county"&&l==="total"&&(P=(M=(N=(E=n==null?void 0:n.rankCounty)!=null?E:n==null?void 0:n.countyRank)!=null?N:t==null?void 0:t.rankCounty)!=null?M:t==null?void 0:t.countyRank)!=null?P:"-"},kt=(t,n=null)=>{const l=String((t==null?void 0:t.examFullKey)||(t==null?void 0:t.examId)||(n==null?void 0:n._sourceExam)||(n==null?void 0:n.examFullKey)||(n==null?void 0:n.examId)||"").trim();if(!l)return null;const i=Zt();return(i==null?void 0:i[l])||null},L=(t,n="total",l=null)=>{var f,S,R,b,k,E,N,M,P;if(!t||typeof t!="object")return!1;const i=n==="total"?(b=(R=(S=(f=t==null?void 0:t.ranks)==null?void 0:f.total)==null?void 0:S.county)!=null?R:t==null?void 0:t.rankCounty)!=null?b:t==null?void 0:t.countyRank:(P=(E=(k=t==null?void 0:t.ranks)==null?void 0:k[n])==null?void 0:E.county)!=null?P:(M=(N=t==null?void 0:t.subjectRanks)==null?void 0:N[n])==null?void 0:M.county;if(i!=null&&i!==""&&i!=="-")return!0;const w=kt(l,t);return!w||w.includesCounty!==!0?!1:i!=null&&i!==""},ft=t=>{var i;const n=String((i=t==null?void 0:t.class)!=null?i:"").trim(),l=typeof normalizeClass=="function"?normalizeClass(n):n;return!l||l==="-"?!1:!/^(?:无|未分班|无班级|暂无|undefined|null|nan)$/i.test(l)},ut=t=>{if(typeof isCountyDirectStudentForRank=="function")return isCountyDirectStudentForRank(t);const n=String((t==null?void 0:t.school)||"").trim();if(!n||typeof getCountyDirectSchoolNames!="function"||typeof getTownshipManagedSchoolNames!="function")return!1;if(o.countyDirect.has(t))return o.countyDirect.get(t);const l=Xt();if(!getTownshipManagedSchoolNames(l).length)return o.countyDirect.set(t,!1),!1;const w=getCountyDirectSchoolNames(l).some(f=>f===n||typeof areSchoolNamesEquivalent=="function"&&areSchoolNamesEquivalent(f,n)||typeof areSchoolNamesMatched=="function"&&areSchoolNamesMatched(f,n,!0));return o.countyDirect.set(t,w),w},H=(t,n=!0)=>n?t==null||t===""?"-":t:"-",Z=d&&typeof d=="object"&&d.scores&&typeof d.scores=="object"?d.scores:{},c=[...new Set(SUBJECTS)],h=((Nt=window.RankingDataService)==null?void 0:Nt.buildStudentRankSnapshot(RAW_DATA,d,c))||null,y=(t,n)=>{var i;const l=safeGet(d,`ranks.${t}.${n}`,"-");return l!=null&&l!==""&&l!=="-"&&l!=="—"?l:(i=h==null?void 0:h.getRank(d,t,n,"-"))!=null?i:"-"},C=nt("township",c),tt=nt("county",c),F=tt===null?getStudentCountyRankValue(d,"total")!=="-":tt,O=ft(d),B=C&&!ut(d),v=F,K=H(y("total","township"),B),it=H((It=(Mt=x.township)!=null?Mt:g==null?void 0:g.townRank)!=null?It:"-",B),st=H(y("total","class"),O),gt=H((Kt=(_t=x.class)!=null?_t:g==null?void 0:g.classRank)!=null?Kt:"-",O),X=y("total","school"),et=(Ot=(Ft=x.school)!=null?Ft:g==null?void 0:g.schoolRank)!=null?Ot:"-",A=H(y("total","county"),v),ot=L(m,"total",j)?Y(j,m,"total","county"):"-",mt=C?"":"display:none !important;",xt=v?"":"display:none !important;",ht=getComparisonTotalSubjects(),bt=getComparisonTotalValue(d,ht),yt=CONFIG.name==="9年级"&&ht.length?"五科总分":CONFIG.label,Lt=m?recalcPrevTotal(m):"-",te=$(bt,Lt,"score"),ee=O?$(st,gt,"rank"):"",oe=$(X,et,"rank"),ne=B?$(K,it,"rank"):"",re=v?$(A,ot,"rank"):"";let zt=`<tr style="background:rgba(239,246,255,0.7); backdrop-filter:blur(4px); border-bottom:2px solid #fff;">
            ${p("科目",`🏆 ${yt}`,"font-weight:bold; color:#1e3a8a;")}
            ${p("成绩（对比）",`${Number.isFinite(bt)?bt.toFixed(2):"-"} ${te}`,"font-weight:800; font-size:16px; color:#1e40af;")}
            ${p("班级排名",`${st} ${ee}`,"font-weight:bold; color:#334155;")}
            ${p("校级排名",`${X} ${oe}`,"font-weight:bold; color:#334155;")}
            ${p("全镇排名",`${K} ${ne}`,`${mt} font-weight:bold; color:#334155;`)}
            ${p("全县排名",`${v?A:"-"} ${re}`,`${xt} font-weight:bold; color:#334155;`)}
        </tr>`;[...new Set(SUBJECTS)].forEach(t=>{if(Z[t]!==void 0){const n=m&&m.scores?At(m.scores[t]):"-",l=$(Z[t],n,"score");let i=J(m&&m.ranks?m.ranks[t]:null);i.class==="-"&&i.school==="-"&&i.township==="-"&&g&&g.ranks&&g.ranks[t]&&(i=J(g.ranks[t]));const w=H(y(t,"class"),O),f=O?$(w,i.class||"-","rank"):"",S=y(t,"school"),R=$(S,i.school||"-","rank"),b=H(y(t,"township"),B),k=B?$(b,i.township||"-","rank"):"",E=H(y(t,"county"),v),N=Y(j,m,t,"county"),M=v&&L(m,t,j)?$(E,N||"-","rank"):"";zt+=`<tr style="transition:0.2s;" onmouseover="this.style.background='rgba(241,245,249,0.5)'" onmouseout="this.style.background='transparent'">
                    ${p("科目",t,"font-weight:600; color:#475569;")}
                    ${p("成绩（对比）",`${Z[t]}（上次 ${n}）${l}`,"font-weight:bold;color:#334155;")}
                    ${p("班级排名",`${w} ${f}`,"color:#64748b;")}
                    ${p("校级排名",`${S} <span style="font-size:0.9em;">${R}</span>`,"color:#64748b;")}
                    ${p("全镇排名",`${b} <span style="font-size:0.9em;">${k}</span>`,`color:#64748b; ${mt}`)}
                    ${p("全县排名",`${v?E:"-"} <span style="font-size:0.9em;">${M}</span>`,`color:#64748b; ${xt}`)}
                </tr>`}});const ae=`
            <style>
        ...
        `,ie=typeof buildChartNarrative=="function"?buildChartNarrative(d):"",lt=Vt(d,_),se=Ut(lt),le=qt(lt),ce=Jt(lt),de=Yt(lt),pe=D?`
        ...
        <div class="fluent-card student-report-table-card" style="padding:0; overflow:hidden;">
            <table class="fluent-table" id="tb-query">
                <thead><tr><th style="text-align:left; padding-left:20px;">科目</th><th>成绩 (对比)</th><th>总分班排</th><th>校排</th><th style="${mt}">全镇排名</th><th style="${xt}">全县排名</th></tr></thead>
                <tbody>${zt}</tbody>
            </table>
        </div>
        </div>`,wt=_;let Dt="";if(wt.length>1){let t="",n=`<th style="text-align:left; padding-left:20px;">考试名称</th><th>${yt}</th><th>校排</th>`;C&&(n+="<th>镇排</th>"),v&&(n+="<th>县排</th>");for(let l=wt.length-1;l>=0;l--){const i=wt[l],w=i.examFullKey||i.examId,f=getEffectiveCurrentExamId(),S=!!f&&(isExamKeyEquivalentForCompare(w,f)||isExamKeyEquivalentForCompare(i.examId,f)),R=S?"background:rgba(239,246,255,0.7); font-weight:bold;":"",b=i.student||i,k=getComparisonTotalValue(b,ht),N=Number.isFinite(k)?k.toFixed(1):"-",M=safeGet(b,"ranks.total.school",i.rankSchool||"-"),P=safeGet(b,"ranks.total.township",i.rankTown||"-"),ge=Y(i,b,"total","county");t+=`<tr style="${R}">
                ${p("考试名称",`${S?"⭐ ":""}${i.examLabel||i.examId||i.examFullKey||"-"}`,"text-align:left; padding-left:20px; color:#475569;")}
                ${p(yt,N,"color:#2563eb;")}
                ${p("校级排名",M,"color:#64748b;")}
                ${C?p("全镇排名",P,"color:#64748b;"):""}
                ${v?p("全县排名",ge,"color:#64748b;"):""}
            </tr>`}Dt=`
        ...
        <div style="text-align:center; font-size:11px; color:#cbd5e1; margin-top:20px;">系统自动生成 · 仅供家校沟通参考</div>
        </div>`;return z&&o.html.set(U,jt),jt}function Rt(e){var H,Z;const a=new Date().toLocaleDateString(),s=RAW_DATA.length,r=dt(e),u=getComparisonTotalSubjects(),V=getComparisonTotalValue(r,u),pt=nt("township",u),Q=nt("county",u),rt=Q===null?getStudentCountyRankValue(r,"total")!=="-":Q,z=pt&&!isCountyDirectStudent(r),U=z?safeGet(r,"ranks.total.township","-"):safeGet(r,"ranks.total.school","-"),$t=(r==null?void 0:r.school)&&((Z=(H=SCHOOLS==null?void 0:SCHOOLS[r.school])==null?void 0:H.students)==null?void 0:Z.length)||s||1,d=typeof U=="number"?((1-U/(z?s||1:$t))*100).toFixed(0):"-",D=e.name.charAt(0),_=vt(r),j=Object.keys(SCHOOLS).length<=1?"全校":z?"全镇":"本校";let T="";d>=90?T="🌟 卓越之星":d>=75?T="🔥 进步飞速":T="📚 持续努力";let at="";u.forEach(c=>{if(r.scores[c]!==void 0){const h=r.scores[c],y=safeGet(r,`ranks.${c}.school`,"-"),C=z?safeGet(r,`ranks.${c}.township`,"-"):"-",tt=getStudentCountyRankValue(r,c),F=[`级#${y}`];z&&F.push(`镇#${C}`),rt&&F.push(`县#${tt}`),at+=`
                    <div class="insta-comment-row">
                        ...
                        <div>
                            ...
                            <span class="insta-comm-rank">${F.join(" | ")}</span>
                        </div>
                    </div>
                `}});const g=`
        ...
        `,x=(()=>{let c=[],h=[],y=[],C=[];getComparisonTotalSubjects().forEach(v=>{if(e.scores[v]!==void 0){const K=RAW_DATA.map(A=>A.scores[v]).filter(A=>typeof A=="number");if(K.length<2)return;const it=K.reduce((A,ot)=>A+ot,0)/K.length,st=K.reduce((A,ot)=>A+Math.pow(ot-it,2),0)/K.length,gt=Math.sqrt(st)||1,X=(e.scores[v]-it)/gt;C.push(X);const et=`${v}`;X>=.8?c.push(et):X<=-.8?h.push(et):y.push(et)}});const F=C.length?Math.max(...C):0,O=C.length?Math.min(...C):0,B=F-O;return{strong:c,weak:h,mid:y,range:B}})(),q=(c=>c>=2.5?{tag:"⚠️ 严重偏科",color:"#b91c1c",bg:"#fee2e2",text:"不同学科成绩差异极大，存在明显优势科目与薄弱科目，需要针对性调整学习重心，补齐短板。"}:c>=1.2?{tag:"⚖️ 相对均衡",color:"#0369a1",bg:"#e0f2fe",text:"各学科成绩整体较为均衡，个别学科略有波动，保持稳定发挥是关键。"}:{tag:"🌟 结构优秀",color:"#15803d",bg:"#dcfce7",text:"各学科发展极其均衡，无明显短板，心理素质稳定，是冲刺更高目标的理想状态。"})(x.range),p=`
            <div style="margin: 15px 14px 0 14px; background: #fff; border: 1px solid #e2e8f0; border-radius: 8px; padding: 15px;">
                <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:8px;">
                    ...
                    <span style="font-size:12px; background:${q.bg}; color:${q.color}; padding:2px 8px; border-radius:12px; font-weight:bold;">
                        ${q.tag}
                    </span>
                </div>
        ...
        `,J=(c,h)=>!c||c.length===0?`<div style="font-size:12px; color:#ccc; padding:5px;">${h}</div>`:c.map(y=>`<span style="display:inline-block; background:#f1f5f9; color:#334155; font-size:12px; padding:4px 10px; border-radius:4px; margin:0 5px 5px 0;">${y}</span>`).join(""),Y=`
        ...
        `,L=`
            <div style="margin: 15px 14px 20px 14px; background: #fffbeb; border: 1px solid #fcd34d; border-radius: 8px; padding: 15px;">
                ...
                <ul style="padding-left:15px; margin:0; font-size:12px; color:#78350f;">
                    ${(()=>{const c=[];if(x.weak.length>0){const h=x.weak.join("、");c.push(`🎯 <strong>精准攻坚：</strong>针对 ${h}，建议每天安排 15 分钟回归课本基础概念，不盲目刷题。`)}if(x.strong.length>0){const h=x.strong.join("、");c.push(`🛡️ <strong>保持自信：</strong>${h} 是孩子的信心来源，请多给予具体表扬，稳住优势。`)}return x.strong.length===0&&x.weak.length===0&&c.push("🚀 <strong>寻找突破：</strong>目前成绩非常稳定。建议选定一门孩子最感兴趣的学科，尝试增加 5% 的投入，培养成优势学科。"),c.push("📅 <strong>习惯养成：</strong>检查孩子是否养成了“先复习，后作业”的习惯。"),c.map(h=>`<li style="margin-bottom:8px; line-height:1.5;">${h}</li>`).join("")})()}
                </ul>
            </div>
        `,ft=`
        ...
        `}Object.assign(window,{getTrendBadge:$,renderSingleReportCardHTML:Ct,renderInstagramCard:Rt}),window.__REPORT_RENDER_RUNTIME_PATCHED__=!0})();
