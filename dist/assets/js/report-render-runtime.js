(()=>{if(typeof window=="undefined"||window.__REPORT_RENDER_RUNTIME_PATCHED__)return;const q=window.CompareSessionState||null,ft=window.ReportSessionState||null,Kt=typeof window.readCloudStudentCompareContextState=="function"?window.readCloudStudentCompareContextState:(()=>q&&typeof q.getCloudStudentCompareContext=="function"&&q.getCloudStudentCompareContext()||null),le=typeof window.readCurrentReportStudentState=="function"?window.readCurrentReportStudentState:(()=>ft&&typeof ft.getCurrentReportStudent=="function"?ft.getCurrentReportStudent()||null:window.CURRENT_REPORT_STUDENT&&typeof window.CURRENT_REPORT_STUDENT=="object"?window.CURRENT_REPORT_STUDENT:null),Ot=typeof window.readDuplicateCompareExamsState=="function"?window.readDuplicateCompareExamsState:(()=>q&&typeof q.getDuplicateCompareExams=="function"?q.getDuplicateCompareExams()||[]:[]),o={signature:"",html:new Map,comparisonStudent:new WeakMap,comparisonStudentByKey:new Map,cloudHint:new WeakMap,cloudHintByKey:new Map,previousRecord:new WeakMap,previousRecordByKey:new Map,examHistory:new WeakMap,examHistoryByKey:new Map,scopeMapRaw:"",scopeMap:{},schoolCandidatesSignature:"",schoolCandidates:[],townshipRank:new Map,countyRank:new Map,countyDirect:new WeakMap};function P(){const e=[window.CURRENT_EXAM_ID||"",window.__RAW_DATA_VERSION||0,Array.isArray(window.RAW_DATA)?window.RAW_DATA.length:0,Array.isArray(window.SUBJECTS)?window.SUBJECTS.join("|"):"",Object.keys(window.SCHOOLS||{}).join("|")].join("::");return o.signature!==e&&(o.signature=e,o.html.clear(),o.comparisonStudent=new WeakMap,o.comparisonStudentByKey.clear(),o.cloudHint=new WeakMap,o.cloudHintByKey.clear(),o.previousRecord=new WeakMap,o.previousRecordByKey.clear(),o.examHistory=new WeakMap,o.examHistoryByKey.clear(),o.townshipRank.clear(),o.countyRank.clear(),o.countyDirect=new WeakMap),e}function et(e){return[String((e==null?void 0:e.school)||"").trim(),String((e==null?void 0:e.class)||"").trim(),String((e==null?void 0:e.name)||"").trim(),String((e==null?void 0:e.id)||(e==null?void 0:e.examNo)||"").trim()].join("::")}function It(e,a){if(!Array.isArray(e)||!e.length)return null;for(let s=e.length-1;s>=0;s--){const r=e[s],u=(r==null?void 0:r.examFullKey)||(r==null?void 0:r.examId);if(!a||!isExamKeyEquivalentForCompare(u,a)&&!isExamKeyEquivalentForCompare(r==null?void 0:r.examId,a))return r||null}return null}function vt(e){if(!e||typeof e!="object")return e;if(P(),o.comparisonStudent.has(e))return o.comparisonStudent.get(e);const a=et(e);if(o.comparisonStudentByKey.has(a)){const r=o.comparisonStudentByKey.get(a);return o.comparisonStudent.set(e,r),r}const s=typeof getComparisonStudentView=="function"?getComparisonStudentView(e,RAW_DATA):e;return o.comparisonStudent.set(e,s),o.comparisonStudentByKey.set(a,s),s}function wt(e){if(!e||typeof e!="object")return null;if(P(),o.cloudHint.has(e))return o.cloudHint.get(e);const a=et(e);if(o.cloudHintByKey.has(a)){const r=o.cloudHintByKey.get(a);return o.cloudHint.set(e,r),r}const s=Vt(e);return o.cloudHint.set(e,s||null),o.cloudHintByKey.set(a,s||null),s||null}function Bt(e){if(!e||typeof e!="object")return null;if(P(),o.previousRecord.has(e))return o.previousRecord.get(e);const a=et(e);if(o.previousRecordByKey.has(a)){const r=o.previousRecordByKey.get(a);return o.previousRecord.set(e,r),r}const s=typeof findPreviousRecord=="function"?findPreviousRecord(e):null;return o.previousRecord.set(e,s||null),o.previousRecordByKey.set(a,s||null),s||null}function Gt(e){if(!e||typeof e!="object")return[];if(P(),o.examHistory.has(e))return o.examHistory.get(e);const a=et(e);if(o.examHistoryByKey.has(a)){const u=o.examHistoryByKey.get(a);return o.examHistory.set(e,u),u}const s=typeof getStudentExamHistory=="function"?getStudentExamHistory(e):[],r=Array.isArray(s)?s:[];return o.examHistory.set(e,r),o.examHistoryByKey.set(a,r),r}function rt(e,a){const s=`${P()}::${e}::${(a||[]).join("|")}`,r=e==="township"?o.townshipRank:o.countyRank;if(r.has(s))return r.get(s);const u=e==="township"?typeof hasStudentTownshipRankData=="function"?hasStudentTownshipRankData(RAW_DATA,a):Object.keys(SCHOOLS).length>1:typeof hasStudentCountyRankData=="function"?hasStudentCountyRankData(RAW_DATA,a):null;return r.set(s,u),u}function Pt(){let e="";try{e=localStorage.getItem("COUNTY_ANALYSIS_SCOPE_V1")||""}catch(a){e=""}if(o.scopeMapRaw!==e){o.scopeMapRaw=e;try{o.scopeMap=e?JSON.parse(e):{}}catch(a){o.scopeMap={}}}return o.scopeMap}function Wt(){const e=P();return o.schoolCandidatesSignature===e||(o.schoolCandidatesSignature=e,o.schoolCandidates=Array.from(new Set([...Object.keys(SCHOOLS||{}),...(RAW_DATA||[]).map(a=>a==null?void 0:a.school)].map(a=>String(a||"").trim()).filter(Boolean)))),o.schoolCandidates}function Vt(e){return typeof getCloudCompareHint=="function"?getCloudCompareHint(e):isCloudContextMatchStudent(e)||isCloudContextLikelyCurrentTarget(e)?Kt():null}function T(e,a,s="score"){if(a==null||a==="-"||a==="")return"";const r=parseFloat(e),u=parseFloat(a);if(isNaN(r)||isNaN(u))return"";const M=r-u;if(Math.abs(M)<.01)return'<span style="color:#94a3b8; font-size:11px; margin-left:4px; font-weight:normal;">(持平)</span>';let z="",S="",H="";s==="score"?M>0?(z="#15803d",H="#dcfce7",S="▲"):(z="#b91c1c",H="#fee2e2",S="▼"):M<0?(z="#15803d",H="#dcfce7",S="▲"):(z="#b91c1c",H="#fee2e2",S="▼");const w=Math.abs(M);return`<span style="display:inline-flex; align-items:center; background:${H}; color:${z}; padding:1px 6px; border-radius:10px; font-size:11px; font-weight:bold; margin-left:5px; vertical-align:middle;">
            ${S} ${s==="score"?w.toFixed(1):w}
        </span>`}function Ct(e,a,s={}){var Dt,jt,Nt,Et,Mt,_t,Ft;if(navigator.userAgent.toLowerCase().includes("android")&&window.innerWidth<=768&&!window.Chart)return console.warn("⚠️ Android Canvas 异常，强制切换 PC 模式"),Ct(e,"PC",s);const z=window.innerWidth<=768,S=a==="FULL",H=a==="A4"||a==="PC"||S,w=H,J=w?`${P()}::${et(e)}::${a||""}::${new Date().toLocaleDateString()}`:"";if(w&&o.html.has(J))return o.html.get(J);if(!H&&z||a==="IG"){const t=St(e);return setTimeout(()=>{typeof renderIGCharts=="function"&&renderIGCharts(e)},50),t}const $t=RAW_DATA.length,Rt=new Date().toLocaleDateString(),d=vt(e),A=wt(d),_=Array.isArray(s.reportExamHistory)?s.reportExamHistory:Gt(d),Tt=getEffectiveCurrentExamId(),D=It(_,Tt),$=D?D.student||D:null,at=!!($&&$.scores&&$.ranks),m=(A==null?void 0:A.previousRecord)||(at?null:Bt(d)),x=$&&$.scores?$:m,h=((Dt=x==null?void 0:x.ranks)==null?void 0:Dt.total)||{},Ht=t=>typeof t=="number"&&Number.isFinite(t)?t:t&&typeof t=="object"&&typeof t.score=="number"&&Number.isFinite(t.score)?t.score:"-",Y=t=>String(t!=null?t:"").replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),c=(t,n,l="")=>`<td data-label="${Y(t)}"${l?` style="${l}"`:""}>${n}</td>`,Z=t=>{var n,l,i,y,f,v,C,b;return{class:(l=(n=t==null?void 0:t.class)!=null?n:t==null?void 0:t.rankClass)!=null?l:"-",school:(y=(i=t==null?void 0:t.school)!=null?i:t==null?void 0:t.rankSchool)!=null?y:"-",township:(v=(f=t==null?void 0:t.township)!=null?f:t==null?void 0:t.rankTown)!=null?v:"-",county:(b=(C=t==null?void 0:t.county)!=null?C:t==null?void 0:t.rankCounty)!=null?b:"-"}},X=(t,n,l="total",i="county")=>{var v,C,b,k,G,W,V,U;const y=l==="total"?((v=n==null?void 0:n.ranks)==null?void 0:v.total)||n||t||{}:((C=n==null?void 0:n.ranks)==null?void 0:C[l])||((b=n==null?void 0:n.subjectRanks)==null?void 0:b[l])||((k=t==null?void 0:t.subjectRanks)==null?void 0:k[l])||{},f=Z(y)[i];return f!=null&&f!==""?f:i==="county"&&l==="total"&&(U=(V=(W=(G=n==null?void 0:n.rankCounty)!=null?G:n==null?void 0:n.countyRank)!=null?W:t==null?void 0:t.rankCounty)!=null?V:t==null?void 0:t.countyRank)!=null?U:"-"},kt=(t,n=null)=>{const l=String((t==null?void 0:t.examFullKey)||(t==null?void 0:t.examId)||(n==null?void 0:n._sourceExam)||(n==null?void 0:n.examFullKey)||(n==null?void 0:n.examId)||"").trim();if(!l)return null;const i=Pt();return(i==null?void 0:i[l])||null},ot=(t,n="total",l=null)=>{var f,v,C,b,k,G,W,V,U;if(!t||typeof t!="object")return!1;const i=n==="total"?(b=(C=(v=(f=t==null?void 0:t.ranks)==null?void 0:f.total)==null?void 0:v.county)!=null?C:t==null?void 0:t.rankCounty)!=null?b:t==null?void 0:t.countyRank:(U=(G=(k=t==null?void 0:t.ranks)==null?void 0:k[n])==null?void 0:G.county)!=null?U:(V=(W=t==null?void 0:t.subjectRanks)==null?void 0:W[n])==null?void 0:V.county;if(i!=null&&i!==""&&i!=="-")return!0;const y=kt(l,t);return!y||y.includesCounty!==!0?!1:i!=null&&i!==""},gt=t=>{var i;const n=String((i=t==null?void 0:t.class)!=null?i:"").trim(),l=typeof normalizeClass=="function"?normalizeClass(n):n;return!l||l==="-"?!1:!/^(?:无|未分班|无班级|暂无|undefined|null|nan)$/i.test(l)},ut=t=>{if(typeof isCountyDirectStudentForRank=="function")return isCountyDirectStudentForRank(t);const n=String((t==null?void 0:t.school)||"").trim();if(!n||typeof getCountyDirectSchoolNames!="function"||typeof getTownshipManagedSchoolNames!="function")return!1;if(o.countyDirect.has(t))return o.countyDirect.get(t);const l=Wt();if(!getTownshipManagedSchoolNames(l).length)return o.countyDirect.set(t,!1),!1;const y=getCountyDirectSchoolNames(l).some(f=>f===n||typeof areSchoolNamesEquivalent=="function"&&areSchoolNamesEquivalent(f,n)||typeof areSchoolNamesMatched=="function"&&areSchoolNamesMatched(f,n,!0));return o.countyDirect.set(t,y),y},F=(t,n=!0)=>n?t==null||t===""?"-":t:"-",K=d&&typeof d=="object"&&d.scores&&typeof d.scores=="object"?d.scores:{},p=[...new Set(SUBJECTS)],g=rt("township",p),j=rt("county",p),N=j===null?getStudentCountyRankValue(d,"total")!=="-":j,Q=gt(d),R=g&&!ut(d),E=N,it=F(safeGet(d,"ranks.total.township","-"),R),L=F((Nt=(jt=h.township)!=null?jt:m==null?void 0:m.townRank)!=null?Nt:"-",R),O=F(safeGet(d,"ranks.total.class","-"),Q),st=F((Mt=(Et=h.class)!=null?Et:m==null?void 0:m.classRank)!=null?Mt:"-",Q),lt=safeGet(d,"ranks.total.school","-"),mt=(Ft=(_t=h.school)!=null?_t:m==null?void 0:m.schoolRank)!=null?Ft:"-",tt=getStudentCountyRankValue(d,"total"),nt=ot(x,"total",D)?X(D,x,"total","county"):"-",I=Object.keys(SCHOOLS).length<=1,B=g?"":"display:none !important;",ct=E?"":"display:none !important;";let dt="";if(CONFIG.name==="9年级"){let t=0,n=0;["语文","数学","英语","物理","化学"].forEach(l=>{K[l]!==void 0&&(t+=K[l],n++)}),n>0&&(dt+=`<tr style="background:rgba(248,250,252,0.5);">
                    ...
                    ${c("全镇排名","-",B)}
                    ${c("全县排名","-",ct)}
                </tr>`)}const xt=getComparisonTotalSubjects(),ht=getComparisonTotalValue(d,xt),bt=CONFIG.name==="9年级"&&xt.length?"五科总分":CONFIG.label,Ut=x?recalcPrevTotal(x):"-",qt=T(ht,Ut,"score"),Jt=Q?T(O,st,"rank"):"",Yt=T(lt,mt,"rank"),Zt=R?T(it,L,"rank"):"",Xt=E?T(tt,nt,"rank"):"";dt+=`<tr style="background:rgba(239,246,255,0.7); backdrop-filter:blur(4px); border-bottom:2px solid #fff;">
            ${c("科目",`🏆 ${bt}`,"font-weight:bold; color:#1e3a8a;")}
            ${c("成绩（对比）",`${Number.isFinite(ht)?ht.toFixed(2):"-"} ${qt}`,"font-weight:800; font-size:16px; color:#1e40af;")}
            ${c("班级排名",`${O} ${Jt}`,"font-weight:bold; color:#334155;")}
            ${c("校级排名",`${lt} ${Yt}`,"font-weight:bold; color:#334155;")}
            ${c("全镇排名",`${it} ${Zt}`,`${B} font-weight:bold; color:#334155;`)}
            ${c("全县排名",`${E?tt:"-"} ${Xt}`,`${ct} font-weight:bold; color:#334155;`)}
        </tr>`,[...new Set(SUBJECTS)].forEach(t=>{if(K[t]!==void 0){const n=x&&x.scores?Ht(x.scores[t]):"-",l=T(K[t],n,"score");let i=Z(x&&x.ranks?x.ranks[t]:null);i.class==="-"&&i.school==="-"&&i.township==="-"&&m&&m.ranks&&m.ranks[t]&&(i=Z(m.ranks[t]));const y=safeGet(d,`ranks.${t}.school`,"-"),f=T(y,i.school||"-","rank"),v=F(safeGet(d,`ranks.${t}.township`,"-"),R),C=R?T(v,i.township||"-","rank"):"",b=getStudentCountyRankValue(d,t),k=X(D,x,t,"county"),G=E&&ot(x,t,D)?T(b,k||"-","rank"):"";dt+=`<tr style="transition:0.2s;" onmouseover="this.style.background='rgba(241,245,249,0.5)'" onmouseout="this.style.background='transparent'">
                    ${c("科目",t,"font-weight:600; color:#475569;")}
                    ${c("成绩（对比）",`${K[t]} ${l}`,"font-weight:bold; color:#334155;")}
                    ${c("班级排名","-","color:#cbd5e1;")}
                    ${c("校级排名",`${y} <span style="font-size:0.9em;">${f}</span>`,"color:#64748b;")}
                    ${c("全镇排名",`${v} <span style="font-size:0.9em;">${C}</span>`,`color:#64748b; ${B}`)}
                    ${c("全县排名",`${E?b:"-"} <span style="font-size:0.9em;">${G}</span>`,`color:#64748b; ${ct}`)}
                </tr>`}});const Qt=`
            <style>
        ...
        `,Lt=typeof buildChartNarrative=="function"?buildChartNarrative(d):"",pt=buildStudentInsightModel(d,_),te=renderStudentInsightOverview(pt),ee=renderStudentActionPlan(pt),oe=renderStudentSubjectBoard(pt),ne=renderStudentRealityNote(pt),re=A?`
        <div class="fluent-card" style="padding:10px 14px; margin-bottom:12px; background:#eef2ff; border:1px solid #c7d2fe; color:#3730a3;">
            <div style="display:flex; align-items:center; gap:8px; font-size:12px; flex-wrap:wrap;">
                ...
                <span>当前对比：${A.prevExamId||"上次"} → ${A.latestExamId||"本次"}</span>
                <span style="color:#6366f1;">来源：${A.title||"云端记录"}</span>
            </div>
        </div>`:"",ae=Ot().length>0?`
        ...
        ${Qt}
        <div class="${S?"student-report-shell student-report-shell-full":"student-report-shell"}">
        <div class="report-header" style="border-bottom:none; margin-bottom:10px; text-align:center;">
            ...
            <p style="color:#94a3b8; font-size:12px; margin-top:5px;">生成日期: ${Rt}</p>
        </div>
        ${re}
        ${ae}
        ...
        <div class="fluent-card student-report-table-card" style="padding:0; overflow:hidden;">
            <table class="fluent-table" id="tb-query">
                <thead><tr><th style="text-align:left; padding-left:20px;">科目</th><th>成绩 (对比)</th><th>总分班排</th><th>校排</th><th style="${B}">全镇排名</th><th style="${ct}">全县排名</th></tr></thead>
                <tbody>${dt}</tbody>
            </table>
        </div>
        </div>`,yt=_;let zt="";if(yt.length>1){let t="",n=`<th style="text-align:left; padding-left:20px;">考试名称</th><th>${bt}</th><th>校排</th>`;g&&(n+="<th>镇排</th>"),E&&(n+="<th>县排</th>");for(let l=yt.length-1;l>=0;l--){const i=yt[l],y=i.examFullKey||i.examId,f=getEffectiveCurrentExamId(),v=!!f&&(isExamKeyEquivalentForCompare(y,f)||isExamKeyEquivalentForCompare(i.examId,f)),C=v?"background:rgba(239,246,255,0.7); font-weight:bold;":"",b=i.student||i,k=getComparisonTotalValue(b,xt),W=Number.isFinite(k)?k.toFixed(1):"-",V=safeGet(b,"ranks.total.school",i.rankSchool||"-"),U=safeGet(b,"ranks.total.township",i.rankTown||"-"),se=X(i,b,"total","county");t+=`<tr style="${C}">
                ${c("考试名称",`${v?"⭐ ":""}${i.examLabel||i.examId||i.examFullKey||"-"}`,"text-align:left; padding-left:20px; color:#475569;")}
                ${c(bt,W,"color:#2563eb;")}
                ${c("校级排名",V,"color:#64748b;")}
                ${g?c("全镇排名",U,"color:#64748b;"):""}
                ${E?c("全县排名",se,"color:#64748b;"):""}
            </tr>`}zt=`
        ...
        </div>`;return w&&o.html.set(J,At),At}function St(e){var F,K;const a=new Date().toLocaleDateString(),s=RAW_DATA.length,r=vt(e),u=getComparisonTotalSubjects(),M=getComparisonTotalValue(r,u),z=rt("township",u),S=rt("county",u),H=S===null?getStudentCountyRankValue(r,"total")!=="-":S,w=z&&!isCountyDirectStudent(r),J=w?safeGet(r,"ranks.total.township","-"):safeGet(r,"ranks.total.school","-"),$t=(r==null?void 0:r.school)&&((K=(F=SCHOOLS==null?void 0:SCHOOLS[r.school])==null?void 0:F.students)==null?void 0:K.length)||s||1,d=typeof J=="number"?((1-J/(w?s||1:$t))*100).toFixed(0):"-",A=e.name.charAt(0),_=wt(r),D=Object.keys(SCHOOLS).length<=1?"全校":w?"全镇":"本校";let $="";d>=90?$="🌟 卓越之星":d>=75?$="🔥 进步飞速":$="📚 持续努力";let at="";u.forEach(p=>{if(r.scores[p]!==void 0){const g=r.scores[p],j=safeGet(r,`ranks.${p}.school`,"-"),N=w?safeGet(r,`ranks.${p}.township`,"-"):"-",Q=getStudentCountyRankValue(r,p),R=[`级#${j}`];w&&R.push(`镇#${N}`),H&&R.push(`县#${Q}`),at+=`
        ...
        `,h=(()=>{let p=[],g=[],j=[],N=[];getComparisonTotalSubjects().forEach(L=>{if(e.scores[L]!==void 0){const O=RAW_DATA.map(I=>I.scores[L]).filter(I=>typeof I=="number");if(O.length<2)return;const st=O.reduce((I,B)=>I+B,0)/O.length,lt=O.reduce((I,B)=>I+Math.pow(B-st,2),0)/O.length,mt=Math.sqrt(lt)||1,tt=(e.scores[L]-st)/mt;N.push(tt);const nt=`${L}`;tt>=.8?p.push(nt):tt<=-.8?g.push(nt):j.push(nt)}});const R=N.length?Math.max(...N):0,E=N.length?Math.min(...N):0,it=R-E;return{strong:p,weak:g,mid:j,range:it}})(),Y=(p=>p>=2.5?{tag:"⚠️ 严重偏科",color:"#b91c1c",bg:"#fee2e2",text:"不同学科成绩差异极大，存在明显优势科目与薄弱科目，需要针对性调整学习重心，补齐短板。"}:p>=1.2?{tag:"⚖️ 相对均衡",color:"#0369a1",bg:"#e0f2fe",text:"各学科成绩整体较为均衡，个别学科略有波动，保持稳定发挥是关键。"}:{tag:"🌟 结构优秀",color:"#15803d",bg:"#dcfce7",text:"各学科发展极其均衡，无明显短板，心理素质稳定，是冲刺更高目标的理想状态。"})(h.range),c=`
            <div style="margin: 15px 14px 0 14px; background: #fff; border: 1px solid #e2e8f0; border-radius: 8px; padding: 15px;">
                <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:8px;">
                    ...
                    <span style="font-size:12px; background:${Y.bg}; color:${Y.color}; padding:2px 8px; border-radius:12px; font-weight:bold;">
                        ${Y.tag}
                    </span>
                </div>
        ...
        `,Z=(p,g)=>!p||p.length===0?`<div style="font-size:12px; color:#ccc; padding:5px;">${g}</div>`:p.map(j=>`<span style="display:inline-block; background:#f1f5f9; color:#334155; font-size:12px; padding:4px 10px; border-radius:4px; margin:0 5px 5px 0;">${j}</span>`).join(""),X=`
        ...
        `,ot=`
            <div style="margin: 15px 14px 20px 14px; background: #fffbeb; border: 1px solid #fcd34d; border-radius: 8px; padding: 15px;">
                ...
                <ul style="padding-left:15px; margin:0; font-size:12px; color:#78350f;">
                    ${(()=>{const p=[];if(h.weak.length>0){const g=h.weak.join("、");p.push(`🎯 <strong>精准攻坚：</strong>针对 ${g}，建议每天安排 15 分钟回归课本基础概念，不盲目刷题。`)}if(h.strong.length>0){const g=h.strong.join("、");p.push(`🛡️ <strong>保持自信：</strong>${g} 是孩子的信心来源，请多给予具体表扬，稳住优势。`)}return h.strong.length===0&&h.weak.length===0&&p.push("🚀 <strong>寻找突破：</strong>目前成绩非常稳定。建议选定一门孩子最感兴趣的学科，尝试增加 5% 的投入，培养成优势学科。"),p.push("📅 <strong>习惯养成：</strong>检查孩子是否养成了“先复习，后作业”的习惯。"),p.map(g=>`<li style="margin-bottom:8px; line-height:1.5;">${g}</li>`).join("")})()}
                </ul>
            </div>
        `,gt=`
            <div class="insta-visual-area">
                <div style="width:100%; height:100%; display:flex; flex-direction:column; justify-content:center; align-items:center; background:linear-gradient(135deg, #833ab4, #fd1d1d, #fcb045); border-radius:8px; color:white; padding:40px 0;">
                    ...
                    <div style="margin-top:20px; font-size:12px; opacity:0.8;">击败了${D} ${d}% 的考生</div>
                </div>
            </div>
        `,ut=_?`
            ...
            <div class="insta-view-container" style="background:#fafafa; padding-top:20px;">
                <div class="insta-card">
                    ...
                    <div class="insta-header">
                        <div class="insta-avatar-ring"><div class="insta-avatar">${A}</div></div>
        ...
        `}Object.assign(window,{getTrendBadge:T,renderSingleReportCardHTML:Ct,renderInstagramCard:St}),window.__REPORT_RENDER_RUNTIME_PATCHED__=!0})();
