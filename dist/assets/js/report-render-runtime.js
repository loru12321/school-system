(()=>{if(typeof window=="undefined"||window.__REPORT_RENDER_RUNTIME_PATCHED__)return;const q=window.CompareSessionState||null,ct=window.ReportSessionState||null,_t=typeof window.readCloudStudentCompareContextState=="function"?window.readCloudStudentCompareContextState:(()=>q&&typeof q.getCloudStudentCompareContext=="function"&&q.getCloudStudentCompareContext()||null),ae=typeof window.readCurrentReportStudentState=="function"?window.readCurrentReportStudentState:(()=>ct&&typeof ct.getCurrentReportStudent=="function"?ct.getCurrentReportStudent()||null:window.CURRENT_REPORT_STUDENT&&typeof window.CURRENT_REPORT_STUDENT=="object"?window.CURRENT_REPORT_STUDENT:null),Ft=typeof window.readDuplicateCompareExamsState=="function"?window.readDuplicateCompareExamsState:(()=>q&&typeof q.getDuplicateCompareExams=="function"?q.getDuplicateCompareExams()||[]:[]),o={signature:"",html:new Map,comparisonStudent:new WeakMap,comparisonStudentByKey:new Map,cloudHint:new WeakMap,cloudHintByKey:new Map,previousRecord:new WeakMap,previousRecordByKey:new Map,examHistory:new WeakMap,examHistoryByKey:new Map,scopeMapRaw:"",scopeMap:{},schoolCandidatesSignature:"",schoolCandidates:[],townshipRank:new Map,countyRank:new Map,countyDirect:new WeakMap};function F(){const e=[window.CURRENT_EXAM_ID||"",window.__RAW_DATA_VERSION||0,Array.isArray(window.RAW_DATA)?window.RAW_DATA.length:0,Array.isArray(window.SUBJECTS)?window.SUBJECTS.join("|"):"",Object.keys(window.SCHOOLS||{}).join("|")].join("::");return o.signature!==e&&(o.signature=e,o.html.clear(),o.comparisonStudent=new WeakMap,o.comparisonStudentByKey.clear(),o.cloudHint=new WeakMap,o.cloudHintByKey.clear(),o.previousRecord=new WeakMap,o.previousRecordByKey.clear(),o.examHistory=new WeakMap,o.examHistoryByKey.clear(),o.townshipRank.clear(),o.countyRank.clear(),o.countyDirect=new WeakMap),e}function Y(e){return[String((e==null?void 0:e.school)||"").trim(),String((e==null?void 0:e.class)||"").trim(),String((e==null?void 0:e.name)||"").trim(),String((e==null?void 0:e.id)||(e==null?void 0:e.examNo)||"").trim()].join("::")}function Kt(e,r){if(!Array.isArray(e)||!e.length)return null;for(let s=e.length-1;s>=0;s--){const n=e[s],f=(n==null?void 0:n.examFullKey)||(n==null?void 0:n.examId);if(!r||!isExamKeyEquivalentForCompare(f,r)&&!isExamKeyEquivalentForCompare(n==null?void 0:n.examId,r))return n||null}return null}function bt(e){if(!e||typeof e!="object")return e;if(F(),o.comparisonStudent.has(e))return o.comparisonStudent.get(e);const r=Y(e);if(o.comparisonStudentByKey.has(r)){const n=o.comparisonStudentByKey.get(r);return o.comparisonStudent.set(e,n),n}const s=typeof getComparisonStudentView=="function"?getComparisonStudentView(e,RAW_DATA):e;return o.comparisonStudent.set(e,s),o.comparisonStudentByKey.set(r,s),s}function yt(e){if(!e||typeof e!="object")return null;if(F(),o.cloudHint.has(e))return o.cloudHint.get(e);const r=Y(e);if(o.cloudHintByKey.has(r)){const n=o.cloudHintByKey.get(r);return o.cloudHint.set(e,n),n}const s=Pt(e);return o.cloudHint.set(e,s||null),o.cloudHintByKey.set(r,s||null),s||null}function Ot(e){if(!e||typeof e!="object")return null;if(F(),o.previousRecord.has(e))return o.previousRecord.get(e);const r=Y(e);if(o.previousRecordByKey.has(r)){const n=o.previousRecordByKey.get(r);return o.previousRecord.set(e,n),n}const s=typeof findPreviousRecord=="function"?findPreviousRecord(e):null;return o.previousRecord.set(e,s||null),o.previousRecordByKey.set(r,s||null),s||null}function It(e){if(!e||typeof e!="object")return[];if(F(),o.examHistory.has(e))return o.examHistory.get(e);const r=Y(e);if(o.examHistoryByKey.has(r)){const f=o.examHistoryByKey.get(r);return o.examHistory.set(e,f),f}const s=typeof getStudentExamHistory=="function"?getStudentExamHistory(e):[],n=Array.isArray(s)?s:[];return o.examHistory.set(e,n),o.examHistoryByKey.set(r,n),n}function tt(e,r){const s=`${F()}::${e}::${(r||[]).join("|")}`,n=e==="township"?o.townshipRank:o.countyRank;if(n.has(s))return n.get(s);const f=e==="township"?typeof hasStudentTownshipRankData=="function"?hasStudentTownshipRankData(RAW_DATA,r):Object.keys(SCHOOLS).length>1:typeof hasStudentCountyRankData=="function"?hasStudentCountyRankData(RAW_DATA,r):null;return n.set(s,f),f}function Bt(){let e="";try{e=localStorage.getItem("COUNTY_ANALYSIS_SCOPE_V1")||""}catch(r){e=""}if(o.scopeMapRaw!==e){o.scopeMapRaw=e;try{o.scopeMap=e?JSON.parse(e):{}}catch(r){o.scopeMap={}}}return o.scopeMap}function Gt(){const e=F();return o.schoolCandidatesSignature===e||(o.schoolCandidatesSignature=e,o.schoolCandidates=Array.from(new Set([...Object.keys(SCHOOLS||{}),...(RAW_DATA||[]).map(r=>r==null?void 0:r.school)].map(r=>String(r||"").trim()).filter(Boolean)))),o.schoolCandidates}function Pt(e){return typeof getCloudCompareHint=="function"?getCloudCompareHint(e):isCloudContextMatchStudent(e)||isCloudContextLikelyCurrentTarget(e)?_t():null}function z(e,r,s="score"){if(r==null||r==="-"||r==="")return"";const n=parseFloat(e),f=parseFloat(r);if(isNaN(n)||isNaN(f))return"";const D=n-f;if(Math.abs(D)<.01)return'<span style="color:#94a3b8; font-size:11px; margin-left:4px; font-weight:normal;">(持平)</span>';let A="",$="",R="";s==="score"?D>0?(A="#15803d",R="#dcfce7",$="▲"):(A="#b91c1c",R="#fee2e2",$="▼"):D<0?(A="#15803d",R="#dcfce7",$="▲"):(A="#b91c1c",R="#fee2e2",$="▼");const v=Math.abs(D);return`<span style="display:inline-flex; align-items:center; background:${R}; color:${A}; padding:1px 6px; border-radius:10px; font-size:11px; font-weight:bold; margin-left:5px; vertical-align:middle;">
            ${$} ${s==="score"?v.toFixed(1):v}
        </span>`}function vt(e,r){var zt,At,Dt,jt,kt,Nt,Et,Mt;if(navigator.userAgent.toLowerCase().includes("android")&&window.innerWidth<=768&&!window.Chart)return console.warn("⚠️ Android Canvas 异常，强制切换 PC 模式"),vt(e,"PC");const D=window.innerWidth<=768,A=r==="FULL",$=r==="A4"||r==="PC"||A,R=$,v=R?`${F()}::${Y(e)}::${r||""}::${new Date().toLocaleDateString()}`:"";if(R&&o.html.has(v))return o.html.get(v);if(!$&&D||r==="IG"){const t=wt(e);return setTimeout(()=>{typeof renderIGCharts=="function"&&renderIGCharts(e)},50),t}const dt=RAW_DATA.length,pt=new Date().toLocaleDateString(),p=bt(e),T=yt(p),g=(T==null?void 0:T.previousRecord)||Ot(p),k=It(p),St=getEffectiveCurrentExamId(),K=Kt(k,St),N=K?K.student||K:null,u=N&&N.scores?N:g,J=((zt=u==null?void 0:u.ranks)==null?void 0:zt.total)||{},Ct=t=>typeof t=="number"&&Number.isFinite(t)?t:t&&typeof t=="object"&&typeof t.score=="number"&&Number.isFinite(t.score)?t.score:"-",h=t=>String(t!=null?t:"").replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),d=(t,a,l="")=>`<td data-label="${h(t)}"${l?` style="${l}"`:""}>${a}</td>`,O=t=>{var a,l,i,b,x,H,j,C;return{class:(l=(a=t==null?void 0:t.class)!=null?a:t==null?void 0:t.rankClass)!=null?l:"-",school:(b=(i=t==null?void 0:t.school)!=null?i:t==null?void 0:t.rankSchool)!=null?b:"-",township:(H=(x=t==null?void 0:t.township)!=null?x:t==null?void 0:t.rankTown)!=null?H:"-",county:(C=(j=t==null?void 0:t.county)!=null?j:t==null?void 0:t.rankCounty)!=null?C:"-"}},et=(t,a=null)=>{const l=String((t==null?void 0:t.examFullKey)||(t==null?void 0:t.examId)||(a==null?void 0:a._sourceExam)||(a==null?void 0:a.examFullKey)||(a==null?void 0:a.examId)||"").trim();if(!l)return null;const i=Bt();return(i==null?void 0:i[l])||null},Z=(t,a="total",l=null)=>{var x,H,j,C,U,ht,it,st,lt;if(!t||typeof t!="object")return!1;const i=et(l,t);if(!i||i.includesCounty!==!0)return!1;const b=a==="total"?(C=(j=(H=(x=t==null?void 0:t.ranks)==null?void 0:x.total)==null?void 0:H.county)!=null?j:t==null?void 0:t.rankCounty)!=null?C:t==null?void 0:t.countyRank:(lt=(ht=(U=t==null?void 0:t.ranks)==null?void 0:U[a])==null?void 0:ht.county)!=null?lt:(st=(it=t==null?void 0:t.subjectRanks)==null?void 0:it[a])==null?void 0:st.county;return b!=null&&b!==""},ot=t=>{var i;const a=String((i=t==null?void 0:t.class)!=null?i:"").trim(),l=typeof normalizeClass=="function"?normalizeClass(a):a;return!l||l==="-"?!1:!/^(?:无|未分班|无班级|暂无|undefined|null|nan)$/i.test(l)},$t=t=>{if(typeof isCountyDirectStudentForRank=="function")return isCountyDirectStudentForRank(t);const a=String((t==null?void 0:t.school)||"").trim();if(!a||typeof getCountyDirectSchoolNames!="function"||typeof getTownshipManagedSchoolNames!="function")return!1;if(o.countyDirect.has(t))return o.countyDirect.get(t);const l=Gt();if(!getTownshipManagedSchoolNames(l).length)return o.countyDirect.set(t,!1),!1;const b=getCountyDirectSchoolNames(l).some(x=>x===a||typeof areSchoolNamesEquivalent=="function"&&areSchoolNamesEquivalent(x,a)||typeof areSchoolNamesMatched=="function"&&areSchoolNamesMatched(x,a,!0));return o.countyDirect.set(t,b),b},E=(t,a=!0)=>a?t==null||t===""?"-":t:"-",I=p&&typeof p=="object"&&p.scores&&typeof p.scores=="object"?p.scores:{},nt=[...new Set(SUBJECTS)],B=tt("township",nt),X=tt("county",nt),c=X===null?getStudentCountyRankValue(p,"total")!=="-":X,m=ot(p),w=B&&!$t(p),y=c,Q=E(safeGet(p,"ranks.total.township","-"),w),G=E((Dt=(At=J.township)!=null?At:g==null?void 0:g.townRank)!=null?Dt:"-",w),rt=E(safeGet(p,"ranks.total.class","-"),m),ft=E((kt=(jt=J.class)!=null?jt:g==null?void 0:g.classRank)!=null?kt:"-",m),P=safeGet(p,"ranks.total.school","-"),W=(Et=(Nt=J.school)!=null?Nt:g==null?void 0:g.schoolRank)!=null?Et:"-",L=getStudentCountyRankValue(p,"total"),gt=Z(u,"total",K)&&(Mt=J.county)!=null?Mt:"-",Rt=Object.keys(SCHOOLS).length<=1,M=B?"":"display:none !important;",_=y?"":"display:none !important;";let S="";if(CONFIG.name==="9年级"){let t=0,a=0;["语文","数学","英语","物理","化学"].forEach(l=>{I[l]!==void 0&&(t+=I[l],a++)}),a>0&&(S+=`<tr style="background:rgba(248,250,252,0.5);">
                    ...
                    ${d("全镇排名","-",M)}
                    ${d("全县排名","-",_)}
                </tr>`)}const V=getComparisonTotalSubjects(),ut=getComparisonTotalValue(p,V),mt=CONFIG.name==="9年级"&&V.length?"五科总分":CONFIG.label,Wt=u?recalcPrevTotal(u):"-",Vt=z(ut,Wt,"score"),Ut=m?z(rt,ft,"rank"):"",qt=z(P,W,"rank"),Jt=w?z(Q,G,"rank"):"",Yt=y?z(L,gt,"rank"):"";S+=`<tr style="background:rgba(239,246,255,0.7); backdrop-filter:blur(4px); border-bottom:2px solid #fff;">
            ${d("科目",`🏆 ${mt}`,"font-weight:bold; color:#1e3a8a;")}
            ${d("成绩（对比）",`${Number.isFinite(ut)?ut.toFixed(2):"-"} ${Vt}`,"font-weight:800; font-size:16px; color:#1e40af;")}
            ${d("班级排名",`${rt} ${Ut}`,"font-weight:bold; color:#334155;")}
            ${d("校级排名",`${P} ${qt}`,"font-weight:bold; color:#334155;")}
            ${d("全镇排名",`${Q} ${Jt}`,`${M} font-weight:bold; color:#334155;`)}
            ${d("全县排名",`${y?L:"-"} ${Yt}`,`${_} font-weight:bold; color:#334155;`)}
        </tr>`,[...new Set(SUBJECTS)].forEach(t=>{if(I[t]!==void 0){const a=u&&u.scores?Ct(u.scores[t]):"-",l=z(I[t],a,"score");let i=O(u&&u.ranks?u.ranks[t]:null);i.class==="-"&&i.school==="-"&&i.township==="-"&&g&&g.ranks&&g.ranks[t]&&(i=O(g.ranks[t]));const b=safeGet(p,`ranks.${t}.school`,"-"),x=z(b,i.school||"-","rank"),H=E(safeGet(p,`ranks.${t}.township`,"-"),w),j=w?z(H,i.township||"-","rank"):"",C=getStudentCountyRankValue(p,t),U=y&&Z(u,t,K)?z(C,i.county||"-","rank"):"";S+=`<tr style="transition:0.2s;" onmouseover="this.style.background='rgba(241,245,249,0.5)'" onmouseout="this.style.background='transparent'">
                    ${d("科目",t,"font-weight:600; color:#475569;")}
                    ${d("成绩（对比）",`${I[t]} ${l}`,"font-weight:bold; color:#334155;")}
                    ${d("班级排名","-","color:#cbd5e1;")}
                    ${d("校级排名",`${b} <span style="font-size:0.9em;">${x}</span>`,"color:#64748b;")}
                    ${d("全镇排名",`${H} <span style="font-size:0.9em;">${j}</span>`,`color:#64748b; ${M}`)}
        ...
        `,Xt=buildChartNarrative(p),at=buildStudentInsightModel(p,k),Qt=renderStudentInsightOverview(at),Lt=renderStudentActionPlan(at),te=renderStudentSubjectBoard(at),ee=renderStudentRealityNote(at),oe=T?`
        ...
        </div>`,xt=k;let Tt="";if(xt.length>1){let t="",a=`<th style="text-align:left; padding-left:20px;">考试名称</th><th>${mt}</th><th>校排</th>`;B&&(a+="<th>镇排</th>");for(let l=xt.length-1;l>=0;l--){const i=xt[l],b=i.examFullKey||i.examId,x=getEffectiveCurrentExamId(),H=!!x&&(isExamKeyEquivalentForCompare(b,x)||isExamKeyEquivalentForCompare(i.examId,x)),j=H?"background:rgba(239,246,255,0.7); font-weight:bold;":"",C=i.student||i,U=getComparisonTotalValue(C,V),it=Number.isFinite(U)?U.toFixed(1):"-",st=safeGet(C,"ranks.total.school",i.rankSchool||"-"),lt=safeGet(C,"ranks.total.township",i.rankTown||"-");t+=`<tr style="${j}">
        ...
        <div style="text-align:center; font-size:11px; color:#cbd5e1; margin-top:20px;">系统自动生成 · 仅供家校沟通参考</div>
        </div>`;return R&&o.html.set(v,Ht),Ht}function wt(e){var B,X;const r=new Date().toLocaleDateString(),s=RAW_DATA.length,n=bt(e),f=getComparisonTotalSubjects(),D=getComparisonTotalValue(n,f),A=tt("township",f),$=tt("county",f),R=$===null?getStudentCountyRankValue(n,"total")!=="-":$,v=A&&!isCountyDirectStudent(n),dt=v?safeGet(n,"ranks.total.township","-"):safeGet(n,"ranks.total.school","-"),pt=(n==null?void 0:n.school)&&((X=(B=SCHOOLS==null?void 0:SCHOOLS[n.school])==null?void 0:B.students)==null?void 0:X.length)||s||1,T=typeof dt=="number"?((1-dt/(v?s||1:pt))*100).toFixed(0):"-",g=e.name.charAt(0),k=yt(n),K=Object.keys(SCHOOLS).length<=1?"全校":v?"全镇":"本校";let N="";T>=90?N="🌟 卓越之星":T>=75?N="🔥 进步飞速":N="📚 持续努力";let u="";f.forEach(c=>{if(n.scores[c]!==void 0){const m=n.scores[c],w=safeGet(n,`ranks.${c}.school`,"-"),y=v?safeGet(n,`ranks.${c}.township`,"-"):"-",Q=getStudentCountyRankValue(n,c),G=[`级#${w}`];v&&G.push(`镇#${y}`),R&&G.push(`县#${Q}`),u+=`
                    <div class="insta-comment-row">
                        ...
                        <div>
                            <span class="insta-comm-score">${m}</span>
        ...
        `,h=(()=>{let c=[],m=[],w=[],y=[];getComparisonTotalSubjects().forEach(P=>{if(e.scores[P]!==void 0){const W=RAW_DATA.map(S=>S.scores[P]).filter(S=>typeof S=="number");if(W.length<2)return;const L=W.reduce((S,V)=>S+V,0)/W.length,gt=W.reduce((S,V)=>S+Math.pow(V-L,2),0)/W.length,Rt=Math.sqrt(gt)||1,M=(e.scores[P]-L)/Rt;y.push(M);const _=`${P}`;M>=.8?c.push(_):M<=-.8?m.push(_):w.push(_)}});const G=y.length?Math.max(...y):0,rt=y.length?Math.min(...y):0,ft=G-rt;return{strong:c,weak:m,mid:w,range:ft}})(),O=(c=>c>=2.5?{tag:"⚠️ 严重偏科",color:"#b91c1c",bg:"#fee2e2",text:"不同学科成绩差异极大，存在明显优势科目与薄弱科目，需要针对性调整学习重心，补齐短板。"}:c>=1.2?{tag:"⚖️ 相对均衡",color:"#0369a1",bg:"#e0f2fe",text:"各学科成绩整体较为均衡，个别学科略有波动，保持稳定发挥是关键。"}:{tag:"🌟 结构优秀",color:"#15803d",bg:"#dcfce7",text:"各学科发展极其均衡，无明显短板，心理素质稳定，是冲刺更高目标的理想状态。"})(h.range),et=`
        ...
        `,Z=(c,m)=>!c||c.length===0?`<div style="font-size:12px; color:#ccc; padding:5px;">${m}</div>`:c.map(w=>`<span style="display:inline-block; background:#f1f5f9; color:#334155; font-size:12px; padding:4px 10px; border-radius:4px; margin:0 5px 5px 0;">${w}</span>`).join(""),ot=`
        ...
        `,E=`
            <div style="margin: 15px 14px 20px 14px; background: #fffbeb; border: 1px solid #fcd34d; border-radius: 8px; padding: 15px;">
                ...
                <ul style="padding-left:15px; margin:0; font-size:12px; color:#78350f;">
                    ${(()=>{const c=[];if(h.weak.length>0){const m=h.weak.join("、");c.push(`🎯 <strong>精准攻坚：</strong>针对 ${m}，建议每天安排 15 分钟回归课本基础概念，不盲目刷题。`)}if(h.strong.length>0){const m=h.strong.join("、");c.push(`🛡️ <strong>保持自信：</strong>${m} 是孩子的信心来源，请多给予具体表扬，稳住优势。`)}return h.strong.length===0&&h.weak.length===0&&c.push("🚀 <strong>寻找突破：</strong>目前成绩非常稳定。建议选定一门孩子最感兴趣的学科，尝试增加 5% 的投入，培养成优势学科。"),c.push("📅 <strong>习惯养成：</strong>检查孩子是否养成了“先复习，后作业”的习惯。"),c.map(m=>`<li style="margin-bottom:8px; line-height:1.5;">${m}</li>`).join("")})()}
                </ul>
            </div>
        `,I=`
            <div class="insta-visual-area">
                <div style="width:100%; height:100%; display:flex; flex-direction:column; justify-content:center; align-items:center; background:linear-gradient(135deg, #833ab4, #fd1d1d, #fcb045); border-radius:8px; color:white; padding:40px 0;">
                    ...
                    <div style="margin-top:20px; font-size:12px; opacity:0.8;">击败了${K} ${T}% 的考生</div>
                </div>
            </div>
        `,nt=k?`
            ...
            <div class="insta-view-container" style="background:#fafafa; padding-top:20px;">
                <div class="insta-card">
                    ...
                    <div class="insta-header">
                        <div class="insta-avatar-ring"><div class="insta-avatar">${g}</div></div>
        ...
        `}Object.assign(window,{getTrendBadge:z,renderSingleReportCardHTML:vt,renderInstagramCard:wt}),window.__REPORT_RENDER_RUNTIME_PATCHED__=!0})();
