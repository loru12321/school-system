(()=>{if(typeof window=="undefined"||window.__REPORT_RENDER_RUNTIME_PATCHED__)return;const W=window.CompareSessionState||null,ct=window.ReportSessionState||null,Bt=typeof window.readCloudStudentCompareContextState=="function"?window.readCloudStudentCompareContextState:(()=>W&&typeof W.getCloudStudentCompareContext=="function"&&W.getCloudStudentCompareContext()||null),me=typeof window.readCurrentReportStudentState=="function"?window.readCurrentReportStudentState:(()=>ct&&typeof ct.getCurrentReportStudent=="function"?ct.getCurrentReportStudent()||null:window.CURRENT_REPORT_STUDENT&&typeof window.CURRENT_REPORT_STUDENT=="object"?window.CURRENT_REPORT_STUDENT:null),Pt=typeof window.readDuplicateCompareExamsState=="function"?window.readDuplicateCompareExamsState:(()=>W&&typeof W.getDuplicateCompareExams=="function"?W.getDuplicateCompareExams()||[]:[]),o={signature:"",html:new Map,comparisonStudent:new WeakMap,comparisonStudentByKey:new Map,cloudHint:new WeakMap,cloudHintByKey:new Map,previousRecord:new WeakMap,previousRecordByKey:new Map,examHistory:new WeakMap,examHistoryByKey:new Map,im:new Map,scopeMapRaw:"",scopeMap:{},schoolCandidatesSignature:"",schoolCandidates:[],townshipRank:new Map,countyRank:new Map,countyDirect:new WeakMap,rankIndex:null};function M(){const e=[window.CURRENT_EXAM_ID||"",window.__RAW_DATA_VERSION||0,Array.isArray(window.RAW_DATA)?window.RAW_DATA.length:0,Array.isArray(window.SUBJECTS)?window.SUBJECTS.join("|"):"",Object.keys(window.SCHOOLS||{}).join("|")].join("::");return o.signature!==e&&(o.signature=e,o.html.clear(),o.comparisonStudent=new WeakMap,o.comparisonStudentByKey.clear(),o.cloudHint=new WeakMap,o.cloudHintByKey.clear(),o.previousRecord=new WeakMap,o.previousRecordByKey.clear(),o.examHistory=new WeakMap,o.examHistoryByKey.clear(),o.townshipRank.clear(),o.countyRank.clear(),o.countyDirect=new WeakMap,o.rankIndex=null),e}function G(e){return[String((e==null?void 0:e.school)||"").trim(),String((e==null?void 0:e.class)||"").trim(),String((e==null?void 0:e.name)||"").trim(),String((e==null?void 0:e.id)||(e==null?void 0:e.examNo)||"").trim()].join("::")}function Wt(e,a){if(!Array.isArray(e)||!e.length)return null;for(let s=e.length-1;s>=0;s--){const r=e[s],u=(r==null?void 0:r.examFullKey)||(r==null?void 0:r.examId);if(!a||!isExamKeyEquivalentForCompare(u,a)&&!isExamKeyEquivalentForCompare(r==null?void 0:r.examId,a))return r||null}return null}function dt(e){if(!e||typeof e!="object")return e;if(M(),o.comparisonStudent.has(e))return o.comparisonStudent.get(e);const a=G(e);if(o.comparisonStudentByKey.has(a)){const r=o.comparisonStudentByKey.get(a);return o.comparisonStudent.set(e,r),r}const s=typeof getComparisonStudentView=="function"?getComparisonStudentView(e,RAW_DATA):e;return o.comparisonStudent.set(e,s),o.comparisonStudentByKey.set(a,s),s}function vt(e){if(!e||typeof e!="object")return null;if(M(),o.cloudHint.has(e))return o.cloudHint.get(e);const a=G(e);if(o.cloudHintByKey.has(a)){const r=o.cloudHintByKey.get(a);return o.cloudHint.set(e,r),r}const s=Qt(e);return o.cloudHint.set(e,s||null),o.cloudHintByKey.set(a,s||null),s||null}function Gt(e){if(!e||typeof e!="object")return null;if(M(),o.previousRecord.has(e))return o.previousRecord.get(e);const a=G(e);if(o.previousRecordByKey.has(a)){const r=o.previousRecordByKey.get(a);return o.previousRecord.set(e,r),r}const s=typeof findPreviousRecord=="function"?findPreviousRecord(e):null;return o.previousRecord.set(e,s||null),o.previousRecordByKey.set(a,s||null),s||null}function St(e){if(!e||typeof e!="object")return[];if(M(),o.examHistory.has(e))return o.examHistory.get(e);const a=G(e);if(o.examHistoryByKey.has(a)){const u=o.examHistoryByKey.get(a);return o.examHistory.set(e,u),u}const s=typeof getStudentExamHistory=="function"?getStudentExamHistory(e):[],r=Array.isArray(s)?s:[];return o.examHistory.set(e,r),o.examHistoryByKey.set(a,r),r}function Vt(e,a=null){const s=Array.isArray(a)?a:[],r=s[s.length-1]||{},u=`${M()}::${G(e)}::${s.length}:${r.examFullKey||r.examId||""}`;if(o.im.has(u))return o.im.get(u);const V=window.ReportInsightRuntime.buildStudentInsightModel(e,a,{getCachedComparisonStudentView:dt,getCachedStudentExamHistory:St});return o.im.set(u,V),V}function Ut(e){return window.ReportInsightRuntime.renderStudentInsightOverview(e)}function qt(e){return window.ReportInsightRuntime.renderStudentActionPlan(e)}function Jt(e){return window.ReportInsightRuntime.renderStudentSubjectBoard(e)}function Yt(e){return window.ReportInsightRuntime.renderStudentRealityNote(e)}function nt(e,a){const s=`${M()}::${e}::${(a||[]).join("|")}`,r=e==="township"?o.townshipRank:o.countyRank;if(r.has(s))return r.get(s);const u=e==="township"?typeof hasStudentTownshipRankData=="function"?hasStudentTownshipRankData(RAW_DATA,a):Object.keys(SCHOOLS).length>1:typeof hasStudentCountyRankData=="function"?hasStudentCountyRankData(RAW_DATA,a):null;return r.set(s,u),u}function Zt(){let e="";try{e=localStorage.getItem("COUNTY_ANALYSIS_SCOPE_V1")||""}catch(a){e=""}if(o.scopeMapRaw!==e){o.scopeMapRaw=e;try{o.scopeMap=e?JSON.parse(e):{}}catch(a){o.scopeMap={}}}return o.scopeMap}function Xt(){const e=M();return o.schoolCandidatesSignature===e||(o.schoolCandidatesSignature=e,o.schoolCandidates=Array.from(new Set([...Object.keys(SCHOOLS||{}),...(RAW_DATA||[]).map(a=>a==null?void 0:a.school)].map(a=>String(a||"").trim()).filter(Boolean)))),o.schoolCandidates}function Qt(e){return typeof getCloudCompareHint=="function"?getCloudCompareHint(e):isCloudContextMatchStudent(e)||isCloudContextLikelyCurrentTarget(e)?Bt():null}function $(e,a,s="score"){return window.ReportInsightRuntime.getTrendBadge(e,a,s)}function Ct(e,a,s={}){var Et,It,Nt,Mt,_t,Kt,Ft,Ot;if(navigator.userAgent.toLowerCase().includes("android")&&window.innerWidth<=768&&!window.Chart)return console.warn("⚠️ Android Canvas 异常，强制切换 PC 模式"),Ct(e,"PC",s);const pt=window.innerWidth<=768,Q=a==="FULL",rt=a==="A4"||a==="PC"||Q,z=rt,U=z?`${M()}::${G(e)}::${a||""}::${new Date().toLocaleDateString()}`:"";if(z&&o.html.has(U))return o.html.get(U);if(!rt&&pt||a==="IG"){const t=Rt(e);return setTimeout(()=>{typeof renderIGCharts=="function"&&renderIGCharts(e)},50),t}const $t=RAW_DATA.length,Tt=new Date().toLocaleDateString(),d=dt(e),D=vt(d),_=Array.isArray(s.reportExamHistory)?s.reportExamHistory:St(d),Ht=getEffectiveCurrentExamId(),j=Wt(_,Ht),T=j?j.student||j:null,at=!!(T&&T.scores&&T.ranks),g=(D==null?void 0:D.previousRecord)||(at?null:Gt(d)),m=T&&T.scores?T:g,x=((Et=m==null?void 0:m.ranks)==null?void 0:Et.total)||{},At=t=>typeof t=="number"&&Number.isFinite(t)?t:t&&typeof t=="object"&&typeof t.score=="number"&&Number.isFinite(t.score)?t.score:"-",q=t=>String(t!=null?t:"").replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),p=(t,n,l="")=>`<td data-label="${q(t)}"${l?` style="${l}"`:""}>${n}</td>`,J=t=>{var n,l,i,w,f,S,R,b;return{class:(l=(n=t==null?void 0:t.class)!=null?n:t==null?void 0:t.rankClass)!=null?l:"-",school:(w=(i=t==null?void 0:t.school)!=null?i:t==null?void 0:t.rankSchool)!=null?w:"-",township:(S=(f=t==null?void 0:t.township)!=null?f:t==null?void 0:t.rankTown)!=null?S:"-",county:(b=(R=t==null?void 0:t.county)!=null?R:t==null?void 0:t.rankCounty)!=null?b:"-"}},Y=(t,n,l="total",i="county")=>{var S,R,b,k,E,I,N,P;const w=l==="total"?((S=n==null?void 0:n.ranks)==null?void 0:S.total)||n||t||{}:((R=n==null?void 0:n.ranks)==null?void 0:R[l])||((b=n==null?void 0:n.subjectRanks)==null?void 0:b[l])||((k=t==null?void 0:t.subjectRanks)==null?void 0:k[l])||{},f=J(w)[i];return f!=null&&f!==""?f:i==="county"&&l==="total"&&(P=(N=(I=(E=n==null?void 0:n.rankCounty)!=null?E:n==null?void 0:n.countyRank)!=null?I:t==null?void 0:t.rankCounty)!=null?N:t==null?void 0:t.countyRank)!=null?P:"-"},kt=(t,n=null)=>{const l=String((t==null?void 0:t.examFullKey)||(t==null?void 0:t.examId)||(n==null?void 0:n._sourceExam)||(n==null?void 0:n.examFullKey)||(n==null?void 0:n.examId)||"").trim();if(!l)return null;const i=Zt();return(i==null?void 0:i[l])||null},L=(t,n="total",l=null)=>{var f,S,R,b,k,E,I,N,P;if(!t||typeof t!="object")return!1;const i=n==="total"?(b=(R=(S=(f=t==null?void 0:t.ranks)==null?void 0:f.total)==null?void 0:S.county)!=null?R:t==null?void 0:t.rankCounty)!=null?b:t==null?void 0:t.countyRank:(P=(E=(k=t==null?void 0:t.ranks)==null?void 0:k[n])==null?void 0:E.county)!=null?P:(N=(I=t==null?void 0:t.subjectRanks)==null?void 0:I[n])==null?void 0:N.county;if(i!=null&&i!==""&&i!=="-")return!0;const w=kt(l,t);return!w||w.includesCounty!==!0?!1:i!=null&&i!==""},ft=t=>{var i;const n=String((i=t==null?void 0:t.class)!=null?i:"").trim(),l=typeof normalizeClass=="function"?normalizeClass(n):n;return!l||l==="-"?!1:!/^(?:无|未分班|无班级|暂无|undefined|null|nan)$/i.test(l)},ut=t=>{if(typeof isCountyDirectStudentForRank=="function")return isCountyDirectStudentForRank(t);const n=String((t==null?void 0:t.school)||"").trim();if(!n||typeof getCountyDirectSchoolNames!="function"||typeof getTownshipManagedSchoolNames!="function")return!1;if(o.countyDirect.has(t))return o.countyDirect.get(t);const l=Xt();if(!getTownshipManagedSchoolNames(l).length)return o.countyDirect.set(t,!1),!1;const w=getCountyDirectSchoolNames(l).some(f=>f===n||typeof areSchoolNamesEquivalent=="function"&&areSchoolNamesEquivalent(f,n)||typeof areSchoolNamesMatched=="function"&&areSchoolNamesMatched(f,n,!0));return o.countyDirect.set(t,w),w},H=(t,n=!0)=>n?t==null||t===""?"-":t:"-",Z=d&&typeof d=="object"&&d.scores&&typeof d.scores=="object"?d.scores:{},c=[...new Set(SUBJECTS)],h=o.rankIndex||(o.rankIndex=((It=window.RankingDataService)==null?void 0:It.buildStudentRankIndex(RAW_DATA,c))||null),y=(t,n)=>{var i;const l=safeGet(d,`ranks.${t}.${n}`,"-");return l!=null&&l!==""&&l!=="-"&&l!=="—"?l:(i=h==null?void 0:h.getRank(d,t,n,"-"))!=null?i:"-"},C=nt("township",c),tt=nt("county",c),F=tt===null?getStudentCountyRankValue(d,"total")!=="-":tt,O=ft(d),B=C&&!ut(d),v=F,K=H(y("total","township"),B),it=H((Mt=(Nt=x.township)!=null?Nt:g==null?void 0:g.townRank)!=null?Mt:"-",B),st=H(y("total","class"),O),gt=H((Kt=(_t=x.class)!=null?_t:g==null?void 0:g.classRank)!=null?Kt:"-",O),X=y("total","school"),et=(Ot=(Ft=x.school)!=null?Ft:g==null?void 0:g.schoolRank)!=null?Ot:"-",A=H(y("total","county"),v),ot=L(m,"total",j)?Y(j,m,"total","county"):"-",mt=C?"":"display:none !important;",xt=v?"":"display:none !important;",ht=getComparisonTotalSubjects(),bt=getComparisonTotalValue(d,ht),yt=CONFIG.name==="9年级"&&ht.length?"五科总分":CONFIG.label,Lt=m?recalcPrevTotal(m):"-",te=$(bt,Lt,"score"),ee=O?$(st,gt,"rank"):"",oe=$(X,et,"rank"),ne=B?$(K,it,"rank"):"",re=v?$(A,ot,"rank"):"";let zt=`<tr style="background:rgba(239,246,255,0.7); backdrop-filter:blur(4px); border-bottom:2px solid #fff;">
            ...
            ${p("全县排名",`${v?A:"-"} ${re}`,`${xt} font-weight:bold; color:#334155;`)}
                    ...
                    ${p("全县排名",`${v?E:"-"} <span style="font-size:0.9em;">${N}</span>`,`color:#64748b; ${xt}`)}
                </tr>`}});const ae=`
            <style>
