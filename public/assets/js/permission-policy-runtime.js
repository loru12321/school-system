const QUERY_MODULE_ACCESS = {
    admin: ['*'],
    director: ['starter-hub', 'upload', 'data-quality', 'summary', 'analysis', 'high-score', 'indicator', 'bottom3', 'county-analysis', 'teaching-overview', 'teacher-analysis', 'teaching-issue-board', 'teaching-warning-center', 'teaching-rectify-center', 'teaching-version-center', 'marginal-push', 'progress-analysis', 'report-generator', 'freshman-simulator', 'exam-arranger', 'grade-scheduler', 'seat-adjustment', 'mutual-aid', 'student-overview', 'student-details', 'subject-balance', 'potential-analysis', 'segment-analysis', 'correlation-analysis', 'cohort-growth', 'zhongkao-countdown', 'app-download-center'],
    grade_director: ['summary', 'analysis', 'high-score', 'indicator', 'bottom3', 'teaching-overview', 'teacher-analysis', 'teaching-issue-board', 'teaching-warning-center', 'teaching-rectify-center', 'marginal-push', 'progress-analysis', 'report-generator', 'student-overview', 'student-details', 'subject-balance', 'potential-analysis', 'segment-analysis', 'correlation-analysis', 'cohort-growth', 'zhongkao-countdown', 'app-download-center'],
    class_teacher: ['summary', 'analysis', 'high-score', 'indicator', 'bottom3', 'teacher-analysis', 'student-details', 'app-download-center'],
    teacher: ['summary', 'analysis', 'high-score', 'indicator', 'bottom3', 'teacher-analysis', 'student-details', 'app-download-center'],
