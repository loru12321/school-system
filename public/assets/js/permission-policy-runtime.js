const QUERY_MODULE_ACCESS = {
    ...
    grade_director: ['starter-hub', 'county-analysis', 'teacher-analysis', 'indicator', 'bottom3', 'marginal-push', 'progress-analysis', 'report-generator', 'student-overview', 'student-details', 'subject-balance', 'potential-analysis', 'segment-analysis', 'correlation-analysis', 'zhongkao-countdown', 'app-download-center'],
