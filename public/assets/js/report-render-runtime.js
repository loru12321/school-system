...
function buildStudentInsightModel(student, passedHistory = null) {
    const reportStudent = getCachedComparisonStudentView(student);
    ...
    const percentile = (typeof effectiveRank === 'number' && totalCount > 0)
        ...
        : null;
    const history = Array.isArray(passedHistory) ? passedHistory : getCachedStudentExamHistory(reportStudent);
