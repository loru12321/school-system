...
(() => {
    ...
    const actionHandlers = {
        ...
        'subject-balance-export': () => callGlobal('SB_exportExcel'),
        'subject-balance-render': () => callGlobal('SB_renderTable'),
        'subject-balance-cluster': () => callGlobal('SB_runCluster'),
        'potential-export': () => callGlobal('exportPotentialAnalysis'),
        'potential-render': () => callGlobal('renderPotentialAnalysis'),
