...
'student-details-core': bootSkill('demand', 'demand', ['student-details'], [
    bootEntry('student-details-guard-core', bootJs('student-details-guard-runtime.js')),
...
'student-report-core': bootSkill('demand', 'demand', ['report-generator', 'doQuery'], [
    bootEntry('student-details-guard-core', bootJs('student-details-guard-runtime.js')),
    bootEntry('student-details-render-core', bootJs('student-details-render-runtime.js')),
    bootEntry('comparison-render-core', bootJs('comparison-render-runtime.js')),
    bootEntry('compare-selectors-core', bootJs('compare-selectors-runtime.js')),
...
'comparison-ui-core': bootSkill('demand', 'demand', ['mutual-aid', 'comparison-panel'], [
    bootEntry('comparison-panel-collapse-core', bootJs('comparison-panel-collapse-runtime.js')),
    bootEntry('comparison-render-core', bootJs('comparison-render-runtime.js'))
]),
'teacher-ui-core': bootSkill('demand', 'demand', ['teacher-analysis'], [
    bootEntry('teacher-card-store-core', bootJs('teacher-card-store-runtime.js')),
    bootEntry('teaching-management-modules-core', bootJs('teaching-management-modules-runtime.js'))
]),
'data-quality-core': bootSkill('demand', 'demand', ['data-quality'], [
    bootEntry('data-quality-core', bootJs('data-quality-runtime.js'))
]),
'marginal-push-core': bootSkill('demand', 'demand', ['marginal-push'], [
    bootEntry('marginal-push-core', bootJs('marginal-push-runtime.js'))
]),
'seat-adjustment-core': bootSkill('demand', 'demand', ['seat-adjustment'], [
    bootEntry('seat-adjustment-core', bootJs('seat-adjustment-runtime.js'))
]),
'macro-analysis-core': bootSkill('demand', 'demand', ['analysis', 'renderHorizontalTable'], [
    bootEntry('macro-analysis-compat-core', bootJs('macro-analysis-compat-runtime.js'))
]),
...
// Even the desktop/full profile keeps feature code demand-driven. "full" now
// means aggressive cache hints, not executing every feature after login.
if (profile === 'full') return skill.warmup === 'balanced' || skill.warmup === 'idle';
...
window.ensureStudentDetailsCoreRuntimeLoaded = function () {
return window.SystemRuntimeLoader.load('student-details-core');
};

window.ensureStudentReportCoreRuntimeLoaded = function () {
return window.SystemRuntimeLoader.load('student-report-core');
};

window.ensureComparisonUiCoreRuntimeLoaded = function () {
return window.SystemRuntimeLoader.load('comparison-ui-core');
};

window.ensureTeacherUiCoreRuntimeLoaded = function () {
return window.SystemRuntimeLoader.load('teacher-ui-core');
};

window.ensureDataQualityCoreRuntimeLoaded = function () {
return window.SystemRuntimeLoader.load('data-quality-core');
};

window.ensureMarginalPushCoreRuntimeLoaded = function () {
return window.SystemRuntimeLoader.load('marginal-push-core');
};

window.ensureSeatAdjustmentCoreRuntimeLoaded = function () {
return window.SystemRuntimeLoader.load('seat-adjustment-core');
};

window.ensureMacroAnalysisCoreRuntimeLoaded = function () {
...
installOptionalRuntimeMethod('doQuery', window.ensureStudentReportCoreRuntimeLoaded);

['updateSeatAdjSelects', 'generateSeatSuggestions', 'renderSeatGrid'].forEach((name) => {
installOptionalRuntimeMethod(name, window.ensureSeatAdjustmentCoreRuntimeLoaded);
});
